...
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.11.0](https://github.com/simple-icons/simple-icons/releases/tag/13.11.0), 1 day ago) - SVG icons for popular brands
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.26](https://github.com/alexellis/arkade/releases/tag/0.11.26), 2 days ago) - Open Source Marketplace For Developer Tools
- [dirien/kargo-test](https://github.com/dirien/kargo-test) ([0.1.6-helm](https://github.com/dirien/kargo-test/releases/tag/0.1.6-helm), 5 days ago)
...
- [kubernetes-sigs/secrets-store-csi-driver](https://github.com/kubernetes-sigs/secrets-store-csi-driver) - Secrets Store CSI driver for Kubernetes secrets - Integrates secrets stores with Kubernetes via a CSI volume.   - 1238 stars
- [ratify-project/ratify](https://github.com/ratify-project/ratify) - Artifact Ratification Framework - 209 stars
- [trufflesecurity/trufflehog](https://github.com/trufflesecurity/trufflehog) - Find, verify, and analyze leaked credentials - 15691 stars
- [voideditor/void](https://github.com/voideditor/void) -  - 6154 stars
