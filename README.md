...
- [dirien/devpod-provider-scaleway](https://github.com/dirien/devpod-provider-scaleway) - DevPod on Scaleway 🇫🇷 (2 weeks ago)
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) - Pulumi Port provider (2 weeks ago)

#### 🚀 Latest releases I contributed to

- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.1.0](https://github.com/simple-icons/simple-icons/releases/tag/13.1.0), 1 day ago) - SVG icons for popular brands
- [external-secrets/external-secrets](https://github.com/external-secrets/external-secrets) ([helm-chart-0.9.20](https://github.com/external-secrets/external-secrets/releases/tag/helm-chart-0.9.20), 2 days ago) - External Secrets Operator reads information from a third-party service like AWS Secrets Manager and automatically injects the values as Kubernetes Secrets.
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.4.2](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.4.2), 4 days ago)
...
- [kubescape/kubescape](https://github.com/kubescape/kubescape) ([v3.0.13](https://github.com/kubescape/kubescape/releases/tag/v3.0.13), 4 days ago) - Kubescape is an open-source Kubernetes security platform for your IDE, CI/CD pipelines, and clusters. It includes risk analysis, security, compliance, and misconfiguration scanning, saving Kubernetes users and administrators precious time, effort, and resources.
...
- [goyek/goyek](https://github.com/goyek/goyek) - Task automation Go library - 535 stars
- [baalimago/clai](https://github.com/baalimago/clai) - Command line artificial intelligence - Multi-vendor generation in your terminal - 50 stars
...
- [creativecreature/pulse](https://github.com/creativecreature/pulse) - Like a fitness tracker for your coding sessions - 127 stars
- [nginxinc/nginx-gateway-fabric](https://github.com/nginxinc/nginx-gateway-fabric) - NGINX Gateway Fabric provides an implementation for the Gateway API using NGINX as the data plane. - 426 stars
