...
- [port-labs/pulumi](https://github.com/port-labs/pulumi) - Pulumi provider for Port Labs (2 days ago)
...
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1188.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1188.0), 1 day ago) - IDE-style autocomplete for your existing terminal &amp; shell
- [civo/civogo](https://github.com/civo/civogo) ([v0.3.42](https://github.com/civo/civogo/releases/tag/v0.3.42), 2 days ago) - Golang client to interact with Civo&#39;s API
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.3.0](https://github.com/loft-sh/devpod/releases/tag/v0.3.0), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
- [pulumiverse/pulumi-harbor](https://github.com/pulumiverse/pulumi-harbor) ([v3.9.4](https://github.com/pulumiverse/pulumi-harbor/releases/tag/v3.9.4), 2 days ago) - A Pulumi native provider Harbor
- [dirien/pulumi-scaleway](https://github.com/dirien/pulumi-scaleway) ([v2.24.0](https://github.com/dirien/pulumi-scaleway/releases/tag/v2.24.0), 2 days ago) - Pulumi provider for Scaleway

#### ⭐ Latest repositories I starred

- [lbrlabs/iac-in-go](https://github.com/lbrlabs/iac-in-go) - A reference architecture example for Pulumi in Go - 1 stars
- [devstream-io/devstream](https://github.com/devstream-io/devstream) - DevStream: the open-source DevOps toolchain manager (DTM). - 795 stars
...
- [enix/kube-image-keeper](https://github.com/enix/kube-image-keeper) - kuik is a container image caching system for Kubernetes - 221 stars
- [zellij-org/zellij](https://github.com/zellij-org/zellij) - A terminal workspace with batteries included - 12987 stars
...
- [PurpleMonkey729](https://github.com/PurpleMonkey729) - Hiroki Yoshimura
- [mxaxaxbx](https://github.com/mxaxaxbx) - Miguel A. Arenas
- [1ScriptKiddie1](https://github.com/1ScriptKiddie1) - ScriptMonrad
- [huaiim](https://github.com/huaiim) - 
