...
- [pulumiverse/pulumi-harbor](https://github.com/pulumiverse/pulumi-harbor) - A Pulumi native provider Harbor (2 weeks ago)
- [dirien/pulumi-fly](https://github.com/dirien/pulumi-fly) - Pulumi provider for Fly.io (2 weeks ago)

#### 🚀 Latest releases I contributed to

- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.1.25](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.1.25), 1 day ago)
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.44.1](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.44.1), 1 day ago) - Azure Native Provider
- [pulumiverse/pulumi-scaleway](https://github.com/pulumiverse/pulumi-scaleway) ([v1.14.0](https://github.com/pulumiverse/pulumi-scaleway/releases/tag/v1.14.0), 1 day ago) - Pulumi provider for Scaleway
...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.13](https://github.com/alexellis/arkade/releases/tag/0.11.13), 2 days ago) - Open Source Marketplace For Developer Tools
...
- [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly WebUI for LLMs (Formerly Ollama WebUI) - 25946 stars
- [volcano-sh/volcano](https://github.com/volcano-sh/volcano) - A Cloud Native Batch System (Project under CNCF) - 3853 stars
...
- [robusta-dev/holmesgpt](https://github.com/robusta-dev/holmesgpt) - The Open Source DevOps Assistant - solve problems twice as fast with an AI teammate - 134 stars
- [explodinggradients/ragas](https://github.com/explodinggradients/ragas) - Evaluation framework for your Retrieval Augmented Generation (RAG) pipelines - 5275 stars
- [containers/bootc](https://github.com/containers/bootc) - Boot and upgrade via container images - 441 stars
