...
- [dirien/minecraft-prometheus-exporter](https://github.com/dirien/minecraft-prometheus-exporter) ([v0.8.1](https://github.com/dirien/minecraft-prometheus-exporter/releases/tag/v0.8.1), 1 day ago) - This is a Prometheus Minecraft exporter, created as part of the minectl 🗺 project.
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.8.13](https://github.com/alexellis/arkade/releases/tag/0.8.13), 2 days ago) - Open Source Kubernetes Marketplace
- [civo/terraform-provider-civo](https://github.com/civo/terraform-provider-civo) ([v1.0.9](https://github.com/civo/terraform-provider-civo/releases/tag/v1.0.9), 3 days ago) - Terraform Civo provider
...
- [ckotzbauer/sbom-operator](https://github.com/ckotzbauer/sbom-operator) - Catalogue all images of a Kubernetes cluster to Git with Syft - 6 stars
- [starship/starship](https://github.com/starship/starship) - ☄🌌️  The minimal, blazing-fast, and infinitely customizable prompt for any shell! - 21754 stars
...
- [umbracle/go-web3](https://github.com/umbracle/go-web3) - Ethereum Golang API - 201 stars
- [kubeshop/monokle](https://github.com/kubeshop/monokle) - Monokle is your K8s best friend for creating, validating, debugging and managing manifests! - 222 stars
