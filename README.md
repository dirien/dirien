...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.9](https://github.com/alexellis/arkade/releases/tag/0.11.9), 1 day ago) - Open Source Marketplace For Developer Tools
- [ovh/pulumi-ovh](https://github.com/ovh/pulumi-ovh) ([v0.42.0](https://github.com/ovh/pulumi-ovh/releases/tag/v0.42.0), 1 day ago) - Pulumi provider for OVHcloud
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.36.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.36.0), 2 days ago) - Azure Native Provider
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-k8s-exporter-0.2.21](https://github.com/port-labs/helm-charts/releases/tag/port-k8s-exporter-0.2.21), 2 days ago)
...
- [mziyabo/argocd-trivy-extension](https://github.com/mziyabo/argocd-trivy-extension) - An Argo CD extension to enable visualization of Trivy generated vulnerability reports in Argo CD UI.  - 24 stars
- [cilium/pwru](https://github.com/cilium/pwru) - Packet, where are you? -- eBPF-based Linux kernel networking debugger - 2424 stars
- [nixys/nxs-universal-chart](https://github.com/nixys/nxs-universal-chart) - The Helm chart you can use to install any of your applications into Kubernetes/OpenShift - 316 stars
- [awslabs/diagram-as-code](https://github.com/awslabs/diagram-as-code) - Diagram-as-code for AWS architecture. - 305 stars
- [turbot/powerpipe](https://github.com/turbot/powerpipe) - Powerpipe: Dashboards for DevOps. Visualize cloud configurations. Assess security posture against a massive library of benchmarks. Build custom dashboards with code. - 77 stars
- [levkush/termvideo](https://github.com/levkush/termvideo) - Play videos from a terminal with audio support! 🚀 - 10 stars
- [hcavarsan/kftray](https://github.com/hcavarsan/kftray) - kubectl port-forward on steroids ⚡ |  kftray makes it easy for you to manage and share multiple k8s port forwards right from your menu bar - built with rust 🦀 and ts using tauri - 384 stars
