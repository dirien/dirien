...
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1191.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1191.0), 1 day ago) - IDE-style autocomplete for your existing terminal &amp; shell
- [go-acme/lego](https://github.com/go-acme/lego) ([v4.13.3](https://github.com/go-acme/lego/releases/tag/v4.13.3), 1 day ago) - Let&#39;s Encrypt/ACME client and library written in Go
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.9.25](https://github.com/alexellis/arkade/releases/tag/0.9.25), 1 day ago) - Open Source Marketplace For Developer Tools
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.3.2](https://github.com/loft-sh/devpod/releases/tag/v0.3.2), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
- [dirien/pulumi-scaleway](https://github.com/dirien/pulumi-scaleway) ([v2.25.1](https://github.com/dirien/pulumi-scaleway/releases/tag/v2.25.1), 3 days ago) - Pulumi provider for Scaleway
...
- [devcontainers/features](https://github.com/devcontainers/features) - A collection of Dev Container Features managed by Dev Container spec maintainers. See https://github.com/devcontainers/feature-starter to publish your own - 498 stars
...
- [enix/kube-image-keeper](https://github.com/enix/kube-image-keeper) - kuik is a container image caching system for Kubernetes - 223 stars
- [zellij-org/zellij](https://github.com/zellij-org/zellij) - A terminal workspace with batteries included - 13056 stars
