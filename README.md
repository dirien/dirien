...
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.13-alpha.0](https://github.com/loft-sh/devpod/releases/tag/v0.5.13-alpha.0), 1 day ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
...
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.43.1](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.43.1), 3 days ago) - Azure Native Provider

#### ⭐ Latest repositories I starred

- [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly WebUI for LLMs (Formerly Ollama WebUI) - 25389 stars
- [volcano-sh/volcano](https://github.com/volcano-sh/volcano) - A Cloud Native Batch System (Project under CNCF) - 3846 stars
...
- [robusta-dev/holmesgpt](https://github.com/robusta-dev/holmesgpt) - The Open Source DevOps Assistant - solve problems twice as fast with an AI teammate - 112 stars
- [explodinggradients/ragas](https://github.com/explodinggradients/ragas) - Evaluation framework for your Retrieval Augmented Generation (RAG) pipelines - 5221 stars
- [containers/bootc](https://github.com/containers/bootc) - Boot and upgrade via container images - 434 stars
- [kubecolor/kubecolor](https://github.com/kubecolor/kubecolor) - Colorize your kubectl output - 427 stars
