...
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.1.2](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.1.2), 1 day ago)
- [lbrlabs/pulumi-ovh](https://github.com/lbrlabs/pulumi-ovh) ([v0.32.0](https://github.com/lbrlabs/pulumi-ovh/releases/tag/v0.32.0), 1 day ago) - Pulumi provider for OVH
- [dirien/devpod-provider-equinix](https://github.com/dirien/devpod-provider-equinix) ([v0.2.0](https://github.com/dirien/devpod-provider-equinix/releases/tag/v0.2.0), 2 days ago) - DevPod on Equinix Metal
- [dirien/devpod-provider-scaleway](https://github.com/dirien/devpod-provider-scaleway) ([v0.4.0](https://github.com/dirien/devpod-provider-scaleway/releases/tag/v0.4.0), 2 days ago) - DevPod on Scaleway 🇫🇷

#### ⭐ Latest repositories I starred

- [yonahd/kor](https://github.com/yonahd/kor) - A Tool to discover unused Kubernetes Resources  - 71 stars
...
- [kubewharf/kelemetry](https://github.com/kubewharf/kelemetry) - Global control plane tracing for Kubernetes - 172 stars
