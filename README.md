...
- [cncf-bulgaria/meetups](https://github.com/cncf-bulgaria/meetups) - Kubernetes &amp; CNCF Bulgaria Meetup Repository (2 days ago)
...
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1238.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1238.0), 1 day ago) - IDE-style autocomplete for your existing terminal &amp; shell
- [argoproj/argo-helm](https://github.com/argoproj/argo-helm) ([argo-cd-5.47.0](https://github.com/argoproj/argo-helm/releases/tag/argo-cd-5.47.0), 1 day ago) - ArgoProj Helm Charts
- [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) ([nightly](https://github.com/goreleaser/goreleaser/releases/tag/nightly), 2 days ago) - Deliver Go binaries as fast and easily as possible
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.14.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.14.0), 3 days ago) - Azure Native Provider
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.1.5](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.1.5), 3 days ago)

#### ⭐ Latest repositories I starred

- [undistro/marvin](https://github.com/undistro/marvin) - Marvin is a CLI tool that scans a k8s cluster by performing CEL expressions to report potential issues, misconfigurations and vulnerabilities. - 92 stars
- [TabbyML/tabby](https://github.com/TabbyML/tabby) - Self-hosted AI coding assistant - 12131 stars
- [dotdc/grafana-dashboards-kubernetes](https://github.com/dotdc/grafana-dashboards-kubernetes) - A set of modern Grafana dashboards for Kubernetes. - 1557 stars
...
- [aws-samples/karpenter-blueprints](https://github.com/aws-samples/karpenter-blueprints) - Karpenter Blueprints is a list of common workload scenarios following best practices. You&#39;ll find here details of why configuring the Karpenter and Kubernetes objects in such a way is important when using Karpenter on EKS. - 71 stars
- [argoproj-labs/hera](https://github.com/argoproj-labs/hera) - Hera is an Argo Python SDK. Hera aims to make construction and submission of various Argo Project resources easy and accessible to everyone! Hera abstracts away low-level setup details while still maintaining a consistent vocabulary with Argo. - 359 stars
...
- [vladmandic/human](https://github.com/vladmandic/human) - Human: AI-powered 3D Face Detection &amp; Rotation Tracking, Face Description &amp; Recognition, Body Pose Tracking, 3D Hand &amp; Finger Tracking, Iris Analysis, Age &amp; Gender &amp; Emotion Prediction, Gaze Tracking, Gesture Recognition - 1696 stars
- [balena-io/open-balena](https://github.com/balena-io/open-balena) - Open source software to manage connected IoT devices at scale - 952 stars
- [zitadel/zitadel](https://github.com/zitadel/zitadel) - ZITADEL - Identity infrastructure, simplified for you. - 4987 stars
