...
- [How to cross-compile your Rust applications using cross-rs and GitHub Actions](https://blog.ediri.io/how-to-cross-compile-your-rust-applications-using-cross-rs-and-github-actions) (10 months ago)
- [Kubernetes 1.26: Implementing Validating Admission Policies with Pulumi](https://blog.ediri.io/kubernetes-126-implementing-validating-admission-policies-with-pulumi) (10 months ago)
- [Rust Development with Testcontainers](https://blog.ediri.io/rust-development-with-testcontainers) (11 months ago)

#### 👷 I'm currently working on

- [dirien/pulumi-qovery](https://github.com/dirien/pulumi-qovery) - Pulumi provider for Qovery (1 day ago)
...
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.1.26](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.1.26), 1 day ago)
- [dirien/pulumi-scaleway](https://github.com/dirien/pulumi-scaleway) ([v2.41.1](https://github.com/dirien/pulumi-scaleway/releases/tag/v2.41.1), 1 day ago) - Pulumi provider for Scaleway
- [dirien/pulumi-qovery](https://github.com/dirien/pulumi-qovery) ([v0.28.10](https://github.com/dirien/pulumi-qovery/releases/tag/v0.28.10), 1 day ago) - Pulumi provider for Qovery
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.44.1](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.44.1), 2 days ago) - Azure Native Provider
- [pulumiverse/pulumi-scaleway](https://github.com/pulumiverse/pulumi-scaleway) ([v1.14.0](https://github.com/pulumiverse/pulumi-scaleway/releases/tag/v1.14.0), 2 days ago) - Pulumi provider for Scaleway

#### ⭐ Latest repositories I starred

- [gatewayd-io/gatewayd](https://github.com/gatewayd-io/gatewayd) - ☁️ Cloud-native database gateway and framework for building data-driven applications ✨ Like API gateways, for databases ✨ - 194 stars
- [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly WebUI for LLMs (Formerly Ollama WebUI) - 26104 stars
- [volcano-sh/volcano](https://github.com/volcano-sh/volcano) - A Cloud Native Batch System (Project under CNCF) - 3854 stars
- [open-cluster-management-io/ocm](https://github.com/open-cluster-management-io/ocm) - Core components in the OCM project. Report here if you found any issues in OCM. - 711 stars
- [submariner-io/submariner](https://github.com/submariner-io/submariner) - Networking component for interconnecting Pods and Services across Kubernetes clusters. - 2357 stars
- [robusta-dev/holmesgpt](https://github.com/robusta-dev/holmesgpt) - The Open Source DevOps Assistant - solve problems twice as fast with an AI teammate - 146 stars
- [explodinggradients/ragas](https://github.com/explodinggradients/ragas) - Evaluation framework for your Retrieval Augmented Generation (RAG) pipelines - 5283 stars
- [containers/bootc](https://github.com/containers/bootc) - Boot and upgrade via container images - 443 stars
- [kubecolor/kubecolor](https://github.com/kubecolor/kubecolor) - Colorize your kubectl output - 433 stars
- [awslabs/app-development-for-backstage-io-on-aws](https://github.com/awslabs/app-development-for-backstage-io-on-aws) - A developer portal to meet your Enterprise needs. Fast, secure, and at-scale.  - 154 stars

#### 👥 Latest follower

- [afro-coder](https://github.com/afro-coder) - Leon
- [ssmiller25](https://github.com/ssmiller25) - Steve Miller
- [VinceDeslo](https://github.com/VinceDeslo) - Vincent Desloover
- [YourongW](https://github.com/YourongW) - Yourong Wu
- [petrosiatrou](https://github.com/petrosiatrou) - Petros Iatrou
