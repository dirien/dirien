...
- [scraly/pulumi-ovh](https://github.com/scraly/pulumi-ovh) - Pulumi provider for OVHcloud (2 days ago)
...
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-k8s-exporter-0.1.19](https://github.com/port-labs/helm-charts/releases/tag/port-k8s-exporter-0.1.19), 4 days ago)
- [dirien/pulumi-github](https://github.com/dirien/pulumi-github) ([v0.2.33](https://github.com/dirien/pulumi-github/releases/tag/v0.2.33), 4 days ago) - Pulumi program to manage my GitHub repositories
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v1.4.1](https://github.com/port-labs/pulumi-port/releases/tag/v1.4.1), 5 days ago)

#### ⭐ Latest repositories I starred

- [undistro/zora](https://github.com/undistro/zora) - Zora is a multi-cluster scan that helps you identify potential issues and vulnerabilities in your Kubernetes clusters. - 176 stars
...
- [kubewharf/kelemetry](https://github.com/kubewharf/kelemetry) - Global control plane tracing for Kubernetes - 181 stars
