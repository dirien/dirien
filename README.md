...
- [ovh/pulumi-ovh](https://github.com/ovh/pulumi-ovh) - Pulumi provider for OVHcloud (2 weeks ago)
...
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.3.7](https://github.com/loft-sh/devpod/releases/tag/v0.3.7), 1 day ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.10.1](https://github.com/alexellis/arkade/releases/tag/0.10.1), 1 day ago) - Open Source Marketplace For Developer Tools
- [civo/civogo](https://github.com/civo/civogo) ([v0.3.45](https://github.com/civo/civogo/releases/tag/v0.3.45), 1 day ago) - Golang client to interact with Civo&#39;s API
- [pulumi/pulumi](https://github.com/pulumi/pulumi) ([v3.80.0](https://github.com/pulumi/pulumi/releases/tag/v3.80.0), 1 day ago) - Pulumi - Infrastructure as Code in any programming language. Build infrastructure intuitively on any cloud using familiar languages 🚀
...
- [kdash-rs/kdash](https://github.com/kdash-rs/kdash) - A simple and fast dashboard for Kubernetes - 1467 stars
- [mochi-mqtt/server](https://github.com/mochi-mqtt/server) - The fully compliant, embeddable high-performance Go MQTT v5 server for IoT, smarthome, and pubsub - 698 stars
- [eigr/spawn](https://github.com/eigr/spawn) - Spawn - Actor Mesh - 131 stars
- [kcl-lang/kcl](https://github.com/kcl-lang/kcl) - A constraint-based record &amp; functional language mainly used in configuration and policy scenarios. https://kcl-lang.io - 739 stars
- [IBM/fp-go](https://github.com/IBM/fp-go) - functional programming library for golang - 1078 stars
- [undistro/zora](https://github.com/undistro/zora) - Zora is a multi-cluster scan that helps you identify potential issues and vulnerabilities in your Kubernetes clusters. - 181 stars
- [org-formation/org-formation-cli](https://github.com/org-formation/org-formation-cli) - Better than landingzones! - 1232 stars
