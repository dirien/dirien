...
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-agent-0.7.13](https://github.com/port-labs/helm-charts/releases/tag/port-agent-0.7.13), 1 day ago)
...
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.18](https://github.com/loft-sh/devpod/releases/tag/v0.5.18), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.0.12](https://github.com/port-labs/pulumi-port/releases/tag/v2.0.12), 2 days ago) - Pulumi Port provider
...
- [kurtosis-tech/kardinal](https://github.com/kurtosis-tech/kardinal) - Kardinal is the lightest-weight way to spin up dev and test environments in Kubernetes. Deploy the absolute minimum resources necessary and implement dev, test, and QA all in one cluster. - 31 stars
- [mingrammer/diagrams](https://github.com/mingrammer/diagrams) - :art: Diagram as Code for prototyping cloud system architectures - 35688 stars
...
- [goyek/goyek](https://github.com/goyek/goyek) - Task automation Go library - 545 stars
