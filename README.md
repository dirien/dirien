...
- [dirien/doplane](https://github.com/dirien/doplane) - Kubernetes operator managing individual cloud resources declaratively via &#39;pulumi do&#39; — no Pulumi programs, stacks, or state files; etcd is the state store (2 days ago)
- [dirien/herdr-sbx-plugin](https://github.com/dirien/herdr-sbx-plugin) - Herdr plugin that runs coding agents inside Docker Sandboxes (sbx), one microVM per agent (2 days ago)
- [docker/sbx-kits-contrib](https://github.com/docker/sbx-kits-contrib) - Community repository for sbx kits (2 weeks ago)

#### 🚀 Latest releases I contributed to

- [dirien/herdr-sbx-plugin](https://github.com/dirien/herdr-sbx-plugin) ([v0.1.0](https://github.com/dirien/herdr-sbx-plugin/releases/tag/v0.1.0), 2 days ago) - Herdr plugin that runs coding agents inside Docker Sandboxes (sbx), one microVM per agent
- [dirien/doplane](https://github.com/dirien/doplane) ([v0.3.0](https://github.com/dirien/doplane/releases/tag/v0.3.0), 2 days ago) - Kubernetes operator managing individual cloud resources declaratively via &#39;pulumi do&#39; — no Pulumi programs, stacks, or state files; etcd is the state store
- [dirien/my-claude-apm-setup](https://github.com/dirien/my-claude-apm-setup) ([v0.6.4](https://github.com/dirien/my-claude-apm-setup/releases/tag/v0.6.4), 2 days ago) - A self-contained APM-managed Claude Code &#43; Codex setup — pinned skills, agents, guardrail hooks, MCP, LSP, and single-source generated context.
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.70](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.70), 4 days ago) - MCP DigitalOcean Integration
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.25.0](https://github.com/port-labs/pulumi-port/releases/tag/v2.25.0), 2 weeks ago) - Pulumi Port provider

#### ⭐ Latest repositories I starred

- [fastrepl/anarlog](https://github.com/fastrepl/anarlog) - Open source Granola AI Alternative - 9307 stars
- [mrinalwadhwa/fluent](https://github.com/mrinalwadhwa/fluent) - Fluent is a self-improving software factory. It autonomously turns your team&#39;s vision, ideas, bug reports, user feedback, production logs, and agent traces into working software. - 101 stars
- [NVIDIA/SkillEvaluator](https://github.com/NVIDIA/SkillEvaluator) - Multi-tier framework for evaluating AI agent skills with quality gates, semantic overlap detection, synthetic evaluation dataset generation, and live agent evaluation that measures how skills affect agent behavior. - 443 stars
- [benchflow-ai/awesome-evals](https://github.com/benchflow-ai/awesome-evals) - A curated, non-BS library of the best resources for building and evaluating AI agents — papers, blogs, talks, tools, benchmarks. Maintained by BenchFlow. - 884 stars
- [lirantal/boxdown](https://github.com/lirantal/boxdown) - CLI for Local Isolated Environments for Coding Agents - 31 stars
- [madarco/agentbox](https://github.com/madarco/agentbox) - Run multiple agents in parallel sandboxed VMs, with a single command, on your PC or in the cloud - 398 stars
- [plannotator/herdr-annotate](https://github.com/plannotator/herdr-annotate) - Annotate terminal text, review documents and agent replies in Herdr, and send the feedback straight back to the agent. - 464 stars
- [shanthropic/claude-adapter](https://github.com/shanthropic/claude-adapter) - Transform your OpenAI API into an Anthropic-compatible endpoint for Claude Code - 139 stars
- [musistudio/claude-code-router](https://github.com/musistudio/claude-code-router) - One local control plane for every AI agent: route across models, fuse new capabilities, orchestrate tools, and stay fully in control. - 37238 stars
- [MaryamTavakkoli/local-k8s-ai-agent](https://github.com/MaryamTavakkoli/local-k8s-ai-agent) - Self-hosted AI agent on K8s that reads live pods, events, and logs. Local LLM (Mistral/Ollama), FastAPI, read-only RBAC, ArgoCD &#43; Image Updater GitOps. - 21 stars
