...
- [dirien/fully-automated-ai-inference-pulumi](https://github.com/dirien/fully-automated-ai-inference-pulumi) - Zero-touch GPU inference server (Ollama) on AWS, Azure, and Google Cloud with Pulumi. Companion code for the Pulumi blog post. (1 day ago)
...
- [dirien/pulumi-minecraft](https://github.com/dirien/pulumi-minecraft) - Pulumi component (Go): a Java Minecraft server on DigitalOcean (6 days ago)
...
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.22.0](https://github.com/port-labs/pulumi-port/releases/tag/v2.22.0), 1 day ago) - Pulumi Port provider
- [pulumi-labs/pulumi-exporter](https://github.com/pulumi-labs/pulumi-exporter) ([v0.1.3](https://github.com/pulumi-labs/pulumi-exporter/releases/tag/v0.1.3), 2 days ago) - OpenTelemetry Pulumi Cloud metrics exporter
...
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.34.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.34.0), 2 weeks ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
...
- [visa/visa-vulnerability-agentic-harness](https://github.com/visa/visa-vulnerability-agentic-harness) - Visa Vulnerability Agentic Harness - 584 stars
...
- [CopilotKit/OpenTag](https://github.com/CopilotKit/OpenTag) - OpenTag - 462 stars
- [EpicGames/lore](https://github.com/EpicGames/lore) - Lore is a next-generation, open source version control system - 7441 stars
