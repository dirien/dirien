...
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.2.0](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.2.0), 2 days ago)
- [langchain-ai/langserve](https://github.com/langchain-ai/langserve) ([v0.2.2](https://github.com/langchain-ai/langserve/releases/tag/v0.2.2), 2 days ago) - LangServe 🦜️🏓
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.13](https://github.com/loft-sh/devpod/releases/tag/v0.5.13), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.14](https://github.com/alexellis/arkade/releases/tag/0.11.14), 2 days ago) - Open Source Marketplace For Developer Tools

#### ⭐ Latest repositories I starred

- [kserve/kserve](https://github.com/kserve/kserve) - Standardized Serverless ML Inference Platform on Kubernetes - 3205 stars
...
- [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly WebUI for LLMs (Formerly Ollama WebUI) - 26596 stars
...
- [robusta-dev/holmesgpt](https://github.com/robusta-dev/holmesgpt) - On-Call/DevOps Assistant - Get a head start on fixing alerts with AI investigation - 164 stars
- [explodinggradients/ragas](https://github.com/explodinggradients/ragas) - Evaluation framework for your Retrieval Augmented Generation (RAG) pipelines - 5321 stars
- [containers/bootc](https://github.com/containers/bootc) - Boot and upgrade via container images - 446 stars
- [kubecolor/kubecolor](https://github.com/kubecolor/kubecolor) - Colorize your kubectl output - 441 stars
