...
- [flatcar/Flatcar](https://github.com/flatcar/Flatcar) - Flatcar project repository for issue tracking, project documentation, etc. (2 days ago)
...
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.954.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.954.0), 1 day ago) - Fig adds autocomplete to your terminal.
- [dexidp/dex](https://github.com/dexidp/dex) ([v2.35.1](https://github.com/dexidp/dex/releases/tag/v2.35.1), 1 day ago) - OpenID Connect (OIDC) identity and OAuth 2.0 provider with pluggable connectors
- [go-acme/lego](https://github.com/go-acme/lego) ([v4.9.0](https://github.com/go-acme/lego/releases/tag/v4.9.0), 2 days ago) - Let&#39;s Encrypt/ACME client and library written in Go
...
- [upscayl/upscayl](https://github.com/upscayl/upscayl) - 🆙 Upscayl - Free and Open Source AI Image Upscaler for Linux, MacOS and Windows built with Linux-First philosophy. - 5563 stars
- [stefanmaric/g](https://github.com/stefanmaric/g) - Simple go version manager, gluten-free - 618 stars
...
- [learntocloud/learn-to-cloud](https://github.com/learntocloud/learn-to-cloud) - Learn the fundamentals of cloud computing - 3472 stars
...
- [cloudflare/workerd](https://github.com/cloudflare/workerd) - The JavaScript / Wasm runtime that powers Cloudflare Workers - 3618 stars
