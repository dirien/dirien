...
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.28.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.28.0), 4 days ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.21.9](https://github.com/port-labs/pulumi-port/releases/tag/v2.21.9), 5 days ago) - Pulumi Port provider
...
- [vercel-labs/ai-cli](https://github.com/vercel-labs/ai-cli) - Generate anything from your terminal - 208 stars
- [withastro/flue](https://github.com/withastro/flue) - The sandbox agent framework. - 2108 stars
- [chrishutchinson/claude-receipts](https://github.com/chrishutchinson/claude-receipts) - Bring receipts from your Claude Code sessions - 479 stars
- [amitshekhariitbhu/ai-engineering-interview-questions](https://github.com/amitshekhariitbhu/ai-engineering-interview-questions) - Your Cheat Sheet for AI Engineering Interview – Questions and Answers. - 1399 stars
- [Effect-TS/effect](https://github.com/Effect-TS/effect) - Build production-ready applications in TypeScript - 14025 stars
- [dohooo/helmor](https://github.com/dohooo/helmor) - Open-source local workbench for multi-agent software development. - 808 stars
- [microsoft/AIforITOps](https://github.com/microsoft/AIforITOps) - Workshop for IT/Ops teams to learn how to manage AI-enabled applications on Microsoft Azure. - 123 stars
...
- [vercel-labs/portless](https://github.com/vercel-labs/portless) - Replace port numbers with stable, named local URLs. For humans and agents. - 8812 stars
