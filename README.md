...
- [Kubernetes GPU Sharing: NVIDIA MIG &#43; DRA on Amazon EKS](https://blog.ediri.io/kubernetes-gpu-sharing-nvidia-mig-dra-on-amazon-eks) (1 week ago)
...
- [dirien/coding-task-test](https://github.com/dirien/coding-task-test) -  (3 days ago)
...
- [dirien/cfgmgmtcamp-2026-agentic-ai-workshop](https://github.com/dirien/cfgmgmtcamp-2026-agentic-ai-workshop) - Building AI-Assisted Operations: Agentic AI Workshop - CfgMgmtCamp Ghent 2026 (1 week ago)
- [dirien/url-shortener-saas](https://github.com/dirien/url-shortener-saas) - Production-ready URL Shortener SaaS built with Pulumi TypeScript, AWS Lambda, DynamoDB, CloudFront, and React (1 week ago)

#### 🚀 Latest releases I contributed to

- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.19.6](https://github.com/port-labs/pulumi-port/releases/tag/v2.19.6), 2 days ago) - Pulumi Port provider
- [dirien/lazy-pulumi](https://github.com/dirien/lazy-pulumi) ([v0.7.0](https://github.com/dirien/lazy-pulumi/releases/tag/v0.7.0), 5 days ago) - A terminal UI (TUI) application for Pulumi Cloud
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.31](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.31), 1 week ago) - MCP DigitalOcean Integration
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.18.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.18.0), 1 week ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
- [pulumi/pulumi-kubernetes-operator](https://github.com/pulumi/pulumi-kubernetes-operator) ([v2.4.1](https://github.com/pulumi/pulumi-kubernetes-operator/releases/tag/v2.4.1), 1 week ago) - A Kubernetes Operator that automates the deployment of Pulumi Stacks

#### ⭐ Latest repositories I starred

- [maximhq/bifrost](https://github.com/maximhq/bifrost) - Fastest enterprise AI gateway (50x faster than LiteLLM) with adaptive load balancer, cluster mode, guardrails, 1000&#43; models support &amp; &lt;100 µs overhead at 5k RPS. - 2324 stars
- [gsd-build/get-shit-done](https://github.com/gsd-build/get-shit-done) - A light-weight and powerful meta-prompting, context engineering and spec-driven development system for Claude Code and OpenCode. - 13768 stars
- [sipeed/picoclaw](https://github.com/sipeed/picoclaw) - picoclaw - 5865 stars
- [rohitg00/skillkit](https://github.com/rohitg00/skillkit) - Supercharge AI coding agents with portable skills. Install, translate &amp; share skills across Claude Code, Cursor, Codex, Copilot &amp; 40 more - 312 stars
- [rohitg00/pro-workflow](https://github.com/rohitg00/pro-workflow) - Battle-tested Claude Code workflows from power users. Self-correcting memory, parallel worktrees, wrap-up rituals, and the 80/20 AI coding ratio. - 856 stars
- [kubernetes-sigs/agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox) - agent-sandbox enables easy management of isolated, stateful, singleton workloads, ideal for use cases like AI agent runtimes. - 966 stars
- [nestybox/sysbox](https://github.com/nestybox/sysbox) - An open-source, next-generation &#34;runc&#34; that empowers rootless containers to run workloads such as Systemd, Docker, Kubernetes, just like VMs. - 3451 stars
- [agent-sandbox/agent-sandbox](https://github.com/agent-sandbox/agent-sandbox) - Agent Sandbox is an E2B compatible, enterprise-grade ai-first, cloud-native runtime environment for AI Agents. Allows Agents to securely run untrusted LLM-generated Code, Browser use, Computer use, and Shell commands etc. with stateful, long-running, multi-session and multi-tenant. - 59 stars
- [pranshuparmar/witr](https://github.com/pranshuparmar/witr) - Why is this running? - 13185 stars
- [oxidecomputer/progenitor](https://github.com/oxidecomputer/progenitor) - An OpenAPI client generator - 848 stars

#### 👥 Latest follower

- [Interested-Deving-1896](https://github.com/Interested-Deving-1896) - Interested Deving
- [Jeffallan](https://github.com/Jeffallan) - 
- [ArielTheGreat](https://github.com/ArielTheGreat) - Franco Rocha
- [mo-hamedaziz](https://github.com/mo-hamedaziz) - Mohamed Aziz Bchini
- [SiddharthMahapatra12](https://github.com/SiddharthMahapatra12) - Siddharth Mahapatra
