...
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.27.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.27.0), 3 days ago) - Azure Native Provider
...
- [pinecone-io/pulumi-pinecone](https://github.com/pinecone-io/pulumi-pinecone) ([v0.4.0](https://github.com/pinecone-io/pulumi-pinecone/releases/tag/v0.4.0), 4 days ago) - Pinecone Pulumi Provider

#### ⭐ Latest repositories I starred

- [lirantal/dockly](https://github.com/lirantal/dockly) - Immersive terminal interface for managing docker containers and services - 3645 stars
- [k3s-io/helm-controller](https://github.com/k3s-io/helm-controller) -  - 329 stars
...
- [joaomdmoura/crewAI](https://github.com/joaomdmoura/crewAI) - Framework for orchestrating role-playing, autonomous AI agents. By fostering collaborative intelligence, CrewAI empowers agents to work together seamlessly, tackling complex tasks. - 6185 stars
- [rednafi/link-patrol](https://github.com/rednafi/link-patrol) - Detect dead links in markdown files - 17 stars
- [projectdiscovery/cvemap](https://github.com/projectdiscovery/cvemap) - Navigate the CVE jungle with ease. - 704 stars
