...
- [pinecone-io/pulumi-pinecone](https://github.com/pinecone-io/pulumi-pinecone) - Pinecone Pulumi Provider (3 days ago)
...
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.27.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.27.0), 2 days ago) - Azure Native Provider
...
- [pinecone-io/pulumi-pinecone](https://github.com/pinecone-io/pulumi-pinecone) ([v0.4.0](https://github.com/pinecone-io/pulumi-pinecone/releases/tag/v0.4.0), 3 days ago) - Pinecone Pulumi Provider
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.1.17](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.1.17), 3 days ago)

#### ⭐ Latest repositories I starred

- [k3s-io/helm-controller](https://github.com/k3s-io/helm-controller) -  - 324 stars
- [Skarlso/crd-bootstrap](https://github.com/Skarlso/crd-bootstrap) - Continuously reconcil CRDs in the cluster with template validation before apply. - 21 stars
- [joaomdmoura/crewAI](https://github.com/joaomdmoura/crewAI) - Framework for orchestrating role-playing, autonomous AI agents. By fostering collaborative intelligence, CrewAI empowers agents to work together seamlessly, tackling complex tasks. - 6126 stars
- [rednafi/link-patrol](https://github.com/rednafi/link-patrol) - Detect dead links in markdown files - 17 stars
- [projectdiscovery/cvemap](https://github.com/projectdiscovery/cvemap) - Navigate the CVE jungle with ease. - 647 stars
...
- [KusionStack/kusion](https://github.com/KusionStack/kusion) - Deliver intentions to Kubernetes and Clouds - 708 stars
