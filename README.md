...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.30](https://github.com/alexellis/arkade/releases/tag/0.11.30), 1 day ago) - Open Source Marketplace For Developer Tools
- [pulumiverse/pulumi-scaleway](https://github.com/pulumiverse/pulumi-scaleway) ([v1.20.0](https://github.com/pulumiverse/pulumi-scaleway/releases/tag/v1.20.0), 2 days ago) - Pulumi provider for Scaleway
- [dirien/pulumi-fly](https://github.com/dirien/pulumi-fly) ([v0.1.18](https://github.com/dirien/pulumi-fly/releases/tag/v0.1.18), 3 days ago) - Pulumi provider for Fly.io
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.16.0](https://github.com/simple-icons/simple-icons/releases/tag/13.16.0), 3 days ago) - SVG icons for popular brands
...
- [pterm/pterm](https://github.com/pterm/pterm) - ✨ #PTerm is a modern Go module to easily beautify console output. Featuring charts, progressbars, tables, trees, text input, select menus and much more 🚀 It&#39;s completely configurable and 100% cross-platform compatible. - 4835 stars
- [MightyMoud/sidekick](https://github.com/MightyMoud/sidekick) - Bare metal to production ready in mins; your own fly server on your VPS. - 5483 stars
...
- [kolbytn/mindcraft](https://github.com/kolbytn/mindcraft) -  - 1856 stars
- [mc-bench/orchestrator](https://github.com/mc-bench/orchestrator) - Orchestrator to spin up MC server, run Mindcraft agent, save building and run eval - 134 stars
