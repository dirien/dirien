...
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.45](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.45), 1 day ago) - MCP DigitalOcean Integration
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v6.83.3](https://github.com/pulumi/pulumi-aws/releases/tag/v6.83.3), 2 days ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
...
- [rtk-ai/rtk](https://github.com/rtk-ai/rtk) - CLI proxy that reduces LLM token consumption by 60-90% on common dev commands. Single Rust binary, zero dependencies - 27271 stars
- [thesysdev/openui](https://github.com/thesysdev/openui) - The Open Standard for Generative UI - 3449 stars
- [AlexsJones/llama-panel](https://github.com/AlexsJones/llama-panel) - A MacOS llama-server command centre - 15 stars
- [erikzaadi/dnd-fam-ftw](https://github.com/erikzaadi/dnd-fam-ftw) - An AI driven Family D&amp;D Game - 6 stars
- [microsoft/apm](https://github.com/microsoft/apm) - Agent Package Manager - 1181 stars
- [griffinmartin/opencode-claude-auth](https://github.com/griffinmartin/opencode-claude-auth) - OpenCode plugin that uses your existing Claude Code credentials — no separate login needed.  - 843 stars
