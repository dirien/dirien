...
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v6.83.3](https://github.com/pulumi/pulumi-aws/releases/tag/v6.83.3), 1 day ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.44](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.44), 1 day ago) - MCP DigitalOcean Integration
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.21.7](https://github.com/port-labs/pulumi-port/releases/tag/v2.21.7), 6 days ago) - Pulumi Port provider
...
- [thesysdev/openui](https://github.com/thesysdev/openui) - The Open Standard for Generative UI - 3413 stars
- [AlexsJones/llama-panel](https://github.com/AlexsJones/llama-panel) - A MacOS llama-server command centre - 13 stars
- [erikzaadi/dnd-fam-ftw](https://github.com/erikzaadi/dnd-fam-ftw) - An AI driven Family D&amp;D Game - 6 stars
- [microsoft/apm](https://github.com/microsoft/apm) - Agent Package Manager - 1168 stars
- [griffinmartin/opencode-claude-auth](https://github.com/griffinmartin/opencode-claude-auth) - OpenCode plugin that uses your existing Claude Code credentials — no separate login needed.  - 825 stars
...
- [kagenti/kagenti](https://github.com/kagenti/kagenti) - Main Kagenti repo - installer, UI and docs - 180 stars
- [agentregistry-dev/agentregistry](https://github.com/agentregistry-dev/agentregistry) - Fast-track AI innovation with a centralized, trusted, curated registry - 259 stars
...
- [envoyproxy/ai-gateway](https://github.com/envoyproxy/ai-gateway) - Manages Unified Access to Generative AI Services built on Envoy Gateway - 1507 stars
