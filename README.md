...
- [dirien/provider-port](https://github.com/dirien/provider-port) - Crossplane provider for Port (3 days ago)
...
- [ovh/pulumi-ovh](https://github.com/ovh/pulumi-ovh) ([v0.34.2](https://github.com/ovh/pulumi-ovh/releases/tag/v0.34.2), 2 days ago) - Pulumi provider for OVHcloud
...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.10.7](https://github.com/alexellis/arkade/releases/tag/0.10.7), 4 days ago) - Open Source Marketplace For Developer Tools
...
- [dokku/dokku](https://github.com/dokku/dokku) - A docker-powered PaaS that helps you build and manage the lifecycle of applications - 24962 stars
- [progrium/docker-stress](https://github.com/progrium/docker-stress) - Docker container for generating workload stress - 218 stars
- [openziti/ziti](https://github.com/openziti/ziti) - The parent project for OpenZiti. Here you will find the executables for a fully zero trust, application embedded, programmable network @OpenZiti - 1340 stars
- [ergomake/layerform](https://github.com/ergomake/layerform) - Layerform helps engineers create reusable environment stacks using plain .tf files. Ideal for multiple &#34;staging&#34; environments. - 1135 stars
...
- [kdash-rs/kdash](https://github.com/kdash-rs/kdash) - A simple and fast dashboard for Kubernetes - 1589 stars
