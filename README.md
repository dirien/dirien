...
- [Rust in the Cloud: Running Rust Based Functions in AWS](https://blog.ediri.io/rust-in-the-cloud-running-rust-based-functions-in-aws) (1 week ago)
...
- [SchwarzIT/node-red-chart](https://github.com/SchwarzIT/node-red-chart) ([node-red-0.28.0](https://github.com/SchwarzIT/node-red-chart/releases/tag/node-red-0.28.0), 1 day ago) - Node-red Helm Chart
- [pulumi/pulumi-kubernetes-operator](https://github.com/pulumi/pulumi-kubernetes-operator) ([pulumi-kubernetes-operator-0.4.0](https://github.com/pulumi/pulumi-kubernetes-operator/releases/tag/pulumi-kubernetes-operator-0.4.0), 1 day ago) - A Kubernetes Operator that automates the deployment of Pulumi Stacks
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([9.20.0](https://github.com/simple-icons/simple-icons/releases/tag/9.20.0), 1 day ago) - SVG icons for popular brands
- [pulumi/pulumi](https://github.com/pulumi/pulumi) ([v3.93.0](https://github.com/pulumi/pulumi/releases/tag/v3.93.0), 3 days ago) - Pulumi - Infrastructure as Code in any programming language. Build infrastructure intuitively on any cloud using familiar languages 🚀
- [argoproj/argo-helm](https://github.com/argoproj/argo-helm) ([argo-cd-5.51.1](https://github.com/argoproj/argo-helm/releases/tag/argo-cd-5.51.1), 3 days ago) - ArgoProj Helm Charts

#### ⭐ Latest repositories I starred

- [Melkeydev/go-blueprint](https://github.com/Melkeydev/go-blueprint) - Go-blueprint allows users to spin up a quick Go project using a popular framework - 535 stars
- [kubeflow/kubeflow](https://github.com/kubeflow/kubeflow) - Machine Learning Toolkit for Kubernetes - 13137 stars
...
- [numaproj/numaflow](https://github.com/numaproj/numaflow) - Kubernetes-native platform to run massively parallel data/streaming jobs - 815 stars
- [backstage/backstage-deploy](https://github.com/backstage/backstage-deploy) - CLI to help deploy Backstage on your cloud provider - 7 stars
- [adobe/k8s-shredder](https://github.com/adobe/k8s-shredder) - K8s-shredder - an opinionated way of parking in Kubernetes - 45 stars
- [syntasso/kratix](https://github.com/syntasso/kratix) - Kratix is a framework for building Platform-as-a-Product - 323 stars
- [FlowiseAI/Flowise](https://github.com/FlowiseAI/Flowise) - Drag &amp; drop UI to build your customized LLM flow - 17652 stars
- [benwilcock/backstage-plugin-backchat](https://github.com/benwilcock/backstage-plugin-backchat) - A quick and dirty frontend plugin that integrates a GenAI feature into Backstage - 13 stars
- [jmorganca/ollama](https://github.com/jmorganca/ollama) - Get up and running with Llama 2 and other large language models locally - 16714 stars
