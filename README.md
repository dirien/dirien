...
- [dirien/pulumi-minecraft](https://github.com/dirien/pulumi-minecraft) - Pulumi component (Go): a Java Minecraft server on DigitalOcean (4 days ago)
- [dirien/hermes-agent-pulumi](https://github.com/dirien/hermes-agent-pulumi) - Deploy a private Hermes agent as one Pulumi program across Render, Modal, and Tailscale. Companion to the Pulumi blog post. (6 days ago)
...
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.65](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.65), 5 days ago) - MCP DigitalOcean Integration
...
- [visa/visa-vulnerability-agentic-harness](https://github.com/visa/visa-vulnerability-agentic-harness) - Visa Vulnerability Agentic Harness - 575 stars
...
- [CopilotKit/OpenTag](https://github.com/CopilotKit/OpenTag) - OpenTag - 316 stars
- [EpicGames/lore](https://github.com/EpicGames/lore) - Lore is a next-generation, open source version control system - 7111 stars
- [getsentry/dotagents](https://github.com/getsentry/dotagents) -  - 199 stars
- [ngrok/webernetes](https://github.com/ngrok/webernetes) - Kubernetes in the browser. - 649 stars
