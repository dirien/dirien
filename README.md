...
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([12.3.0](https://github.com/simple-icons/simple-icons/releases/tag/12.3.0), 1 day ago) - SVG icons for popular brands
...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.16](https://github.com/alexellis/arkade/releases/tag/0.11.16), 4 days ago) - Open Source Marketplace For Developer Tools
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.3.2](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.3.2), 4 days ago)
- [dirien/pulumi-fly](https://github.com/dirien/pulumi-fly) ([v0.1.13](https://github.com/dirien/pulumi-fly/releases/tag/v0.1.13), 4 days ago) - Pulumi provider for Fly.io
...
- [kserve/kserve](https://github.com/kserve/kserve) - Standardized Serverless ML Inference Platform on Kubernetes - 3223 stars
...
- [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly WebUI for LLMs (Formerly Ollama WebUI) - 27724 stars
...
- [robusta-dev/holmesgpt](https://github.com/robusta-dev/holmesgpt) - On-Call/DevOps Assistant - Get a head start on fixing alerts with AI investigation - 178 stars
- [explodinggradients/ragas](https://github.com/explodinggradients/ragas) - Evaluation framework for your Retrieval Augmented Generation (RAG) pipelines - 5385 stars
