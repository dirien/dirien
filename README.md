...
- [dirien/pulumi-fly](https://github.com/dirien/pulumi-fly) - Pulumi provider for Fly.io (1 day ago)
- [dirien/pulumi-scaleway](https://github.com/dirien/pulumi-scaleway) - Pulumi provider for Scaleway (5 days ago)
- [dirien/pulumi-akp](https://github.com/dirien/pulumi-akp) - Pulumi provider for managing Akuity Platform resources (5 days ago)
...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.16](https://github.com/alexellis/arkade/releases/tag/0.11.16), 1 day ago) - Open Source Marketplace For Developer Tools
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.3.2](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.3.2), 1 day ago)
- [dirien/pulumi-fly](https://github.com/dirien/pulumi-fly) ([v0.1.13](https://github.com/dirien/pulumi-fly/releases/tag/v0.1.13), 1 day ago) - Pulumi provider for Fly.io
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.15](https://github.com/loft-sh/devpod/releases/tag/v0.5.15), 1 day ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
...
- [kserve/kserve](https://github.com/kserve/kserve) - Standardized Serverless ML Inference Platform on Kubernetes - 3221 stars
...
- [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly WebUI for LLMs (Formerly Ollama WebUI) - 27043 stars
- [volcano-sh/volcano](https://github.com/volcano-sh/volcano) - A Cloud Native Batch System (Project under CNCF) - 3862 stars
- [open-cluster-management-io/ocm](https://github.com/open-cluster-management-io/ocm) - Core components in the OCM project. Report here if you found any issues in OCM. - 712 stars
- [submariner-io/submariner](https://github.com/submariner-io/submariner) - Networking component for interconnecting Pods and Services across Kubernetes clusters. - 2356 stars
- [robusta-dev/holmesgpt](https://github.com/robusta-dev/holmesgpt) - On-Call/DevOps Assistant - Get a head start on fixing alerts with AI investigation - 171 stars
- [explodinggradients/ragas](https://github.com/explodinggradients/ragas) - Evaluation framework for your Retrieval Augmented Generation (RAG) pipelines - 5357 stars
- [containers/bootc](https://github.com/containers/bootc) - Boot and upgrade via container images - 447 stars

#### 👥 Latest follower

- [fedihamdi](https://github.com/fedihamdi) - Fedi Hamdi
