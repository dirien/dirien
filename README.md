...
- [ovh/pulumi-ovh](https://github.com/ovh/pulumi-ovh) ([v0.43.1](https://github.com/ovh/pulumi-ovh/releases/tag/v0.43.1), 1 day ago) - Pulumi provider for OVHcloud
- [pulumi/pulumi-backstage-plugin](https://github.com/pulumi/pulumi-backstage-plugin) ([v0.7.0](https://github.com/pulumi/pulumi-backstage-plugin/releases/tag/v0.7.0), 2 days ago) - Pulumi plugin for Backstage
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.38.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.38.0), 2 days ago) - Azure Native Provider
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.6-alpha.2](https://github.com/loft-sh/devpod/releases/tag/v0.5.6-alpha.2), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.

#### ⭐ Latest repositories I starred

- [dicebear/dicebear](https://github.com/dicebear/dicebear) - DiceBear is an avatar library for designers and developers. 🌍 - 6485 stars
- [langfuse/langfuse](https://github.com/langfuse/langfuse) - 🪢 Open source LLM engineering platform. Observability, metrics, evals, prompt management, testing, prompt playground, datasets, LLM evaluations -- 🍊YC W23 🤖 integrate via Typescript, Python / Decorators, OpenAI, Langchain, LlamaIndex, Litellm, Instructor, Mistral, Perplexity, Claude, Gemini, Vertex - 3003 stars
- [langflow-ai/langflow](https://github.com/langflow-ai/langflow) - ⛓️ Langflow is a dynamic graph where each node is an executable unit. Its modular and interactive design fosters rapid experimentation and prototyping, pushing hard on the limits of creativity. - 17143 stars
...
- [cilium/pwru](https://github.com/cilium/pwru) - Packet, where are you? -- eBPF-based Linux kernel networking debugger - 2455 stars
...
- [awslabs/diagram-as-code](https://github.com/awslabs/diagram-as-code) - Diagram-as-code for AWS architecture. - 309 stars
- [turbot/powerpipe](https://github.com/turbot/powerpipe) - Powerpipe: Dashboards for DevOps. Visualize cloud configurations. Assess security posture against a massive library of benchmarks. Build custom dashboards with code. - 89 stars
