...
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.0.23](https://github.com/port-labs/pulumi-port/releases/tag/v2.0.23), 1 day ago) - Pulumi Port provider
...
- [kubescape/kubescape](https://github.com/kubescape/kubescape) ([v3.0.18](https://github.com/kubescape/kubescape/releases/tag/v3.0.18), 2 days ago) - Kubescape is an open-source Kubernetes security platform for your IDE, CI/CD pipelines, and clusters. It includes risk analysis, security, compliance, and misconfiguration scanning, saving Kubernetes users and administrators precious time, effort, and resources.
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.27](https://github.com/alexellis/arkade/releases/tag/0.11.27), 3 days ago) - Open Source Marketplace For Developer Tools
- [dirien/devpod-provider-exoscale](https://github.com/dirien/devpod-provider-exoscale) ([v0.4.0](https://github.com/dirien/devpod-provider-exoscale/releases/tag/v0.4.0), 3 days ago) - DevPod on Exoscale 🇨🇭

#### ⭐ Latest repositories I starred

- [muesli/termenv](https://github.com/muesli/termenv) - Advanced ANSI style &amp; color support for your terminal applications - 1725 stars
...
- [temporalio/temporal](https://github.com/temporalio/temporal) - Temporal service - 11538 stars
- [cdklabs/cdk-nag](https://github.com/cdklabs/cdk-nag) - Check CDK applications for best practices using a combination of available rule packs - 806 stars
- [awslabs/aws-lambda-web-adapter](https://github.com/awslabs/aws-lambda-web-adapter) - Run web applications on AWS Lambda - 1857 stars
...
- [trufflesecurity/trufflehog](https://github.com/trufflesecurity/trufflehog) - Find, verify, and analyze leaked credentials - 15789 stars
