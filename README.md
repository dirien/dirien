...
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.23.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.23.0), today) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
...
- [tisu19021997/langclaw](https://github.com/tisu19021997/langclaw) - Langchain &#43; Openclaw = Langclaw - 27 stars
...
- [can1357/oh-my-pi](https://github.com/can1357/oh-my-pi) - ⌥  AI Coding agent for the terminal — hash-anchored edits, optimized tool harness, LSP, Python, browser, subagents, and more - 1907 stars
- [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) - omo; the best agent harness - previously oh-my-opencode - 39432 stars
- [github/gh-aw](https://github.com/github/gh-aw) - GitHub Agentic Workflows - 4074 stars
...
- [openclaw-rocks/k8s-operator](https://github.com/openclaw-rocks/k8s-operator) - Kubernetes operator for deploying and managing OpenClaw AI agent instances with production-grade security, observability, and lifecycle management. - 189 stars
- [bradygaster/squad](https://github.com/bradygaster/squad) - Squad: AI agent teams for any project - 773 stars
- [GoogleCloudPlatform/generative-ai](https://github.com/GoogleCloudPlatform/generative-ai) - Sample code and notebooks for Generative AI on Google Cloud, with Gemini on Vertex AI - 16064 stars
- [affaan-m/everything-claude-code](https://github.com/affaan-m/everything-claude-code) - The agent harness performance optimization system. Skills, instincts, memory, security, and research-first development for Claude Code, Codex, Opencode, Cursor and beyond. - 73198 stars
