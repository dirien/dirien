...
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.50](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.50), 1 day ago) - MCP DigitalOcean Integration
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.27.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.27.0), 5 days ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
...
- [microsoft/Hosted_Agents_Workshop_dotNET](https://github.com/microsoft/Hosted_Agents_Workshop_dotNET) - Build your first Microsoft Foundry hosted agent with this hands-on .NET 10 workshop, covering local development, Copilot-assisted coding, CI, secure deployment to Azure, and a working chat UI. - 11 stars
- [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) - ClawSweeper scans all issues and PRs and suggest what we can close, and why. It runs every PR / Issue once a week. - 1194 stars
- [Azure-Samples/foundry-hosted-agentframework-demos](https://github.com/Azure-Samples/foundry-hosted-agentframework-demos) - A demo project that deploys Agent Framework agent to Foundry Hosted Agents - 11 stars
- [microsoft/openclaw](https://github.com/microsoft/openclaw) - Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞  - 46 stars
...
- [multica-ai/multica](https://github.com/multica-ai/multica) - The open-source managed agents platform. Turn coding agents into real teammates — assign tasks, track progress, compound skills. - 22002 stars
- [excalidraw/excalidraw-mcp](https://github.com/excalidraw/excalidraw-mcp) - Fast and streamable Excalidraw MCP App - 4206 stars
- [TencentCloud/CubeSandbox](https://github.com/TencentCloud/CubeSandbox) - Instant, Concurrent, Secure &amp; Lightweight Sandbox for AI Agents. - 4381 stars
- [BlockRunAI/ClawRouter](https://github.com/BlockRunAI/ClawRouter) - The agent-native LLM router for OpenClaw. 41&#43; models, &lt;1ms routing, USDC payments on Base &amp; Solana via x402. - 6370 stars
- [obot-platform/discobot](https://github.com/obot-platform/discobot) - Coding Agent - 67 stars
