...
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.20-alpha.4](https://github.com/loft-sh/devpod/releases/tag/v0.5.20-alpha.4), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.23](https://github.com/alexellis/arkade/releases/tag/0.11.23), 4 days ago) - Open Source Marketplace For Developer Tools
- [langchain-ai/langserve](https://github.com/langchain-ai/langserve) ([v0.2.3](https://github.com/langchain-ai/langserve/releases/tag/v0.2.3), 4 days ago) - LangServe 🦜️🏓
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.8.0](https://github.com/simple-icons/simple-icons/releases/tag/13.8.0), 5 days ago) - SVG icons for popular brands

#### ⭐ Latest repositories I starred

- [mendableai/firecrawl](https://github.com/mendableai/firecrawl) - 🔥 Turn entire websites into LLM-ready markdown or structured data. Scrape, crawl and extract with a single API. - 12922 stars
- [Stengo/DeskPad](https://github.com/Stengo/DeskPad) - A virtual monitor for screen sharing - 952 stars
- [usebruno/bruno](https://github.com/usebruno/bruno) - Opensource IDE For Exploring and Testing Api&#39;s (lightweight alternative to postman/insomnia) - 24921 stars
- [d07RiV/diabloweb](https://github.com/d07RiV/diabloweb) - Diablo 1 for web browsers - 2688 stars
