...
- [my-silly-organisation/backstage](https://github.com/my-silly-organisation/backstage) -  (2 days ago)
- [dirien/pulumi-github](https://github.com/dirien/pulumi-github) - Pulumi program to manage my GitHub repositories (6 days ago)
- [dirien/backstage-demo](https://github.com/dirien/backstage-demo) -  (6 days ago)
- [dirien/pulumi-fly](https://github.com/dirien/pulumi-fly) - Pulumi provider for Fly.io (1 week ago)

#### 🚀 Latest releases I contributed to

- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.31](https://github.com/alexellis/arkade/releases/tag/0.11.31), 4 days ago) - Open Source Marketplace For Developer Tools
- [pulumiverse/pulumi-scaleway](https://github.com/pulumiverse/pulumi-scaleway) ([v1.20.0](https://github.com/pulumiverse/pulumi-scaleway/releases/tag/v1.20.0), 6 days ago) - Pulumi provider for Scaleway
...
- [hyperlight-dev/hyperlight](https://github.com/hyperlight-dev/hyperlight) - Hyperlight is a lightweight Virtual Machine Manager (VMM) designed to be embedded within applications. It enables safe execution of untrusted code within micro virtual machines with very low latency and minimal overhead. - 1148 stars
...
- [pterm/pterm](https://github.com/pterm/pterm) - ✨ #PTerm is a modern Go module to easily beautify console output. Featuring charts, progressbars, tables, trees, text input, select menus and much more 🚀 It&#39;s completely configurable and 100% cross-platform compatible. - 4844 stars
- [MightyMoud/sidekick](https://github.com/MightyMoud/sidekick) - Bare metal to production ready in mins; your own fly server on your VPS. - 5726 stars
...
- [kolbytn/mindcraft](https://github.com/kolbytn/mindcraft) -  - 1921 stars
- [mc-bench/orchestrator](https://github.com/mc-bench/orchestrator) - Orchestrator to spin up MC server, connect mineflayer bot, generate &#43; execute build commands and export the structure - 135 stars
- [AvitalTamir/cyphernetes](https://github.com/AvitalTamir/cyphernetes) - A Kubernetes Query Language - 500 stars
...
- [schednex-ai/schednex](https://github.com/schednex-ai/schednex) - Smart Kubernetes Scheduling - 63 stars
