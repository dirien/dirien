...
- [dirien/devpod-provider-equinix](https://github.com/dirien/devpod-provider-equinix) - DevPod on Equinix Metal (6 days ago)
...
- [fluxcd-community/helm-charts](https://github.com/fluxcd-community/helm-charts) ([flux2-sync-1.10.0](https://github.com/fluxcd-community/helm-charts/releases/tag/flux2-sync-1.10.0), 2 days ago) - Community maintained Helm charts for Flux
- [pulumi/pulumi-backstage-plugin](https://github.com/pulumi/pulumi-backstage-plugin) ([v0.15.0](https://github.com/pulumi/pulumi-backstage-plugin/releases/tag/v0.15.0), 3 days ago) - Pulumi plugin for Backstage
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.0.23](https://github.com/port-labs/pulumi-port/releases/tag/v2.0.23), 4 days ago) - Pulumi Port provider
- [kubescape/kubescape](https://github.com/kubescape/kubescape) ([v3.0.18](https://github.com/kubescape/kubescape/releases/tag/v3.0.18), 5 days ago) - Kubescape is an open-source Kubernetes security platform for your IDE, CI/CD pipelines, and clusters. It includes risk analysis, security, compliance, and misconfiguration scanning, saving Kubernetes users and administrators precious time, effort, and resources.

#### ⭐ Latest repositories I starred

- [kubernetes-sigs/cloud-provider-kind](https://github.com/kubernetes-sigs/cloud-provider-kind) - Cloud provider for KIND clusters - 157 stars
...
- [containers/toolbox](https://github.com/containers/toolbox) - Tool for interactive command line environments on Linux - 2511 stars
- [moonrepo/moon](https://github.com/moonrepo/moon) - A build system and monorepo management tool for the web ecosystem, written in Rust. - 2855 stars
