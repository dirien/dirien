...
- [dirien/equinix-demo-day-deploy-bare-metal-kubernetes-with-pulumi-on-equinix-metal](https://github.com/dirien/equinix-demo-day-deploy-bare-metal-kubernetes-with-pulumi-on-equinix-metal) -  (5 days ago)
...
- [langchain-ai/langserve](https://github.com/langchain-ai/langserve) ([v0.3.0](https://github.com/langchain-ai/langserve/releases/tag/v0.3.0), 1 day ago) - LangServe 🦜️🏓
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.20](https://github.com/loft-sh/devpod/releases/tag/v0.5.20), 1 day ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
...
- [chronosphereio/pulumi-chronosphere](https://github.com/chronosphereio/pulumi-chronosphere) ([v0.9.2](https://github.com/chronosphereio/pulumi-chronosphere/releases/tag/v0.9.2), 6 days ago) - Chronosphere Pulumi Provider

#### ⭐ Latest repositories I starred

- [guymenahem/backstage-demo](https://github.com/guymenahem/backstage-demo) -  - 3 stars
- [treebeardtech/kubeflow-bootstrap](https://github.com/treebeardtech/kubeflow-bootstrap) - 🪐 1-click Kubeflow using ArgoCD - 55 stars
- [evoxmusic/qovery-airbyte](https://github.com/evoxmusic/qovery-airbyte) - Deploy Airbyte on Kubernetes with Qovery - 3 stars
- [mendableai/firecrawl](https://github.com/mendableai/firecrawl) - 🔥 Turn entire websites into LLM-ready markdown or structured data. Scrape, crawl and extract with a single API. - 13787 stars
- [Stengo/DeskPad](https://github.com/Stengo/DeskPad) - A virtual monitor for screen sharing - 973 stars
- [usebruno/bruno](https://github.com/usebruno/bruno) - Opensource IDE For Exploring and Testing Api&#39;s (lightweight alternative to postman/insomnia) - 25295 stars
- [d07RiV/diabloweb](https://github.com/d07RiV/diabloweb) - Diablo 1 for web browsers - 2702 stars
- [cryptocode/terminal-doom](https://github.com/cryptocode/terminal-doom) - Play DOOM in modern terminals - 113 stars
