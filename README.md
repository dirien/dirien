...
- [kebap-stack/reference-implementation](https://github.com/kebap-stack/reference-implementation) -  (4 days ago)
- [kebap-stack/.github](https://github.com/kebap-stack/.github) -  (5 days ago)
...
- [external-secrets/external-secrets](https://github.com/external-secrets/external-secrets) ([helm-chart-0.9.16](https://github.com/external-secrets/external-secrets/releases/tag/helm-chart-0.9.16), 1 day ago) - External Secrets Operator reads information from a third-party service like AWS Secrets Manager and automatically injects the values as Kubernetes Secrets.
...
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-agent-0.7.11](https://github.com/port-labs/helm-charts/releases/tag/port-agent-0.7.11), 1 day ago)
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.6-alpha.1](https://github.com/loft-sh/devpod/releases/tag/v0.5.6-alpha.1), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.

#### ⭐ Latest repositories I starred

- [langfuse/langfuse](https://github.com/langfuse/langfuse) - 🪢 Open source LLM engineering platform. Observability, metrics, evals, prompt management, testing, prompt playground, datasets, LLM evaluations -- 🍊YC W23 🤖 integrate via Typescript, Python / Decorators, OpenAI, Langchain, LlamaIndex, Litellm, Instructor, Mistral, Perplexity, Claude, Gemini, Vertex - 2902 stars
- [langflow-ai/langflow](https://github.com/langflow-ai/langflow) - ⛓️ Langflow is a dynamic graph where each node is an executable unit. Its modular and interactive design fosters rapid experimentation and prototyping, pushing hard on the limits of creativity. - 16939 stars
...
- [mziyabo/argocd-trivy-extension](https://github.com/mziyabo/argocd-trivy-extension) - An Argo CD extension to enable visualization of Trivy generated vulnerability reports in Argo CD UI.  - 42 stars
- [cilium/pwru](https://github.com/cilium/pwru) - Packet, where are you? -- eBPF-based Linux kernel networking debugger - 2444 stars
...
- [turbot/powerpipe](https://github.com/turbot/powerpipe) - Powerpipe: Dashboards for DevOps. Visualize cloud configurations. Assess security posture against a massive library of benchmarks. Build custom dashboards with code. - 87 stars
