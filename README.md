...
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) - Pulumi Port provider (2 days ago)
...
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-k8s-exporter-0.2.28](https://github.com/port-labs/helm-charts/releases/tag/port-k8s-exporter-0.2.28), 1 day ago)
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.42.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.42.0), 2 days ago) - Azure Native Provider
- [SchwarzIT/node-red-chart](https://github.com/SchwarzIT/node-red-chart) ([node-red-0.32.1](https://github.com/SchwarzIT/node-red-chart/releases/tag/node-red-0.32.1), 2 days ago) - Node-red Helm Chart

#### ⭐ Latest repositories I starred

- [containers/bootc](https://github.com/containers/bootc) - Boot and upgrade via container images - 396 stars
- [kubecolor/kubecolor](https://github.com/kubecolor/kubecolor) - Colorize your kubectl output - 413 stars
...
- [octodns/octodns](https://github.com/octodns/octodns) - Tools for managing DNS across multiple providers - 2992 stars
- [sigoden/aichat](https://github.com/sigoden/aichat) - All-in-one AI-Powered CLI Chat &amp; Copilot that integrates 20&#43; AI platforms, including OpenAI, Azure-OpenAI, Gemini, Claude, Mistral, Cohere, VertexAI, Bedrock, Ollama, Ernie, Qianwen, Deepseek... - 2978 stars
- [jozu-ai/kitops](https://github.com/jozu-ai/kitops) - Tools for easing the handoff between AI/ML and App/SRE teams. - 191 stars
- [inkdrop-org/inkdrop-visualizer](https://github.com/inkdrop-org/inkdrop-visualizer) - Visualizes your Terraform - 402 stars
