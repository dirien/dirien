...
- [jaxxstorm/pulumi-examples](https://github.com/jaxxstorm/pulumi-examples) -  (3 days ago)
- [dirien/pulumi-java-azure-kubernetes](https://github.com/dirien/pulumi-java-azure-kubernetes) - Playing with the new Pulumi Java (4 days ago)

#### 🚀 Latest releases I contributed to

- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.720.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.720.0), 1 day ago) - Fig adds autocomplete to your terminal.
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([6.21.0](https://github.com/simple-icons/simple-icons/releases/tag/6.21.0), 1 day ago) - SVG icons for popular brands
...
- [inlets/inlets-pro](https://github.com/inlets/inlets-pro) ([0.9.4-rc1](https://github.com/inlets/inlets-pro/releases/tag/0.9.4-rc1), 3 days ago) - Secure HTTP and TCP tunnels that just work
- [SchwarzIT/go-template](https://github.com/SchwarzIT/go-template) ([v0.4.0](https://github.com/SchwarzIT/go-template/releases/tag/v0.4.0), 6 days ago) - go/template is a tool for jumpstarting production-ready Golang projects quickly.

#### ⭐ Latest repositories I starred

- [weaveworks/weave-gitops](https://github.com/weaveworks/weave-gitops) - Weave GitOps core - 272 stars
- [candrewlee14/webman](https://github.com/candrewlee14/webman) - Simple cross-platform package manager - 12 stars
...
- [kyverno/kyverno](https://github.com/kyverno/kyverno) - Kubernetes Native Policy Management - 2347 stars
- [psampaz/go-mod-outdated](https://github.com/psampaz/go-mod-outdated) - Find outdated dependencies of your Go projects. go-mod-outdated provides a table view of the go list -u -m -json all command which lists all dependencies of a Go project and their available minor and patch updates. It also provides a way to filter indirect dependencies and dependencies without updates. - 573 stars
- [keisku/kubectl-explore](https://github.com/keisku/kubectl-explore) - A better kubectl explain with the fuzzy finder - 120 stars
- [kubernetes/git-sync](https://github.com/kubernetes/git-sync) - A sidecar app which clones a git repo and keeps it in sync with the upstream. - 1404 stars
...
- [kubernetes/ingress-nginx](https://github.com/kubernetes/ingress-nginx) - NGINX Ingress Controller for Kubernetes - 12656 stars
- [guymenahem/the-kubernetes-journey](https://github.com/guymenahem/the-kubernetes-journey) - The community journey to master Kubernetes - 37 stars
