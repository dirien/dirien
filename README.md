...
- [How to cross-compile your Rust applications using cross-rs and GitHub Actions](https://blog.ediri.io/how-to-cross-compile-your-rust-applications-using-cross-rs-and-github-actions) (2 days ago)
- [Kubernetes 1.26: Implementing Validating Admission Policies with Pulumi](https://blog.ediri.io/kubernetes-126-implementing-validating-admission-policies-with-pulumi) (2 days ago)
...
- [dirien/rust-cross-compile](https://github.com/dirien/rust-cross-compile) - Cross compiling Rust for different architectures and operating systems (2 days ago)
...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.9.26](https://github.com/alexellis/arkade/releases/tag/0.9.26), 1 day ago) - Open Source Marketplace For Developer Tools
- [dirien/rust-cross-compile](https://github.com/dirien/rust-cross-compile) ([v0.1.0](https://github.com/dirien/rust-cross-compile/releases/tag/v0.1.0), 2 days ago) - Cross compiling Rust for different architectures and operating systems
- [dirien/pulumi-github](https://github.com/dirien/pulumi-github) ([v0.2.30](https://github.com/dirien/pulumi-github/releases/tag/v0.2.30), 2 days ago) - Pulumi program to manage my GitHub repositories
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.1.1](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.1.1), 2 days ago)
...
- [UTFeight/Charisma](https://github.com/UTFeight/Charisma) - API Client to Generate AI ASCII Art 🦾🧠 - 8 stars
