...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.8.28](https://github.com/alexellis/arkade/releases/tag/0.8.28), 1 day ago) - Open Source Marketplace For Kubernetes
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.775.1](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.775.1), 1 day ago) - Fig adds autocomplete to your terminal.
...
- [vladimirvivien/ktop](https://github.com/vladimirvivien/ktop) ([v0.3.0](https://github.com/vladimirvivien/ktop/releases/tag/v0.3.0), 3 days ago) - A top-like tool for your Kubernetes clusters
...
- [automatiko-io/automatiko-approval-task](https://github.com/automatiko-io/automatiko-approval-task) - Tekton Pipeline Custom task implementation to add approval capabilities into the pipelines - 7 stars
...
- [chainguard-dev/ssc-reading-list](https://github.com/chainguard-dev/ssc-reading-list) - A reading list for software supply-chain security. - 208 stars
...
- [triggermesh/triggermesh](https://github.com/triggermesh/triggermesh) - Open source event-driven integration platform powered by Kubernetes and Knative. TriggerMesh allows you to declaratively define event flows between sources and targets, with content-based filtering, splitting and processing using functions. - 305 stars
- [open-feature/open-feature-operator](https://github.com/open-feature/open-feature-operator) - A Kubernetes feature flag operator - 9 stars
- [gimlet-io/gimlet](https://github.com/gimlet-io/gimlet) - Build and run a developer platform on Kubernetes - 58 stars
...
- [Shrey-Srivastava21](https://github.com/Shrey-Srivastava21) - Shrey Srivastava
