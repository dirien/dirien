...
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.20-alpha.4](https://github.com/loft-sh/devpod/releases/tag/v0.5.20-alpha.4), 4 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.23](https://github.com/alexellis/arkade/releases/tag/0.11.23), 6 days ago) - Open Source Marketplace For Developer Tools
- [langchain-ai/langserve](https://github.com/langchain-ai/langserve) ([v0.2.3](https://github.com/langchain-ai/langserve/releases/tag/v0.2.3), 6 days ago) - LangServe 🦜️🏓

#### ⭐ Latest repositories I starred

- [mendableai/firecrawl](https://github.com/mendableai/firecrawl) - 🔥 Turn entire websites into LLM-ready markdown or structured data. Scrape, crawl and extract with a single API. - 13155 stars
- [Stengo/DeskPad](https://github.com/Stengo/DeskPad) - A virtual monitor for screen sharing - 957 stars
- [usebruno/bruno](https://github.com/usebruno/bruno) - Opensource IDE For Exploring and Testing Api&#39;s (lightweight alternative to postman/insomnia) - 25025 stars
...
- [sighupio/permission-manager](https://github.com/sighupio/permission-manager) - Permission Manager is a project that brings sanity to Kubernetes RBAC and Users management, Web UI FTW - 1287 stars
