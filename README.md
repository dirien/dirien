...
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-agent-0.6.1](https://github.com/port-labs/helm-charts/releases/tag/port-agent-0.6.1), 3 days ago)
- [aquasecurity/trivy-operator](https://github.com/aquasecurity/trivy-operator) ([v0.17.0-rc](https://github.com/aquasecurity/trivy-operator/releases/tag/v0.17.0-rc), 3 days ago) - Kubernetes-native security toolkit
...
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.21.0-next.1](https://github.com/backstage/backstage/releases/tag/v1.21.0-next.1), 5 days ago) - Backstage is an open platform for building developer portals
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.19.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.19.0), 5 days ago) - Azure Native Provider
...
- [charmbracelet/gum](https://github.com/charmbracelet/gum) - A tool for glamorous shell scripts 🎀 - 15268 stars
- [distribworks/dkron](https://github.com/distribworks/dkron) - Dkron - Distributed, fault tolerant job scheduling system https://dkron.io - 3946 stars
...
- [isotope-rs/isotope](https://github.com/isotope-rs/isotope) - AWS superpowers with the power of bedrock and speed of rust - 47 stars
- [zakkg3/ClusterSecret](https://github.com/zakkg3/ClusterSecret) - Kubernetes ClusterSecret operator. - 313 stars
- [Melkeydev/go-blueprint](https://github.com/Melkeydev/go-blueprint) - Go-blueprint allows users to spin up a quick Go project using a popular framework - 879 stars
- [kubeflow/kubeflow](https://github.com/kubeflow/kubeflow) - Machine Learning Toolkit for Kubernetes - 13171 stars
