...
- [dirien/coding-task-test](https://github.com/dirien/coding-task-test) -  (2 days ago)
...
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.19.6](https://github.com/port-labs/pulumi-port/releases/tag/v2.19.6), 1 day ago) - Pulumi Port provider
- [dirien/lazy-pulumi](https://github.com/dirien/lazy-pulumi) ([v0.7.0](https://github.com/dirien/lazy-pulumi/releases/tag/v0.7.0), 4 days ago) - A terminal UI (TUI) application for Pulumi Cloud
...
- [gsd-build/get-shit-done](https://github.com/gsd-build/get-shit-done) - A light-weight and powerful meta-prompting, context engineering and spec-driven development system for Claude Code and OpenCode. - 13483 stars
- [sipeed/picoclaw](https://github.com/sipeed/picoclaw) - picoclaw - 4360 stars
- [rohitg00/skillkit](https://github.com/rohitg00/skillkit) - Supercharge AI coding agents with portable skills. Install, translate &amp; share skills across Claude Code, Cursor, Codex, Copilot &amp; 40 more - 308 stars
- [rohitg00/pro-workflow](https://github.com/rohitg00/pro-workflow) - Battle-tested Claude Code workflows from power users. Self-correcting memory, parallel worktrees, wrap-up rituals, and the 80/20 AI coding ratio. - 855 stars
- [kubernetes-sigs/agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox) - agent-sandbox enables easy management of isolated, stateful, singleton workloads, ideal for use cases like AI agent runtimes. - 951 stars
- [nestybox/sysbox](https://github.com/nestybox/sysbox) - An open-source, next-generation &#34;runc&#34; that empowers rootless containers to run workloads such as Systemd, Docker, Kubernetes, just like VMs. - 3448 stars
- [agent-sandbox/agent-sandbox](https://github.com/agent-sandbox/agent-sandbox) - Agent Sandbox is an E2B compatible, enterprise-grade ai-first, cloud-native runtime environment for AI Agents. Allows Agents to securely run untrusted LLM-generated Code, Browser use, Computer use, and Shell commands etc. with stateful, long-running, multi-session and multi-tenant. - 57 stars
- [pranshuparmar/witr](https://github.com/pranshuparmar/witr) - Why is this running? - 13148 stars
- [oxidecomputer/progenitor](https://github.com/oxidecomputer/progenitor) - An OpenAPI client generator - 847 stars
- [abiosoft/colima](https://github.com/abiosoft/colima) - Container runtimes on macOS (and Linux) with minimal setup - 26883 stars
