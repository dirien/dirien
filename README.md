...
- [A Step-by-Step Guide to Using Velero on AWS EKS Clusters via Pulumi](https://blog.ediri.io/a-step-by-step-guide-to-using-velero-on-aws-eks-clusters-via-pulumi) (1 day ago)
...
- [aquasecurity/trivy-operator](https://github.com/aquasecurity/trivy-operator) ([v0.16.0-rc](https://github.com/aquasecurity/trivy-operator/releases/tag/v0.16.0-rc), 1 day ago) - Kubernetes-native security toolkit
...
- [dirien/devpod-provider-equinix](https://github.com/dirien/devpod-provider-equinix) ([v0.2.2](https://github.com/dirien/devpod-provider-equinix/releases/tag/v0.2.2), 2 days ago) - DevPod on Equinix Metal
- [dirien/devpod-provider-scaleway](https://github.com/dirien/devpod-provider-scaleway) ([v0.4.2](https://github.com/dirien/devpod-provider-scaleway/releases/tag/v0.4.2), 2 days ago) - DevPod on Scaleway 🇫🇷
...
- [ergomake/layerform](https://github.com/ergomake/layerform) - Layerform helps engineers create reusable environment stacks using plain .tf files. Ideal for multiple &#34;staging&#34; environments. - 931 stars
...
- [kdash-rs/kdash](https://github.com/kdash-rs/kdash) - A simple and fast dashboard for Kubernetes - 1484 stars
- [mochi-mqtt/server](https://github.com/mochi-mqtt/server) - The fully compliant, embeddable high-performance Go MQTT v5 server for IoT, smarthome, and pubsub - 700 stars
- [eigr/spawn](https://github.com/eigr/spawn) - Spawn - Actor Mesh - 133 stars
- [kcl-lang/kcl](https://github.com/kcl-lang/kcl) - A constraint-based record &amp; functional language mainly used in configuration and policy scenarios. https://kcl-lang.io - 748 stars
- [IBM/fp-go](https://github.com/IBM/fp-go) - functional programming library for golang - 1086 stars
- [undistro/zora](https://github.com/undistro/zora) - Zora is a multi-cluster scan that helps you identify potential issues and vulnerabilities in your Kubernetes clusters. - 182 stars
- [org-formation/org-formation-cli](https://github.com/org-formation/org-formation-cli) - Better than landingzones! - 1234 stars
