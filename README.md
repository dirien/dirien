...
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.36.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.36.0), 1 day ago) - Azure Native Provider
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-k8s-exporter-0.2.21](https://github.com/port-labs/helm-charts/releases/tag/port-k8s-exporter-0.2.21), 1 day ago)
- [dirien/minectl](https://github.com/dirien/minectl) ([v0.51.0](https://github.com/dirien/minectl/releases/tag/v0.51.0), 2 days ago) - minectl 🗺  is a cli for creating Minecraft server on different cloud provider.
- [dirien/minectl-sdk](https://github.com/dirien/minectl-sdk) ([v0.17.0](https://github.com/dirien/minectl-sdk/releases/tag/v0.17.0), 2 days ago) - SDK for every minectl product
- [dirien/devpod-provider-equinix](https://github.com/dirien/devpod-provider-equinix) ([v0.5.0](https://github.com/dirien/devpod-provider-equinix/releases/tag/v0.5.0), 2 days ago) - DevPod on Equinix Metal

#### ⭐ Latest repositories I starred

- [cncf/foundation](https://github.com/cncf/foundation) - ☁️♮🏛 This repo contains several documents related to the operation of the CNCF. File non-technical issues related to CNCF here. - 520 stars
- [mziyabo/argocd-trivy-extension](https://github.com/mziyabo/argocd-trivy-extension) - An Argo CD extension to enable visualization of Trivy generated vulnerability reports in Argo CD UI.  - 14 stars
- [cilium/pwru](https://github.com/cilium/pwru) - Packet, where are you? -- eBPF-based Linux kernel networking debugger - 2419 stars
- [nixys/nxs-universal-chart](https://github.com/nixys/nxs-universal-chart) - The Helm chart you can use to install any of your applications into Kubernetes/OpenShift - 315 stars
- [awslabs/diagram-as-code](https://github.com/awslabs/diagram-as-code) - Diagram-as-code for AWS architecture. - 305 stars
- [turbot/powerpipe](https://github.com/turbot/powerpipe) - Powerpipe: Dashboards for DevOps. Visualize cloud configurations. Assess security posture against a massive library of benchmarks. Build custom dashboards with code. - 75 stars
- [levkush/termvideo](https://github.com/levkush/termvideo) - Play videos from a terminal with audio support! 🚀 - 9 stars
- [hcavarsan/kftray](https://github.com/hcavarsan/kftray) - kubectl port-forward on steroids ⚡ |  kftray makes it easy for you to manage and share multiple k8s port forwards right from your menu bar - built with rust 🦀 and ts using tauri - 376 stars
