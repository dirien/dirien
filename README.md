...
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.5.0](https://github.com/simple-icons/simple-icons/releases/tag/13.5.0), 3 days ago) - SVG icons for popular brands
- [dirien/pulumi-qovery](https://github.com/dirien/pulumi-qovery) ([v0.37.0](https://github.com/dirien/pulumi-qovery/releases/tag/v0.37.0), 5 days ago) - Pulumi provider for Qovery
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.20-alpha.0](https://github.com/loft-sh/devpod/releases/tag/v0.5.20-alpha.0), 5 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.19](https://github.com/alexellis/arkade/releases/tag/0.11.19), 6 days ago) - Open Source Marketplace For Developer Tools

#### ⭐ Latest repositories I starred

- [cryptocode/terminal-doom](https://github.com/cryptocode/terminal-doom) - Play DOOM in modern terminals - 81 stars
...
- [infiniflow/ragflow](https://github.com/infiniflow/ragflow) - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding. - 14020 stars
