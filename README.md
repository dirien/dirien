...
- [pulumi/actions](https://github.com/pulumi/actions) ([v5.2.0](https://github.com/pulumi/actions/releases/tag/v5.2.0), 1 day ago) - Deploy continuously to your cloud of choice, using your favorite language, Pulumi, and GitHub!
- [ovh/pulumi-ovh](https://github.com/ovh/pulumi-ovh) ([v0.40.1](https://github.com/ovh/pulumi-ovh/releases/tag/v0.40.1), 1 day ago) - Pulumi provider for OVHcloud
...
- [pinecone-io/pulumi-pinecone](https://github.com/pinecone-io/pulumi-pinecone) ([v0.4.1](https://github.com/pinecone-io/pulumi-pinecone/releases/tag/v0.4.1), 2 days ago) - Pinecone Pulumi Provider
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v1.10.5](https://github.com/port-labs/pulumi-port/releases/tag/v1.10.5), 3 days ago)

#### ⭐ Latest repositories I starred

- [microsoft/retina](https://github.com/microsoft/retina) - eBPF distributed networking observability tool for Kubernetes - 2041 stars
- [spinkube/spin-operator](https://github.com/spinkube/spin-operator) - Spin Operator is a Kubernetes operator that empowers platform engineers to deploy Spin applications as custom resources to their Kubernetes clusters - 70 stars
- [llmnetes/llmnetes](https://github.com/llmnetes/llmnetes) -  - 29 stars
- [Azure/kaito](https://github.com/Azure/kaito) - Kubernetes AI Toolchain Operator - 232 stars
- [SchedMD/slurm](https://github.com/SchedMD/slurm) - Slurm: A Highly Scalable Workload Manager - 2288 stars
- [daytonaio/daytona](https://github.com/daytonaio/daytona) - The Open Source Dev Environment Manager. - 4859 stars
- [embedchain/embedchain](https://github.com/embedchain/embedchain) - Personalizing LLM Responses - 8324 stars
...
- [cirruslabs/tart](https://github.com/cirruslabs/tart) - macOS and Linux VMs on Apple Silicon to use in CI and other automations - 3441 stars
