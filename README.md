...
- [my-silly-organisation/backstage](https://github.com/my-silly-organisation/backstage) -  (1 day ago)
...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.31](https://github.com/alexellis/arkade/releases/tag/0.11.31), 3 days ago) - Open Source Marketplace For Developer Tools
- [pulumiverse/pulumi-scaleway](https://github.com/pulumiverse/pulumi-scaleway) ([v1.20.0](https://github.com/pulumiverse/pulumi-scaleway/releases/tag/v1.20.0), 5 days ago) - Pulumi provider for Scaleway
- [dirien/pulumi-fly](https://github.com/dirien/pulumi-fly) ([v0.1.18](https://github.com/dirien/pulumi-fly/releases/tag/v0.1.18), 6 days ago) - Pulumi provider for Fly.io
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.16.0](https://github.com/simple-icons/simple-icons/releases/tag/13.16.0), 6 days ago) - SVG icons for popular brands
...
- [hyperlight-dev/hyperlight](https://github.com/hyperlight-dev/hyperlight) - Hyperlight is a lightweight Virtual Machine Manager (VMM) designed to be embedded within applications. It enables safe execution of untrusted code within micro virtual machines with very low latency and minimal overhead. - 536 stars
...
- [pterm/pterm](https://github.com/pterm/pterm) - ✨ #PTerm is a modern Go module to easily beautify console output. Featuring charts, progressbars, tables, trees, text input, select menus and much more 🚀 It&#39;s completely configurable and 100% cross-platform compatible. - 4840 stars
- [MightyMoud/sidekick](https://github.com/MightyMoud/sidekick) - Bare metal to production ready in mins; your own fly server on your VPS. - 5679 stars
...
- [kolbytn/mindcraft](https://github.com/kolbytn/mindcraft) -  - 1904 stars
...
- [schednex-ai/schednex](https://github.com/schednex-ai/schednex) - Smart Kubernetes Scheduling - 62 stars
