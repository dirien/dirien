...
- [dirien/parlez-vous-pulumi](https://github.com/dirien/parlez-vous-pulumi) - Creating an EKS cluster with Pulumi in different programming languages (4 days ago)

#### 🚀 Latest releases I contributed to

- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1138.1](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1138.1), 1 day ago) - IDE-style autocomplete for your existing terminal &amp; shell
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([8.7.0](https://github.com/simple-icons/simple-icons/releases/tag/8.7.0), 3 days ago) - SVG icons for popular brands
- [dirien/pulumi-github](https://github.com/dirien/pulumi-github) ([v0.2.21](https://github.com/dirien/pulumi-github/releases/tag/v0.2.21), 4 days ago) - Pulumi program to manage my GitHub repositories
- [aquasecurity/helm-charts](https://github.com/aquasecurity/helm-charts) ([trivy-operator-0.12.1](https://github.com/aquasecurity/helm-charts/releases/tag/trivy-operator-0.12.1), 5 days ago) - Aqua Open Source Helm Chart Repository
- [aquasecurity/trivy-operator](https://github.com/aquasecurity/trivy-operator) ([v0.12.1](https://github.com/aquasecurity/trivy-operator/releases/tag/v0.12.1), 5 days ago) - Kubernetes-native security toolkit
...
- [bevyengine/bevy](https://github.com/bevyengine/bevy) - A refreshingly simple data-driven game engine built in Rust - 22661 stars
...
- [tokio-rs/tracing](https://github.com/tokio-rs/tracing) - Application level tracing for Rust. - 3635 stars
