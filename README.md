...
- [dirien/devpod-provider-exoscale](https://github.com/dirien/devpod-provider-exoscale) ([v0.3.0](https://github.com/dirien/devpod-provider-exoscale/releases/tag/v0.3.0), 1 day ago) - DevPod on Exoscale 🇨🇭
- [dirien/devpod-provider-equinix](https://github.com/dirien/devpod-provider-equinix) ([v0.4.0](https://github.com/dirien/devpod-provider-equinix/releases/tag/v0.4.0), 1 day ago) - DevPod on Equinix Metal
- [dirien/devpod-provider-scaleway](https://github.com/dirien/devpod-provider-scaleway) ([v0.5.0](https://github.com/dirien/devpod-provider-scaleway/releases/tag/v0.5.0), 1 day ago) - DevPod on Scaleway 🇫🇷
- [dirien/pulumi-qovery](https://github.com/dirien/pulumi-qovery) ([v0.28.2](https://github.com/dirien/pulumi-qovery/releases/tag/v0.28.2), 1 day ago) - Pulumi provider for Qovery

#### ⭐ Latest repositories I starred

- [gptscript-ai/gptscript](https://github.com/gptscript-ai/gptscript) - Natural Language Programming  - 114 stars
- [second-state/LlamaEdge](https://github.com/second-state/LlamaEdge) - The easiest &amp; fastest way to run customized and fine-tuned LLMs locally or on the edge - 338 stars
- [Azure/AI-in-a-Box](https://github.com/Azure/AI-in-a-Box) -  - 140 stars
...
- [langchain-ai/langserve](https://github.com/langchain-ai/langserve) - LangServe 🦜️🏓 - 1281 stars
