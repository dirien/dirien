...
- [dirien/equinix-demo-day-deploy-bare-metal-kubernetes-with-pulumi-on-equinix-metal](https://github.com/dirien/equinix-demo-day-deploy-bare-metal-kubernetes-with-pulumi-on-equinix-metal) -  (6 days ago)
...
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.10.0](https://github.com/simple-icons/simple-icons/releases/tag/13.10.0), 1 day ago) - SVG icons for popular brands
- [langchain-ai/langserve](https://github.com/langchain-ai/langserve) ([v0.3.0](https://github.com/langchain-ai/langserve/releases/tag/v0.3.0), 2 days ago) - LangServe 🦜️🏓
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.20](https://github.com/loft-sh/devpod/releases/tag/v0.5.20), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
...
- [mendableai/firecrawl](https://github.com/mendableai/firecrawl) - 🔥 Turn entire websites into LLM-ready markdown or structured data. Scrape, crawl and extract with a single API. - 13829 stars
- [Stengo/DeskPad](https://github.com/Stengo/DeskPad) - A virtual monitor for screen sharing - 973 stars
- [usebruno/bruno](https://github.com/usebruno/bruno) - Opensource IDE For Exploring and Testing Api&#39;s (lightweight alternative to postman/insomnia) - 25315 stars
- [d07RiV/diabloweb](https://github.com/d07RiV/diabloweb) - Diablo 1 for web browsers - 2704 stars
- [cryptocode/terminal-doom](https://github.com/cryptocode/terminal-doom) - Play DOOM in modern terminals - 114 stars
