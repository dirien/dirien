...
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.16.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.16.0), 2 days ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
- [dirien/lazy-pulumi](https://github.com/dirien/lazy-pulumi) ([v0.6.0](https://github.com/dirien/lazy-pulumi/releases/tag/v0.6.0), 4 days ago) - A terminal UI (TUI) application for Pulumi Cloud
- [SchwarzIT/node-red-chart](https://github.com/SchwarzIT/node-red-chart) ([node-red-0.40.0](https://github.com/SchwarzIT/node-red-chart/releases/tag/node-red-0.40.0), 5 days ago) - Node-red Helm Chart
...
- [AdminTurnedDevOps/Agentic-AI-The-Hard-Way](https://github.com/AdminTurnedDevOps/Agentic-AI-The-Hard-Way) - This repository contains free labs for setting up three entire workflows for Agentic AI from a real-world perspective - 19 stars
