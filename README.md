...
- [dirien/pulumi-aws-workshop](https://github.com/dirien/pulumi-aws-workshop) - Pulumi AWS Workshop (2 days ago)
...
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.14.1](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.14.1), 2 days ago) - Azure Native Provider
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.20.0-next.1](https://github.com/backstage/backstage/releases/tag/v1.20.0-next.1), 2 days ago) - Backstage is an open platform for building developer portals
...
- [dirien/pulumi-github](https://github.com/dirien/pulumi-github) ([v0.2.37](https://github.com/dirien/pulumi-github/releases/tag/v0.2.37), 2 days ago) - Pulumi program to manage my GitHub repositories
- [lbrlabs/pulumi-scaleway](https://github.com/lbrlabs/pulumi-scaleway) ([v1.11.0](https://github.com/lbrlabs/pulumi-scaleway/releases/tag/v1.11.0), 3 days ago) - Pulumi provider for Scaleway, the European cloud provider

#### ⭐ Latest repositories I starred

- [wasmerio/winterjs](https://github.com/wasmerio/winterjs) - Winter is coming... ❄️ - 555 stars
- [undistro/marvin](https://github.com/undistro/marvin) - Marvin is a CLI tool that scans a k8s cluster by performing CEL expressions to report potential issues, misconfigurations and vulnerabilities. - 98 stars
- [TabbyML/tabby](https://github.com/TabbyML/tabby) - Self-hosted AI coding assistant - 12347 stars
- [dotdc/grafana-dashboards-kubernetes](https://github.com/dotdc/grafana-dashboards-kubernetes) - A set of modern Grafana dashboards for Kubernetes. - 1571 stars
...
- [aws-samples/karpenter-blueprints](https://github.com/aws-samples/karpenter-blueprints) - Karpenter Blueprints is a list of common workload scenarios following best practices. You&#39;ll find here details of why configuring the Karpenter and Kubernetes objects in such a way is important when using Karpenter on EKS. - 81 stars
- [argoproj-labs/hera](https://github.com/argoproj-labs/hera) - Hera is an Argo Python SDK. Hera aims to make construction and submission of various Argo Project resources easy and accessible to everyone! Hera abstracts away low-level setup details while still maintaining a consistent vocabulary with Argo. - 366 stars
...
- [vladmandic/human](https://github.com/vladmandic/human) - Human: AI-powered 3D Face Detection &amp; Rotation Tracking, Face Description &amp; Recognition, Body Pose Tracking, 3D Hand &amp; Finger Tracking, Iris Analysis, Age &amp; Gender &amp; Emotion Prediction, Gaze Tracking, Gesture Recognition - 1708 stars
