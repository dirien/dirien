...
- [dirien/minecraft-prometheus-exporter](https://github.com/dirien/minecraft-prometheus-exporter) ([0.15.0-helm](https://github.com/dirien/minecraft-prometheus-exporter/releases/tag/0.15.0-helm), 4 days ago) - Minecraft Prometheus exporter
- [dirien/minectl](https://github.com/dirien/minectl) ([v0.60.0](https://github.com/dirien/minectl/releases/tag/v0.60.0), 5 days ago) - minectl 🗺  is a cli for creating Minecraft server on different cloud provider.
- [dirien/minectl-sdk](https://github.com/dirien/minectl-sdk) ([v0.20.0](https://github.com/dirien/minectl-sdk/releases/tag/v0.20.0), 5 days ago) - SDK for every minectl product
- [dirien/lazy-pulumi](https://github.com/dirien/lazy-pulumi) ([v0.5.0](https://github.com/dirien/lazy-pulumi/releases/tag/v0.5.0), 6 days ago) - A terminal UI (TUI) application for Pulumi Cloud
- [pulumi/pulumi-digitalocean](https://github.com/pulumi/pulumi-digitalocean) ([v4.56.0](https://github.com/pulumi/pulumi-digitalocean/releases/tag/v4.56.0), 1 week ago) - A DigitalOcean Pulumi resource package, providing multi-language access to DigitalOcean
...
- [anthropics/claude-code](https://github.com/anthropics/claude-code) - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands. - 49297 stars
- [strands-agents/agent-sop](https://github.com/strands-agents/agent-sop) - Natural language workflows that enable AI agents to perform complex, multi-step tasks with consistency and reliability. - 589 stars
- [sinelaw/fresh](https://github.com/sinelaw/fresh) - Text editor for your terminal: easy, powerful and fast - 3778 stars
- [jesseduffield/lazygit](https://github.com/jesseduffield/lazygit) - simple terminal UI for git commands - 69889 stars
