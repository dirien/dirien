...
- [SchwarzIT/node-red-chart](https://github.com/SchwarzIT/node-red-chart) ([node-red-0.3.3](https://github.com/SchwarzIT/node-red-chart/releases/tag/node-red-0.3.3), 1 day ago) - Node-red Helm Chart
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([6.6.0](https://github.com/simple-icons/simple-icons/releases/tag/6.6.0), 3 days ago) - SVG icons for popular brands
- [emberstack/docker-azure-pipelines-agent](https://github.com/emberstack/docker-azure-pipelines-agent) ([v2.2.26](https://github.com/emberstack/docker-azure-pipelines-agent/releases/tag/v2.2.26), 4 days ago) - Docker based agent for Azure Pipelines
- [dirien/minectl](https://github.com/dirien/minectl) ([v0.15.0](https://github.com/dirien/minectl/releases/tag/v0.15.0), 5 days ago) - minectl 🗺  is a cli for creating Minecraft server on different cloud provider.

#### ⭐ Latest repositories I starred

- [the-gophers/gophercon-2021](https://github.com/the-gophers/gophercon-2021) - Microsoft @ GopherCon 2021! - 17 stars
- [rancher/rancher](https://github.com/rancher/rancher) - Complete container management platform - 18322 stars
...
- [muesli/roff](https://github.com/muesli/roff) - roff lets you write roff documents in Go - 27 stars
- [pyrsia/pyrsia](https://github.com/pyrsia/pyrsia) - Zero-Trust Decentralized Package Network - 14 stars
