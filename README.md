...
- [dirien/pulumi-scaleway](https://github.com/dirien/pulumi-scaleway) ([v2.29.0](https://github.com/dirien/pulumi-scaleway/releases/tag/v2.29.0), 1 day ago) - Pulumi provider for Scaleway
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v1.6.5](https://github.com/port-labs/pulumi-port/releases/tag/v1.6.5), 1 day ago)
- [dirien/pulumi-vultr](https://github.com/dirien/pulumi-vultr) ([v2.16.4](https://github.com/dirien/pulumi-vultr/releases/tag/v2.16.4), 1 day ago) - Pulumi provider for Vultr
- [pulumiverse/pulumi-harbor](https://github.com/pulumiverse/pulumi-harbor) ([v3.10.4](https://github.com/pulumiverse/pulumi-harbor/releases/tag/v3.10.4), 1 day ago) - A Pulumi native provider Harbor
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.19.2](https://github.com/backstage/backstage/releases/tag/v1.19.2), 1 day ago) - Backstage is an open platform for building developer portals

#### ⭐ Latest repositories I starred

- [aws-samples/karpenter-blueprints](https://github.com/aws-samples/karpenter-blueprints) - Karpenter Blueprints is a list of common workload scenarios following best practices. You&#39;ll find here details of why configuring the Karpenter and Kubernetes objects in such a way is important when using Karpenter on EKS. - 63 stars
- [argoproj-labs/hera](https://github.com/argoproj-labs/hera) - Hera is an Argo Python SDK. Hera aims to make construction and submission of various Argo Project resources easy and accessible to everyone! Hera abstracts away low-level setup details while still maintaining a consistent vocabulary with Argo. - 357 stars
...
- [vladmandic/human](https://github.com/vladmandic/human) - Human: AI-powered 3D Face Detection &amp; Rotation Tracking, Face Description &amp; Recognition, Body Pose Tracking, 3D Hand &amp; Finger Tracking, Iris Analysis, Age &amp; Gender &amp; Emotion Prediction, Gaze Tracking, Gesture Recognition - 1683 stars
...
- [zitadel/zitadel](https://github.com/zitadel/zitadel) - ZITADEL - Identity infrastructure, simplified for you. - 4943 stars
...
- [go-skynet/LocalAI](https://github.com/go-skynet/LocalAI) - :robot: The free, Open Source OpenAI alternative. Self-hosted, community-driven and local-first. Drop-in replacement for OpenAI running on consumer-grade hardware. No GPU required. Runs ggml, gguf, GPTQ, onnx, TF compatible models: llama, llama2, rwkv, whisper, vicuna, koala, cerebras, falcon, dolly, starcoder, and many others - 12318 stars
