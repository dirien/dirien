...
- [dirien/backstage-demo](https://github.com/dirien/backstage-demo) -  (1 day ago)
...
- [dirien/pulumi-fly](https://github.com/dirien/pulumi-fly) - Pulumi provider for Fly.io (2 days ago)
- [pulumi/docs](https://github.com/pulumi/docs) - All things Pulumi docs! (4 days ago)

#### 🚀 Latest releases I contributed to

- [pulumiverse/pulumi-scaleway](https://github.com/pulumiverse/pulumi-scaleway) ([v1.20.0](https://github.com/pulumiverse/pulumi-scaleway/releases/tag/v1.20.0), 1 day ago) - Pulumi provider for Scaleway
- [dirien/pulumi-fly](https://github.com/dirien/pulumi-fly) ([v0.1.18](https://github.com/dirien/pulumi-fly/releases/tag/v0.1.18), 2 days ago) - Pulumi provider for Fly.io
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.16.0](https://github.com/simple-icons/simple-icons/releases/tag/13.16.0), 2 days ago) - SVG icons for popular brands
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.29](https://github.com/alexellis/arkade/releases/tag/0.11.29), 1 week ago) - Open Source Marketplace For Developer Tools
...
- [pterm/pterm](https://github.com/pterm/pterm) - ✨ #PTerm is a modern Go module to easily beautify console output. Featuring charts, progressbars, tables, trees, text input, select menus and much more 🚀 It&#39;s completely configurable and 100% cross-platform compatible. - 4832 stars
- [MightyMoud/sidekick](https://github.com/MightyMoud/sidekick) - Bare metal to production ready in mins; your own fly server on your VPS. - 5334 stars
- [sobelio/llm-chain](https://github.com/sobelio/llm-chain) - `llm-chain` is a powerful rust crate for building chains in large language models allowing you to summarise text and complete complex tasks - 1345 stars
- [kolbytn/mindcraft](https://github.com/kolbytn/mindcraft) -  - 1837 stars
- [mc-bench/orchestrator](https://github.com/mc-bench/orchestrator) - Orchestrator to spin up MC server, run Mindcraft agent, save building and run eval - 133 stars
- [AvitalTamir/cyphernetes](https://github.com/AvitalTamir/cyphernetes) - A Kubernetes Query Language - 498 stars
