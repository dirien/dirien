...
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.837.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.837.0), 1 day ago) - Fig adds autocomplete to your terminal.
...
- [sigstore/cosign-installer](https://github.com/sigstore/cosign-installer) ([v2.5.0](https://github.com/sigstore/cosign-installer/releases/tag/v2.5.0), 3 days ago) - Cosign Github Action
...
- [dirien/pulumi-github](https://github.com/dirien/pulumi-github) ([v0.2.4](https://github.com/dirien/pulumi-github/releases/tag/v0.2.4), 5 days ago) - Pulumi program to manage my GitHub repositories

#### ⭐ Latest repositories I starred

- [jorgef/engineeringladders](https://github.com/jorgef/engineeringladders) - A framework for Engineering Managers - 1239 stars
- [loft-sh/cluster-api-provider-vcluster](https://github.com/loft-sh/cluster-api-provider-vcluster) -  - 13 stars
...
- [microsoft/sbom-tool](https://github.com/microsoft/sbom-tool) - The SBOM tool is a highly scalable and enterprise ready tool to create SPDX 2.2 compatible SBOMs for any variety of artifacts. - 668 stars
...
- [infracost/vscode-infracost](https://github.com/infracost/vscode-infracost) - See cost estimates for Terraform right in your editor💰📉 - 1465 stars
- [GoogleCloudPlatform/terraformer](https://github.com/GoogleCloudPlatform/terraformer) - CLI tool to generate terraform files from existing infrastructure (reverse Terraform). Infrastructure to Code - 8094 stars
