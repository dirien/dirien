...
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v1.10.3](https://github.com/port-labs/pulumi-port/releases/tag/v1.10.3), 1 day ago)
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.4-alpha.1](https://github.com/loft-sh/devpod/releases/tag/v0.5.4-alpha.1), 1 day ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
...
- [vllm-project/vllm](https://github.com/vllm-project/vllm) - A high-throughput and memory-efficient inference and serving engine for LLMs - 14916 stars
- [basemind-ai/gateway](https://github.com/basemind-ai/gateway) - The BaseMind.AI monorepo - 17 stars
- [facebook/dotslash](https://github.com/facebook/dotslash) - Simplified executable deployment - 395 stars
- [nuke-build/nuke](https://github.com/nuke-build/nuke) - 🏗 The AKEless Build System for C#/.NET - 2283 stars
- [gptscript-ai/gptscript](https://github.com/gptscript-ai/gptscript) - Natural Language Programming  - 1023 stars
- [second-state/LlamaEdge](https://github.com/second-state/LlamaEdge) - The easiest &amp; fastest way to run customized and fine-tuned LLMs locally or on the edge - 351 stars
- [Azure/AI-in-a-Box](https://github.com/Azure/AI-in-a-Box) -  - 156 stars
