...
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.21.9](https://github.com/port-labs/pulumi-port/releases/tag/v2.21.9), 1 day ago) - Pulumi Port provider
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.50](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.50), 3 days ago) - MCP DigitalOcean Integration
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.27.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.27.0), 1 week ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
- [dirien/yet-another-agent-harness](https://github.com/dirien/yet-another-agent-harness) ([v0.4.1](https://github.com/dirien/yet-another-agent-harness/releases/tag/v0.4.1), 2 weeks ago) - A Go agent harness for Claude Code — runtime hooks, MCP server, session tracking, middleware chains, and full config generation in one binary
...
- [amitshekhariitbhu/ai-engineering-interview-questions](https://github.com/amitshekhariitbhu/ai-engineering-interview-questions) - Your Cheat Sheet for AI Engineering Interview – Questions and Answers. - 1321 stars
- [Effect-TS/effect](https://github.com/Effect-TS/effect) - Build production-ready applications in TypeScript - 13983 stars
- [dohooo/helmor](https://github.com/dohooo/helmor) - Open-source local workbench for multi-agent software development. - 490 stars
- [microsoft/AIforITOps](https://github.com/microsoft/AIforITOps) - Workshop for IT/Ops teams to learn how to manage AI-enabled applications on Microsoft Azure. - 94 stars
...
- [vercel-labs/portless](https://github.com/vercel-labs/portless) - Replace port numbers with stable, named local URLs. For humans and agents. - 8471 stars
- [microsoft/Hosted_Agents_Workshop_dotNET](https://github.com/microsoft/Hosted_Agents_Workshop_dotNET) - Build your first Microsoft Foundry hosted agent with this hands-on .NET 10 workshop, covering local development, Copilot-assisted coding, CI, secure deployment to Azure, and a working chat UI. - 13 stars
- [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) - ClawSweeper scans all issues and PRs and suggest what we can close, and why. It runs every PR / Issue once a week. - 1338 stars
- [Azure-Samples/foundry-hosted-agentframework-demos](https://github.com/Azure-Samples/foundry-hosted-agentframework-demos) - A demo project that deploys Agent Framework agent to Foundry Hosted Agents - 19 stars
- [microsoft/openclaw](https://github.com/microsoft/openclaw) - Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞  - 49 stars
