...
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.1.26](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.1.26), 2 days ago)
- [dirien/pulumi-scaleway](https://github.com/dirien/pulumi-scaleway) ([v2.41.1](https://github.com/dirien/pulumi-scaleway/releases/tag/v2.41.1), 2 days ago) - Pulumi provider for Scaleway
- [dirien/pulumi-qovery](https://github.com/dirien/pulumi-qovery) ([v0.28.10](https://github.com/dirien/pulumi-qovery/releases/tag/v0.28.10), 2 days ago) - Pulumi provider for Qovery
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.44.1](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.44.1), 3 days ago) - Azure Native Provider
- [pulumiverse/pulumi-scaleway](https://github.com/pulumiverse/pulumi-scaleway) ([v1.14.0](https://github.com/pulumiverse/pulumi-scaleway/releases/tag/v1.14.0), 3 days ago) - Pulumi provider for Scaleway
...
- [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly WebUI for LLMs (Formerly Ollama WebUI) - 26221 stars
...
- [robusta-dev/holmesgpt](https://github.com/robusta-dev/holmesgpt) - The Open Source DevOps Assistant - solve problems twice as fast with an AI teammate - 151 stars
- [explodinggradients/ragas](https://github.com/explodinggradients/ragas) - Evaluation framework for your Retrieval Augmented Generation (RAG) pipelines - 5287 stars
- [containers/bootc](https://github.com/containers/bootc) - Boot and upgrade via container images - 444 stars
- [kubecolor/kubecolor](https://github.com/kubecolor/kubecolor) - Colorize your kubectl output - 435 stars
