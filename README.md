...
- [dirien/voting-app](https://github.com/dirien/voting-app) -  (4 days ago)
...
- [dirien/progressive-infrastructure-delivery-using-kargo-and-argo-cd](https://github.com/dirien/progressive-infrastructure-delivery-using-kargo-and-argo-cd) - Progressive Infrastructure Delivery using Kargo and Argo CD (4 days ago)

#### 🚀 Latest releases I contributed to

- [dirien/kargo-test](https://github.com/dirien/kargo-test) ([0.1.6-helm](https://github.com/dirien/kargo-test/releases/tag/0.1.6-helm), 2 days ago)
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.25](https://github.com/alexellis/arkade/releases/tag/0.11.25), 2 days ago) - Open Source Marketplace For Developer Tools
...
- [goreleaser/goreleaser-azure-devops-extension](https://github.com/goreleaser/goreleaser-azure-devops-extension) ([v0.1.46](https://github.com/goreleaser/goreleaser-azure-devops-extension/releases/tag/v0.1.46), 4 days ago) - Azure DevOps Extension for GoReleaser
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.10.0](https://github.com/simple-icons/simple-icons/releases/tag/13.10.0), 5 days ago) - SVG icons for popular brands

#### ⭐ Latest repositories I starred

- [trufflesecurity/trufflehog](https://github.com/trufflesecurity/trufflehog) - Find, verify, and analyze leaked credentials - 15676 stars
- [voideditor/void](https://github.com/voideditor/void) -  - 4491 stars
...
- [lenra-io/dofigen](https://github.com/lenra-io/dofigen) - Dofigen is a Dockerfile generator using a simplified description in YAML or JSON format - 32 stars
...
- [mendableai/firecrawl](https://github.com/mendableai/firecrawl) - 🔥 Turn entire websites into LLM-ready markdown or structured data. Scrape, crawl and extract with a single API. - 14404 stars
- [Stengo/DeskPad](https://github.com/Stengo/DeskPad) - A virtual monitor for screen sharing - 977 stars
