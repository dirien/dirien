...
- [Advanced Secrets Management on Kubernetes with Pulumi: Doppler Secrets Operator](https://blog.ediri.io/advanced-secrets-management-on-kubernetes-with-pulumi-doppler-secrets-operator) (4 weeks ago)
...
- [dirien/devpod-provider-hetzner](https://github.com/dirien/devpod-provider-hetzner) - DevPod on Hetzner 🇩🇪 with Rust 🦀 (3 days ago)
...
- [pulumiverse/pulumi-harbor](https://github.com/pulumiverse/pulumi-harbor) ([v3.9.2](https://github.com/pulumiverse/pulumi-harbor/releases/tag/v3.9.2), 1 day ago) - A Pulumi native provider Harbor
- [dirien/pulumi-scaleway](https://github.com/dirien/pulumi-scaleway) ([v2.21.0](https://github.com/dirien/pulumi-scaleway/releases/tag/v2.21.0), 1 day ago) - Pulumi provider for Scaleway
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.9.22](https://github.com/alexellis/arkade/releases/tag/0.9.22), 2 days ago) - Open Source Marketplace For Developer Tools
- [aquasecurity/trivy-action](https://github.com/aquasecurity/trivy-action) ([0.11.2](https://github.com/aquasecurity/trivy-action/releases/tag/0.11.2), 3 days ago) - Runs Trivy as GitHub action to scan your Docker container image for vulnerabilities
- [dirien/devpod-provider-hetzner](https://github.com/dirien/devpod-provider-hetzner) ([v0.3.0](https://github.com/dirien/devpod-provider-hetzner/releases/tag/v0.3.0), 3 days ago) - DevPod on Hetzner 🇩🇪 with Rust 🦀

#### ⭐ Latest repositories I starred

- [openchatai/OpenChat](https://github.com/openchatai/OpenChat) - LLMs custom-chatbots console ⚡ - 2925 stars
- [StyraInc/regal](https://github.com/StyraInc/regal) - Regal is a linter for Rego - 78 stars
- [ruanbekker/grafana-observability-primer](https://github.com/ruanbekker/grafana-observability-primer) - Grafana Observability Primer - 34 stars
...
- [warp-tech/warpgate](https://github.com/warp-tech/warpgate) - Smart SSH, HTTPS and MySQL bastion that needs no client-side software - 2457 stars
- [tomnomnom/gron](https://github.com/tomnomnom/gron) - Make JSON greppable! - 12188 stars
- [snyk/parlay](https://github.com/snyk/parlay) - Enrich SBOMs with data from third party services - 30 stars
- [lewish/asciiflow](https://github.com/lewish/asciiflow) - ASCIIFlow - 3775 stars
