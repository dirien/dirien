...
- [pulumi/pulumi-esc-csi-provider](https://github.com/pulumi/pulumi-esc-csi-provider) ([pulumi-esc-csi-provider-0.1.6](https://github.com/pulumi/pulumi-esc-csi-provider/releases/tag/pulumi-esc-csi-provider-0.1.6), 1 day ago) - A Secret Store CSI provider for Pulumi ESC
...
- [Handfish/confetty_rs](https://github.com/Handfish/confetty_rs) - Rust port of maaslalani/confetty - 53 stars
- [ratatui/ratatui](https://github.com/ratatui/ratatui) - A Rust crate for cooking up terminal user interfaces (TUIs) 👨‍🍳🐀 https://ratatui.rs - 11465 stars
...
- [bluewave-labs/checkmate](https://github.com/bluewave-labs/checkmate) - Checkmate is an open-source, self-hosted tool designed to track and monitor server hardware, uptime, response times, and incidents in real-time with beautiful visualizations. - 3063 stars
