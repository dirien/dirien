...
- [dirien/coding-task-test](https://github.com/dirien/coding-task-test) -  (1 day ago)
...
- [kubernetes-sigs/kro](https://github.com/kubernetes-sigs/kro) ([v0.8.5](https://github.com/kubernetes-sigs/kro/releases/tag/v0.8.5), 3 days ago) - kro | Kube Resource Orchestrator
- [dirien/lazy-pulumi](https://github.com/dirien/lazy-pulumi) ([v0.7.0](https://github.com/dirien/lazy-pulumi/releases/tag/v0.7.0), 3 days ago) - A terminal UI (TUI) application for Pulumi Cloud
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.31](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.31), 6 days ago) - MCP DigitalOcean Integration
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.18.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.18.0), 6 days ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.19.4](https://github.com/port-labs/pulumi-port/releases/tag/v2.19.4), 1 week ago) - Pulumi Port provider

#### ⭐ Latest repositories I starred

- [sipeed/picoclaw](https://github.com/sipeed/picoclaw) - picoclaw - 2306 stars
- [rohitg00/skillkit](https://github.com/rohitg00/skillkit) - Supercharge AI coding agents with portable skills. Install, translate &amp; share skills across Claude Code, Cursor, Codex, Copilot &amp; 40 more - 299 stars
- [rohitg00/pro-workflow](https://github.com/rohitg00/pro-workflow) - Battle-tested Claude Code workflows from power users. Self-correcting memory, parallel worktrees, wrap-up rituals, and the 80/20 AI coding ratio. - 850 stars
- [kubernetes-sigs/agent-sandbox](https://github.com/kubernetes-sigs/agent-sandbox) - agent-sandbox enables easy management of isolated, stateful, singleton workloads, ideal for use cases like AI agent runtimes. - 943 stars
- [nestybox/sysbox](https://github.com/nestybox/sysbox) - An open-source, next-generation &#34;runc&#34; that empowers rootless containers to run workloads such as Systemd, Docker, Kubernetes, just like VMs. - 3444 stars
- [agent-sandbox/agent-sandbox](https://github.com/agent-sandbox/agent-sandbox) - Agent Sandbox is an E2B compatible, enterprise-grade ai-first, cloud-native runtime environment for AI Agents. Allows Agents to securely run untrusted LLM-generated Code, Browser use, Computer use, and Shell commands etc. with stateful, long-running, multi-session and multi-tenant. - 53 stars
- [pranshuparmar/witr](https://github.com/pranshuparmar/witr) - Why is this running? - 13110 stars
- [oxidecomputer/progenitor](https://github.com/oxidecomputer/progenitor) - An OpenAPI client generator - 847 stars
- [abiosoft/colima](https://github.com/abiosoft/colima) - Container runtimes on macOS (and Linux) with minimal setup - 26856 stars
- [mensfeld/code-on-incus](https://github.com/mensfeld/code-on-incus) - Run coding agents in isolated Incus containers (sandboxes) with session persistence, workspace isolation, and multi-slot support. - 228 stars
