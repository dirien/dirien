...
- [langchain-ai/langserve](https://github.com/langchain-ai/langserve) ([v0.2.0](https://github.com/langchain-ai/langserve/releases/tag/v0.2.0), 2 days ago) - LangServe 🦜️🏓
...
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.7](https://github.com/loft-sh/devpod/releases/tag/v0.5.7), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
...
- [ovh/pulumi-ovh](https://github.com/ovh/pulumi-ovh) ([v0.44.0](https://github.com/ovh/pulumi-ovh/releases/tag/v0.44.0), 4 days ago) - Pulumi provider for OVHcloud

#### ⭐ Latest repositories I starred

- [kubecolor/kubecolor](https://github.com/kubecolor/kubecolor) - Colorize your kubectl output - 404 stars
...
- [sigoden/aichat](https://github.com/sigoden/aichat) - All-in-one AI-Powered CLI Chat &amp; Copilot that integrates 20&#43; AI platforms, including OpenAI, Azure-OpenAI, Gemini, Claude, Mistral, Cohere, VertexAI, Bedrock, Ollama, Ernie, Qianwen, Deepseek... - 2960 stars
- [jozu-ai/kitops](https://github.com/jozu-ai/kitops) - Tools for easing the handoff between AI/ML and App/SRE teams. - 191 stars
- [inkdrop-org/inkdrop-visualizer](https://github.com/inkdrop-org/inkdrop-visualizer) - Visualizes your Terraform - 386 stars
- [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo) - Test your prompts, models, and RAGs. Catch regressions and improve prompt quality. LLM evals for OpenAI, Azure, Anthropic, Gemini, Mistral, Llama, Bedrock, Ollama, and other local &amp; private models with CI/CD integration. - 2946 stars
