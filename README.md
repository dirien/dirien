...
- [dirien/minectl](https://github.com/dirien/minectl) ([v0.51.0](https://github.com/dirien/minectl/releases/tag/v0.51.0), 1 day ago) - minectl 🗺  is a cli for creating Minecraft server on different cloud provider.
- [dirien/minectl-sdk](https://github.com/dirien/minectl-sdk) ([v0.17.0](https://github.com/dirien/minectl-sdk/releases/tag/v0.17.0), 1 day ago) - SDK for every minectl product
- [dirien/devpod-provider-equinix](https://github.com/dirien/devpod-provider-equinix) ([v0.5.0](https://github.com/dirien/devpod-provider-equinix/releases/tag/v0.5.0), 1 day ago) - DevPod on Equinix Metal
- [dirien/devpod-provider-scaleway](https://github.com/dirien/devpod-provider-scaleway) ([v0.5.2](https://github.com/dirien/devpod-provider-scaleway/releases/tag/v0.5.2), 1 day ago) - DevPod on Scaleway 🇫🇷
...
- [nixys/nxs-universal-chart](https://github.com/nixys/nxs-universal-chart) - The Helm chart you can use to install any of your applications into Kubernetes/OpenShift - 311 stars
- [awslabs/diagram-as-code](https://github.com/awslabs/diagram-as-code) - Diagram-as-code for AWS architecture. - 304 stars
- [turbot/powerpipe](https://github.com/turbot/powerpipe) - Powerpipe: Dashboards for DevOps. Visualize cloud configurations. Assess security posture against a massive library of benchmarks. Build custom dashboards with code. - 74 stars
- [levkush/termvideo](https://github.com/levkush/termvideo) - Play videos from a terminal with audio support! 🚀 - 9 stars
- [hcavarsan/kftray](https://github.com/hcavarsan/kftray) - kubectl port-forward on steroids ⚡ |  kftray makes it easy for you to manage and share multiple k8s port forwards right from your menu bar - built with rust 🦀 and ts using tauri - 372 stars
...
- [microsoft/retina](https://github.com/microsoft/retina) - eBPF distributed networking observability tool for Kubernetes - 2327 stars
- [spinkube/spin-operator](https://github.com/spinkube/spin-operator) - Spin Operator is a Kubernetes operator that empowers platform engineers to deploy Spin applications as custom resources to their Kubernetes clusters - 92 stars
