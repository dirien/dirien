...
- [dirien/pulumi-esc-csi-provider](https://github.com/dirien/pulumi-esc-csi-provider) - A CSI provider for Pulumi ESC (3 days ago)
...
- [pulumiverse/pulumi-scaleway](https://github.com/pulumiverse/pulumi-scaleway) ([v1.19.0](https://github.com/pulumiverse/pulumi-scaleway/releases/tag/v1.19.0), 2 days ago) - Pulumi provider for Scaleway
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.15.0](https://github.com/simple-icons/simple-icons/releases/tag/13.15.0), 6 days ago) - SVG icons for popular brands
...
- [kolbytn/mindcraft](https://github.com/kolbytn/mindcraft) -  - 1746 stars
- [mc-bench/orchestrator](https://github.com/mc-bench/orchestrator) - Orchestrator to spin up MC server, run Mindcraft agent, save building and run eval - 129 stars
...
- [controlplaneio-fluxcd/flux-operator](https://github.com/controlplaneio-fluxcd/flux-operator) - Flux Operator is a Kubernetes controller for managing the lifecycle of Flux CD - 172 stars
...
- [antfu-collective/taze](https://github.com/antfu-collective/taze) - 🥦 A modern cli tool that keeps your deps fresh - 2826 stars
...
- [knadh/koanf](https://github.com/knadh/koanf) - Simple, extremely lightweight, extensible, configuration management library for Go. Support for JSON, TOML, YAML, env, command line, file, S3 etc. Alternative to viper. - 2770 stars
