...
- [alexellis/arkade](https://github.com/alexellis/arkade) - Open Source Marketplace For Kubernetes (5 days ago)

#### 🚀 Latest releases I contributed to

- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1077.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1077.0), 3 days ago) - IDE-style autocomplete for your existing terminal &amp; shell
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.8.56](https://github.com/alexellis/arkade/releases/tag/0.8.56), 4 days ago) - Open Source Marketplace For Kubernetes
- [SchwarzIT/node-red-chart](https://github.com/SchwarzIT/node-red-chart) ([node-red-0.22.1](https://github.com/SchwarzIT/node-red-chart/releases/tag/node-red-0.22.1), 4 days ago) - Node-red Helm Chart
- [civo/civogo](https://github.com/civo/civogo) ([v0.3.22](https://github.com/civo/civogo/releases/tag/v0.3.22), 5 days ago) - Golang client to interact with Civo&#39;s API
- [dirien/minectl](https://github.com/dirien/minectl) ([v0.28.0](https://github.com/dirien/minectl/releases/tag/v0.28.0), 6 days ago) - minectl 🗺  is a cli for creating Minecraft server on different cloud provider.
...
- [yannh/kubeconform](https://github.com/yannh/kubeconform) - A FAST Kubernetes manifests validator, with support for Custom Resources! - 863 stars
- [resmoio/kubernetes-event-exporter](https://github.com/resmoio/kubernetes-event-exporter) - Export Kubernetes events to multiple destinations with routing and filtering - 218 stars
...
- [fermyon/installer](https://github.com/fermyon/installer) - Fermyon Installer - 73 stars
