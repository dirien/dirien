...
- [dirien/devpod-provider-equinix](https://github.com/dirien/devpod-provider-equinix) ([v0.2.2](https://github.com/dirien/devpod-provider-equinix/releases/tag/v0.2.2), 1 day ago) - DevPod on Equinix Metal
- [dirien/devpod-provider-scaleway](https://github.com/dirien/devpod-provider-scaleway) ([v0.4.2](https://github.com/dirien/devpod-provider-scaleway/releases/tag/v0.4.2), 1 day ago) - DevPod on Scaleway 🇫🇷
...
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.3.7](https://github.com/loft-sh/devpod/releases/tag/v0.3.7), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.10.1](https://github.com/alexellis/arkade/releases/tag/0.10.1), 2 days ago) - Open Source Marketplace For Developer Tools
...
- [kdash-rs/kdash](https://github.com/kdash-rs/kdash) - A simple and fast dashboard for Kubernetes - 1480 stars
- [mochi-mqtt/server](https://github.com/mochi-mqtt/server) - The fully compliant, embeddable high-performance Go MQTT v5 server for IoT, smarthome, and pubsub - 699 stars
- [eigr/spawn](https://github.com/eigr/spawn) - Spawn - Actor Mesh - 132 stars
- [kcl-lang/kcl](https://github.com/kcl-lang/kcl) - A constraint-based record &amp; functional language mainly used in configuration and policy scenarios. https://kcl-lang.io - 747 stars
- [IBM/fp-go](https://github.com/IBM/fp-go) - functional programming library for golang - 1081 stars
