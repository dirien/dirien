...
- [dirien/pulumi-codefresh](https://github.com/dirien/pulumi-codefresh) - Pulumi provider for Codefresh (4 days ago)
...
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.913.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.913.0), 1 day ago) - Fig adds autocomplete to your terminal.
- [civo/civogo](https://github.com/civo/civogo) ([v0.3.10](https://github.com/civo/civogo/releases/tag/v0.3.10), 2 days ago) - Golang client to interact with Civo&#39;s API
- [aquasecurity/helm-charts](https://github.com/aquasecurity/helm-charts) ([starboard-operator-0.10.9](https://github.com/aquasecurity/helm-charts/releases/tag/starboard-operator-0.10.9), 2 days ago) - Aqua Open Source Helm Chart Repository
- [aquasecurity/starboard](https://github.com/aquasecurity/starboard) ([v0.15.9-rc3](https://github.com/aquasecurity/starboard/releases/tag/v0.15.9-rc3), 2 days ago) - Moved to https://github.com/aquasecurity/trivy-operator
- [sigstore/policy-controller](https://github.com/sigstore/policy-controller) ([v0.3.0](https://github.com/sigstore/policy-controller/releases/tag/v0.3.0), 2 days ago)

#### ⭐ Latest repositories I starred

- [IdreesInc/Monocraft](https://github.com/IdreesInc/Monocraft) - A programming font based on the typeface used in Minecraft - 2950 stars
...
- [alexellis/run-job](https://github.com/alexellis/run-job) - Run a Kubernetes Job and get the logs when it&#39;s done 🏃‍♂️ - 92 stars
...
- [airwallex/k8s-pod-restart-info-collector](https://github.com/airwallex/k8s-pod-restart-info-collector) - Automated troubleshooting of Kubernetes Pods issues. Collect K8s pod restart reasons, logs, and events automatically. - 77 stars
