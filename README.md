...
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.20-alpha.1](https://github.com/loft-sh/devpod/releases/tag/v0.5.20-alpha.1), 1 day ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
...
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.5.0](https://github.com/simple-icons/simple-icons/releases/tag/13.5.0), 4 days ago) - SVG icons for popular brands
- [dirien/pulumi-qovery](https://github.com/dirien/pulumi-qovery) ([v0.37.0](https://github.com/dirien/pulumi-qovery/releases/tag/v0.37.0), 6 days ago) - Pulumi provider for Qovery
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.19](https://github.com/alexellis/arkade/releases/tag/0.11.19), 1 week ago) - Open Source Marketplace For Developer Tools

#### ⭐ Latest repositories I starred

- [d07RiV/diabloweb](https://github.com/d07RiV/diabloweb) - Diablo 1 for web browsers - 2218 stars
- [cryptocode/terminal-doom](https://github.com/cryptocode/terminal-doom) - Play DOOM in modern terminals - 84 stars
- [sighupio/permission-manager](https://github.com/sighupio/permission-manager) - Permission Manager is a project that brings sanity to Kubernetes RBAC and Users management, Web UI FTW - 1279 stars
- [dastergon/postmortem-templates](https://github.com/dastergon/postmortem-templates) - A collection of postmortem templates - 1290 stars
