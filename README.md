...
- [dirien/pulumi-esc-csi-provider](https://github.com/dirien/pulumi-esc-csi-provider) - A CSI provider for Pulumi ESC (4 days ago)
...
- [dirien/aws-ts-rag-opensearch](https://github.com/dirien/aws-ts-rag-opensearch) -  (2 weeks ago)

#### 🚀 Latest releases I contributed to

- [pulumiverse/pulumi-scaleway](https://github.com/pulumiverse/pulumi-scaleway) ([v1.19.0](https://github.com/pulumiverse/pulumi-scaleway/releases/tag/v1.19.0), 3 days ago) - Pulumi provider for Scaleway
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.15.0](https://github.com/simple-icons/simple-icons/releases/tag/13.15.0), 1 week ago) - SVG icons for popular brands
...
- [kolbytn/mindcraft](https://github.com/kolbytn/mindcraft) -  - 1770 stars
- [mc-bench/orchestrator](https://github.com/mc-bench/orchestrator) - Orchestrator to spin up MC server, run Mindcraft agent, save building and run eval - 130 stars
- [AvitalTamir/cyphernetes](https://github.com/AvitalTamir/cyphernetes) - A Kubernetes Query Language - 496 stars
...
- [antfu-collective/taze](https://github.com/antfu-collective/taze) - 🥦 A modern cli tool that keeps your deps fresh - 2825 stars
- [kubewall/kubewall](https://github.com/kubewall/kubewall) - A single binary kubernetes dashboard to manage your multiple clusters. - 603 stars
- [knadh/koanf](https://github.com/knadh/koanf) - Simple, extremely lightweight, extensible, configuration management library for Go. Support for JSON, TOML, YAML, env, command line, file, S3 etc. Alternative to viper. - 2771 stars
