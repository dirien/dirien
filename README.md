...
- [Building a RESTful API with Actix Web and Diesel for Persistent Data Storage](https://blog.ediri.io/building-a-restful-api-with-actix-web-and-diesel-for-persistent-data-storage) (4 weeks ago)
...
- [libdns/civo](https://github.com/libdns/civo) ([v0.1.11](https://github.com/libdns/civo/releases/tag/v0.1.11), 2 days ago) - Civo DNS implementation for libdns
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1155.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1155.0), 2 days ago) - IDE-style autocomplete for your existing terminal &amp; shell
...
- [civo/civogo](https://github.com/civo/civogo) ([v0.3.32](https://github.com/civo/civogo/releases/tag/v0.3.32), 2 days ago) - Golang client to interact with Civo&#39;s API
- [dirien/pulumi-scaleway](https://github.com/dirien/pulumi-scaleway) ([v2.16.3](https://github.com/dirien/pulumi-scaleway/releases/tag/v2.16.3), 4 days ago) - Pulumi provider for Scaleway

#### ⭐ Latest repositories I starred

- [vitobotta/hetzner-k3s](https://github.com/vitobotta/hetzner-k3s) - A CLI tool to install and manage Kubernetes clusters in Hetzner Cloud using the lightweight distribution k3s by Rancher. - 782 stars
...
- [lunarway/shuttle](https://github.com/lunarway/shuttle) - CLI for handling shared build and deploy tools between projects no matter what technologies the projects are using - 119 stars
- [Dentrax/falco-gpt](https://github.com/Dentrax/falco-gpt) - AI-generated remediations for Falco audit events - 28 stars
- [madhuakula/kubernetes-goat](https://github.com/madhuakula/kubernetes-goat) - Kubernetes Goat is a &#34;Vulnerable by Design&#34; cluster environment to learn and practice Kubernetes security using an interactive hands-on playground 🚀 - 3066 stars
- [codesenberg/bombardier](https://github.com/codesenberg/bombardier) - Fast cross-platform HTTP benchmarking tool written in Go - 4197 stars
- [wg/wrk](https://github.com/wg/wrk) - Modern HTTP benchmarking tool - 34216 stars
- [valyala/fasthttp](https://github.com/valyala/fasthttp) - Fast HTTP package for Go. Tuned for high performance. Zero memory allocations in hot paths. Up to 10x faster than net/http - 19397 stars
