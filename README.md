...
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.28.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.28.0), 5 days ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.21.9](https://github.com/port-labs/pulumi-port/releases/tag/v2.21.9), 6 days ago) - Pulumi Port provider
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.50](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.50), 1 week ago) - MCP DigitalOcean Integration
...
- [pulumi/pulumi-kubernetes-operator](https://github.com/pulumi/pulumi-kubernetes-operator) ([v2.7.0](https://github.com/pulumi/pulumi-kubernetes-operator/releases/tag/v2.7.0), 4 weeks ago) - A Kubernetes Operator that automates the deployment of Pulumi Stacks

#### ⭐ Latest repositories I starred

- [strongdm/attractor](https://github.com/strongdm/attractor) - nlspec of StrongDM&#39;s Attractor, a non-interactive Coding Agent sufficient for use in a Software Factory - 1142 stars
- [vercel-labs/ai-cli](https://github.com/vercel-labs/ai-cli) - Generate anything from your terminal - 296 stars
- [withastro/flue](https://github.com/withastro/flue) - The sandbox agent framework. - 2370 stars
- [chrishutchinson/claude-receipts](https://github.com/chrishutchinson/claude-receipts) - Bring receipts from your Claude Code sessions - 493 stars
- [amitshekhariitbhu/ai-engineering-interview-questions](https://github.com/amitshekhariitbhu/ai-engineering-interview-questions) - Your Cheat Sheet for AI Engineering Interview – Questions and Answers. - 1437 stars
- [Effect-TS/effect](https://github.com/Effect-TS/effect) - Build production-ready applications in TypeScript - 14043 stars
- [dohooo/helmor](https://github.com/dohooo/helmor) - Open-source local workbench for multi-agent software development. - 895 stars
- [microsoft/AIforITOps](https://github.com/microsoft/AIforITOps) - Workshop for IT/Ops teams to learn how to manage AI-enabled applications on Microsoft Azure. - 124 stars
...
- [vercel-labs/portless](https://github.com/vercel-labs/portless) - Replace port numbers with stable, named local URLs. For humans and agents. - 8872 stars

#### 👥 Latest follower

- [sithukyaw007](https://github.com/sithukyaw007) - Sithu
