...
- [aquasecurity/helm-charts](https://github.com/aquasecurity/helm-charts) ([postee-v2.11.2](https://github.com/aquasecurity/helm-charts/releases/tag/postee-v2.11.2), 1 day ago) - Aqua Open Source Helm Chart Repository
- [go-acme/lego](https://github.com/go-acme/lego) ([v4.12.1](https://github.com/go-acme/lego/releases/tag/v4.12.1), 1 day ago) - Let&#39;s Encrypt/ACME client and library written in Go
- [aquasecurity/trivy-action](https://github.com/aquasecurity/trivy-action) ([0.11.0](https://github.com/aquasecurity/trivy-action/releases/tag/0.11.0), 2 days ago) - Runs Trivy as GitHub action to scan your Docker container image for vulnerabilities
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.9.19](https://github.com/alexellis/arkade/releases/tag/0.9.19), 2 days ago) - Open Source Marketplace For Developer Tools

#### ⭐ Latest repositories I starred

- [lewish/asciiflow](https://github.com/lewish/asciiflow) - ASCIIFlow - 3772 stars
- [doitintl/kube-no-trouble](https://github.com/doitintl/kube-no-trouble) - Easily check your clusters for use of deprecated APIs - 1893 stars
- [wez/wezterm](https://github.com/wez/wezterm) - A GPU-accelerated cross-platform terminal emulator and multiplexer written by @wez and implemented in Rust - 8971 stars
...
- [ellie/atuin](https://github.com/ellie/atuin) - 🐢 Magical shell history - 9993 stars
...
- [awslabs/specctl](https://github.com/awslabs/specctl) - CLI to convert Kubernetes specifications to ECS Fargate and vice-versa - 160 stars
- [crablang/crab](https://github.com/crablang/crab) - A community fork of a language named after a plant fungus. All of the memory-safe features you love, now with 100% less bureaucracy!  - 4317 stars
