...
- [How To Set Up a Dead Man’s Switch in Prometheus](https://blog.ediri.io/how-to-set-up-a-dead-mans-switch-in-prometheus) (4 days ago)
- [Kubernetes and Pulumi: Converting k8s YAML to a Pulumi supported language](https://blog.ediri.io/kubernetes-and-pulumi-converting-k8s-yaml-to-a-pulumi-supported-language) (5 days ago)
...
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1076.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1076.0), 1 day ago) - IDE-style autocomplete for your existing terminal &amp; shell
- [dirien/minectl](https://github.com/dirien/minectl) ([v0.28.0](https://github.com/dirien/minectl/releases/tag/v0.28.0), 1 day ago) - minectl 🗺  is a cli for creating Minecraft server on different cloud provider.
- [dirien/minectl-sdk](https://github.com/dirien/minectl-sdk) ([v0.7.0](https://github.com/dirien/minectl-sdk/releases/tag/v0.7.0), 1 day ago) - SDK for every minectl product
- [dergeberl/multitool-container](https://github.com/dergeberl/multitool-container) ([v0.5.8](https://github.com/dergeberl/multitool-container/releases/tag/v0.5.8), 1 day ago) - Three containers with useful tools for troubleshooting
...
- [SchemaStore/schemastore](https://github.com/SchemaStore/schemastore) - A collection of JSON schema files including full API - 2062 stars
...
- [oslabs-beta/Kedalyze](https://github.com/oslabs-beta/Kedalyze) - An easy-to-use application that allows developers to visualize their Kubernetes cluster metrics and KEDA&#39;s auto-scaling pods in real-time. - 46 stars
...
- [pulumi/kube2pulumi](https://github.com/pulumi/kube2pulumi) - Upgrade your Kubernetes YAML to a modern language - 62 stars
