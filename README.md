...
- [dirien/c64-demo](https://github.com/dirien/c64-demo) - Classic Commodore 64 cracktro-style demo with raster bars, SID music, and bouncing Pulumi sprite (4 days ago)
...
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.19.0](https://github.com/port-labs/pulumi-port/releases/tag/v2.19.0), 1 day ago) - Pulumi Port provider
...
- [dirien/lazy-pulumi](https://github.com/dirien/lazy-pulumi) ([v0.6.0](https://github.com/dirien/lazy-pulumi/releases/tag/v0.6.0), 2 weeks ago) - A terminal UI (TUI) application for Pulumi Cloud
...
- [BloopAI/vibe-kanban](https://github.com/BloopAI/vibe-kanban) - Get 10X more out of Claude Code, Codex or any coding agent - 17890 stars
- [agentskills/agentskills](https://github.com/agentskills/agentskills) - Specification and documentation for Agent Skills - 6552 stars
- [michaelshimeles/ralphy](https://github.com/michaelshimeles/ralphy) - My Ralph Wiggum setup, an autonomous bash script that runs Claude Code, Codex, OpenCode, Cursor agent, Qwen &amp; Droid in a loop until your PRD is complete. - 1097 stars
- [antonbabenko/terraform-skill](https://github.com/antonbabenko/terraform-skill) - The Claude Agent Skill for Terraform and OpenTofu - testing, modules, CI/CD, and production patterns - 423 stars
- [blader/humanizer](https://github.com/blader/humanizer) - Claude Code skill that removes signs of AI-generated writing from text - 1678 stars
- [dlorenc/multiclaude](https://github.com/dlorenc/multiclaude) -  - 220 stars
- [sarwarbeing-ai/Agentic_Design_Patterns](https://github.com/sarwarbeing-ai/Agentic_Design_Patterns) - Agentic Design Patterns: A Hands-On Guide to Building Intelligent Systems by Antonio Gulli - 8122 stars
- [clawdbot/clawdbot](https://github.com/clawdbot/clawdbot) - Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞  - 5460 stars
- [getzep/graphiti](https://github.com/getzep/graphiti) - Build Real-Time Knowledge Graphs for AI Agents - 22146 stars
- [ballred/obsidian-claude-pkm](https://github.com/ballred/obsidian-claude-pkm) - A complete starter kit for an Obsidian &#43; Claude Code personal knowledge management system. - 872 stars
