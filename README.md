...
- [dirien/kgateway-demo](https://github.com/dirien/kgateway-demo) -  (4 days ago)
- [dirien/lazy-pulumi](https://github.com/dirien/lazy-pulumi) - A terminal UI (TUI) application for Pulumi Cloud (4 days ago)

#### 🚀 Latest releases I contributed to

- [dirien/minectl-sdk](https://github.com/dirien/minectl-sdk) ([v0.21.0](https://github.com/dirien/minectl-sdk/releases/tag/v0.21.0), 4 days ago) - SDK for every minectl product
- [pulumi/pulumi-terraform-bridge](https://github.com/pulumi/pulumi-terraform-bridge) ([v3.119.0](https://github.com/pulumi/pulumi-terraform-bridge/releases/tag/v3.119.0), 1 week ago) - A library allowing Terraform providers to be bridged into Pulumi.
...
- [dirien/minectl](https://github.com/dirien/minectl) ([v0.60.0](https://github.com/dirien/minectl/releases/tag/v0.60.0), 1 week ago) - minectl 🗺  is a cli for creating Minecraft server on different cloud provider.
...
- [AdminTurnedDevOps/Agentic-AI-The-Hard-Way](https://github.com/AdminTurnedDevOps/Agentic-AI-The-Hard-Way) - This repository contains free labs for setting up three entire workflows for Agentic AI from a real-world perspective - 9 stars
...
- [anthropics/claude-code](https://github.com/anthropics/claude-code) - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands. - 51616 stars
- [strands-agents/agent-sop](https://github.com/strands-agents/agent-sop) - Natural language workflows that enable AI agents to perform complex, multi-step tasks with consistency and reliability. - 599 stars
- [sinelaw/fresh](https://github.com/sinelaw/fresh) - Text editor for your terminal: easy, powerful and fast - 4703 stars
- [jesseduffield/lazygit](https://github.com/jesseduffield/lazygit) - simple terminal UI for git commands - 70197 stars
