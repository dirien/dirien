...
- [dirien/aws-ts-rag-opensearch](https://github.com/dirien/aws-ts-rag-opensearch) -  (6 days ago)
...
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.14.1](https://github.com/simple-icons/simple-icons/releases/tag/13.14.1), 3 days ago) - SVG icons for popular brands
...
- [pulumi/pulumi-backstage-plugin](https://github.com/pulumi/pulumi-backstage-plugin) ([v0.15.0](https://github.com/pulumi/pulumi-backstage-plugin/releases/tag/v0.15.0), 3 weeks ago) - Pulumi plugin for Backstage
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.0.23](https://github.com/port-labs/pulumi-port/releases/tag/v2.0.23), 3 weeks ago) - Pulumi Port provider
...
- [schednex-ai/schednex](https://github.com/schednex-ai/schednex) - Smart Kubernetes Scheduling - 55 stars
- [controlplaneio-fluxcd/flux-operator](https://github.com/controlplaneio-fluxcd/flux-operator) - Flux Operator is a Kubernetes controller for managing the lifecycle of Flux CD - 162 stars
- [mbarinov/repogpt](https://github.com/mbarinov/repogpt) - RepoGPT: AI-powered GitHub assistant to chat, manage, and explore your repos effortlessly. - 41 stars
- [antfu-collective/taze](https://github.com/antfu-collective/taze) - 🥦 A modern cli tool that keeps your deps fresh - 2812 stars
- [kubewall/kubewall](https://github.com/kubewall/kubewall) - A single binary kubernetes dashboard to manage your multiple clusters. - 564 stars
- [knadh/koanf](https://github.com/knadh/koanf) - Simple, extremely lightweight, extensible, configuration management library for Go. Support for JSON, TOML, YAML, env, command line, file, S3 etc. Alternative to viper. - 2753 stars
