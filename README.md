...
- [Fiber (Go) vs. Nickel.rs (Rust): A Performance Showdown in &#39;Hello World&#39;](https://blog.ediri.io/fiber-go-vs-nickelrs-rust-a-performance-showdown-in-hello-world) (5 days ago)
...
- [dirien/pulumi-scaleway](https://github.com/dirien/pulumi-scaleway) ([v2.16.3](https://github.com/dirien/pulumi-scaleway/releases/tag/v2.16.3), 1 day ago) - Pulumi provider for Scaleway
- [lbrlabs/pulumi-scaleway](https://github.com/lbrlabs/pulumi-scaleway) ([v1.8.0](https://github.com/lbrlabs/pulumi-scaleway/releases/tag/v1.8.0), 1 day ago) - Pulumi provider for Scaleway, the European cloud provider
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.9.12](https://github.com/alexellis/arkade/releases/tag/0.9.12), 2 days ago) - Open Source Marketplace For Developer Tools
...
- [dirien/pulumi-azapi](https://github.com/dirien/pulumi-azapi) ([v1.5.0](https://github.com/dirien/pulumi-azapi/releases/tag/v1.5.0), 3 days ago) - Pulumi provider for Azure API Management

#### ⭐ Latest repositories I starred

- [madhuakula/kubernetes-goat](https://github.com/madhuakula/kubernetes-goat) - Kubernetes Goat is a &#34;Vulnerable by Design&#34; cluster environment to learn and practice Kubernetes security using an interactive hands-on playground 🚀 - 3051 stars
- [codesenberg/bombardier](https://github.com/codesenberg/bombardier) - Fast cross-platform HTTP benchmarking tool written in Go - 4189 stars
- [wg/wrk](https://github.com/wg/wrk) - Modern HTTP benchmarking tool - 34209 stars
- [valyala/fasthttp](https://github.com/valyala/fasthttp) - Fast HTTP package for Go. Tuned for high performance. Zero memory allocations in hot paths. Up to 10x faster than net/http - 19382 stars
- [nickel-org/nickel.rs](https://github.com/nickel-org/nickel.rs) - An expressjs inspired web framework for Rust - 3000 stars
- [gofiber/fiber](https://github.com/gofiber/fiber) - ⚡️ Express inspired web framework written in Go - 25744 stars
- [humblepenguinn/envio](https://github.com/humblepenguinn/envio) - Envio is a command-line tool that simplifies the management of environment variables across multiple profiles. It allows users to easily switch between different configurations and apply them to their current environment - 512 stars
- [tsenart/vegeta](https://github.com/tsenart/vegeta) - HTTP load testing tool and library. It&#39;s over 9000! - 21076 stars
- [traefik/yaegi](https://github.com/traefik/yaegi) - Yaegi is Another Elegant Go Interpreter - 5618 stars
