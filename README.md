...
- [my-backstage-demo/pulumi-gitops-repo](https://github.com/my-backstage-demo/pulumi-gitops-repo) - Repository for the GitOps engine (1 day ago)
...
- [fluxcd-community/helm-charts](https://github.com/fluxcd-community/helm-charts) - Community maintained Helm charts for Flux (2 days ago)
- [my-backstage-demo/pulumi-backstage-flux-gitops-aws](https://github.com/my-backstage-demo/pulumi-backstage-flux-gitops-aws) -  (5 days ago)

#### 🚀 Latest releases I contributed to

- [pulumi/pulumi-backstage-plugin](https://github.com/pulumi/pulumi-backstage-plugin) ([v0.1.5](https://github.com/pulumi/pulumi-backstage-plugin/releases/tag/v0.1.5), 1 day ago) - Pulumi plugin for Backstage
- [fluxcd-community/helm-charts](https://github.com/fluxcd-community/helm-charts) ([flux2-2.10.2](https://github.com/fluxcd-community/helm-charts/releases/tag/flux2-2.10.2), 1 day ago) - Community maintained Helm charts for Flux
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.11.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.11.0), 2 days ago) - Azure Native Provider
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.19.0-next.2](https://github.com/backstage/backstage/releases/tag/v1.19.0-next.2), 2 days ago) - Backstage is an open platform for building developer portals
...
- [go-skynet/LocalAI](https://github.com/go-skynet/LocalAI) - :robot: The free, Open Source OpenAI alternative. Self-hosted, community-driven and local-first. Drop-in replacement for OpenAI running on consumer-grade hardware. No GPU required. Runs ggml, gguf, GPTQ, onnx, TF compatible models: llama, llama2, rwkv, whisper, vicuna, koala, cerebras, falcon, dolly, starcoder, and many others - 11957 stars
- [pulumi/esc](https://github.com/pulumi/esc) - Pulumi ESC (Environments, Secrets, and Configuration) for cloud applications and infrastructure. - 115 stars
- [ddosify/alaz](https://github.com/ddosify/alaz) - Effortless, Low-Overhead, eBPF-based Kubernetes Monitoring - 407 stars
- [kubero-dev/kubero](https://github.com/kubero-dev/kubero) - A free and self-hosted Heroku PaaS alternative for Kubernetes that implements GitOps - 1469 stars
...
- [thomaspoignant/go-feature-flag](https://github.com/thomaspoignant/go-feature-flag) - GO Feature Flag is a simple, complete and lightweight self-hosted feature flag solution 100% Open Source. 🎛️ - 837 stars
