...
- [dirien/stop-wasting-gpus-how-we-built-a-golden-path-for-gpu-sharing-on-kubernetes](https://github.com/dirien/stop-wasting-gpus-how-we-built-a-golden-path-for-gpu-sharing-on-kubernetes) -  (1 week ago)

#### 🚀 Latest releases I contributed to

- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.59](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.59), 4 days ago) - MCP DigitalOcean Integration
...
- [sidpalas/deputies](https://github.com/sidpalas/deputies) - Engineering agents for delegated work. - 31 stars
- [BerriAI/litellm-agent-platform](https://github.com/BerriAI/litellm-agent-platform) - Self-hosted platform for running coding agents (Claude Code, Codex, Hermes) in isolated sandboxes with vault proxy.  - 488 stars
- [kelos-dev/kelos](https://github.com/kelos-dev/kelos) - Kelos - The Kubernetes-native framework for orchestrating autonomous AI coding agents. - 174 stars
- [jamiepine/voicebox](https://github.com/jamiepine/voicebox) - The open-source AI voice studio. Clone, dictate, create. - 27906 stars
- [rohitg00/agentmemory](https://github.com/rohitg00/agentmemory) - #1 Persistent memory for AI coding agents based on real-world benchmarks - 16841 stars
- [vercel-labs/zerolang](https://github.com/vercel-labs/zerolang) - The programming language for agents - 4405 stars
- [dexhorthy/shannon](https://github.com/dexhorthy/shannon) - alternative to claude -p that lifecycles interactive sessions in tmux - 214 stars
- [NVIDIA/OpenShell](https://github.com/NVIDIA/OpenShell) - OpenShell is the safe, private runtime for autonomous AI agents. - 6200 stars
...
- [always-further/nono](https://github.com/always-further/nono) - Capability-based agent runtime with fine-grained policies . Brokering access directly within the agent&#39;s operating context, with zero setup and zero latency - 2456 stars
