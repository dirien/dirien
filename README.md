...
- [A Step-by-Step Guide to Using Velero on AWS EKS Clusters via Pulumi](https://blog.ediri.io/a-step-by-step-guide-to-using-velero-on-aws-eks-clusters-via-pulumi) (3 weeks ago)
...
- [dirien/kubecon-china-2023-tekton](https://github.com/dirien/kubecon-china-2023-tekton) - Tekton Demo for KubeCon China 2023 (4 days ago)
- [my-silly-organisation/test-app](https://github.com/my-silly-organisation/test-app) - This is test-app Go App (4 days ago)
- [my-silly-organisation/kubecon-2023-backstage-templates](https://github.com/my-silly-organisation/kubecon-2023-backstage-templates) -  (1 week ago)

#### 🚀 Latest releases I contributed to

- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.10.10](https://github.com/alexellis/arkade/releases/tag/0.10.10), 1 day ago) - Open Source Marketplace For Developer Tools
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1216.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1216.0), 1 day ago) - IDE-style autocomplete for your existing terminal &amp; shell
- [ovh/pulumi-ovh](https://github.com/ovh/pulumi-ovh) ([v0.34.3](https://github.com/ovh/pulumi-ovh/releases/tag/v0.34.3), 1 day ago) - Pulumi provider for OVHcloud
- [goreleaser/goreleaser](https://github.com/goreleaser/goreleaser) ([nightly](https://github.com/goreleaser/goreleaser/releases/tag/nightly), 2 days ago) - Deliver Go binaries as fast and easily as possible
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.9.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.9.0), 3 days ago) - Azure Native Provider

#### ⭐ Latest repositories I starred

- [pipe-cd/pipecd](https://github.com/pipe-cd/pipecd) - The One CD for All {applications, platforms, operations} - 838 stars
...
- [akuity/kargo](https://github.com/akuity/kargo) - Application lifecycle orchestration - 632 stars
- [kubernetes-sigs/e2e-framework](https://github.com/kubernetes-sigs/e2e-framework) - A Go framework for end-to-end testing of components running in Kubernetes clusters. - 360 stars
...
- [backstage/charts](https://github.com/backstage/charts) - Backstage Helm Charts - 68 stars
- [pulumi/tutorial-pulumi-fundamentals](https://github.com/pulumi/tutorial-pulumi-fundamentals) -  - 8 stars
- [dokku/dokku](https://github.com/dokku/dokku) - A docker-powered PaaS that helps you build and manage the lifecycle of applications - 25006 stars
