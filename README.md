...
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.46.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.46.0), 2 days ago) - Azure Native Provider
- [dirien/devpod-provider-scaleway](https://github.com/dirien/devpod-provider-scaleway) ([v0.6.0](https://github.com/dirien/devpod-provider-scaleway/releases/tag/v0.6.0), 2 days ago) - DevPod on Scaleway 🇫🇷
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.16-alpha.0](https://github.com/loft-sh/devpod/releases/tag/v0.5.16-alpha.0), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.4.1](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.4.1), 3 days ago)
...
- [flox/flox](https://github.com/flox/flox) - Developer environments you can take with you - 2177 stars
...
- [kserve/kserve](https://github.com/kserve/kserve) - Standardized Serverless ML Inference Platform on Kubernetes - 3232 stars
...
- [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly WebUI for LLMs (Formerly Ollama WebUI) - 28621 stars
- [volcano-sh/volcano](https://github.com/volcano-sh/volcano) - A Cloud Native Batch System (Project under CNCF) - 3877 stars
