...
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([12.4.0](https://github.com/simple-icons/simple-icons/releases/tag/12.4.0), 1 day ago) - SVG icons for popular brands
...
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.46.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.46.0), 3 days ago) - Azure Native Provider
- [dirien/devpod-provider-scaleway](https://github.com/dirien/devpod-provider-scaleway) ([v0.6.0](https://github.com/dirien/devpod-provider-scaleway/releases/tag/v0.6.0), 3 days ago) - DevPod on Scaleway 🇫🇷
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.16-alpha.0](https://github.com/loft-sh/devpod/releases/tag/v0.5.16-alpha.0), 3 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
...
- [flox/flox](https://github.com/flox/flox) - Developer environments you can take with you - 2178 stars
...
- [kserve/kserve](https://github.com/kserve/kserve) - Standardized Serverless ML Inference Platform on Kubernetes - 3234 stars
...
- [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly WebUI for LLMs (Formerly Ollama WebUI) - 28725 stars
