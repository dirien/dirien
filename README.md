...
- [sig-foodies/sig-foodies.github.io](https://github.com/sig-foodies/sig-foodies.github.io) - CNCF SIG Foodies website (1 day ago)
...
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1242.1](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1242.1), 1 day ago) - IDE-style autocomplete for your existing terminal &amp; shell
- [argoproj/argo-helm](https://github.com/argoproj/argo-helm) ([argo-cd-5.51.4](https://github.com/argoproj/argo-helm/releases/tag/argo-cd-5.51.4), 1 day ago) - ArgoProj Helm Charts
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.20.3](https://github.com/backstage/backstage/releases/tag/v1.20.3), 1 day ago) - Backstage is an open platform for building developer portals
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.1.6](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.1.6), 1 day ago)
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([9.21.0](https://github.com/simple-icons/simple-icons/releases/tag/9.21.0), 2 days ago) - SVG icons for popular brands

#### ⭐ Latest repositories I starred

- [kubeshop/tracetest](https://github.com/kubeshop/tracetest) - 🔭 Tracetest - Build integration and end-to-end tests in minutes, instead of days, using OpenTelemetry and trace-based testing. - 746 stars
- [charmbracelet/gum](https://github.com/charmbracelet/gum) - A tool for glamorous shell scripts 🎀 - 15237 stars
- [distribworks/dkron](https://github.com/distribworks/dkron) - Dkron - Distributed, fault tolerant job scheduling system https://dkron.io - 3942 stars
...
- [isotope-rs/isotope](https://github.com/isotope-rs/isotope) - AWS superpowers with the power of bedrock and speed of rust - 43 stars
- [zakkg3/ClusterSecret](https://github.com/zakkg3/ClusterSecret) - Kubernetes ClusterSecret operator. - 313 stars
- [Melkeydev/go-blueprint](https://github.com/Melkeydev/go-blueprint) - Go-blueprint allows users to spin up a quick Go project using a popular framework - 774 stars
- [kubeflow/kubeflow](https://github.com/kubeflow/kubeflow) - Machine Learning Toolkit for Kubernetes - 13162 stars
...
- [numaproj/numaflow](https://github.com/numaproj/numaflow) - Kubernetes-native platform to run massively parallel data/streaming jobs - 821 stars
