...
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-k8s-exporter-0.1.19](https://github.com/port-labs/helm-charts/releases/tag/port-k8s-exporter-0.1.19), 2 days ago)
- [dirien/pulumi-github](https://github.com/dirien/pulumi-github) ([v0.2.33](https://github.com/dirien/pulumi-github/releases/tag/v0.2.33), 2 days ago) - Pulumi program to manage my GitHub repositories
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v1.4.1](https://github.com/port-labs/pulumi-port/releases/tag/v1.4.1), 3 days ago)
...
- [yonahd/kor](https://github.com/yonahd/kor) - A Golang Tool to discover unused Kubernetes Resources  - 87 stars
- [kubernetes-up-and-running/kuard](https://github.com/kubernetes-up-and-running/kuard) - Demo app for Kubernetes Up and Running book - 1425 stars
- [kubewharf/kelemetry](https://github.com/kubewharf/kelemetry) - Global control plane tracing for Kubernetes - 180 stars
