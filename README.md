...
- [dirien/url-shortener-saas](https://github.com/dirien/url-shortener-saas) - Production-ready URL Shortener SaaS built with Pulumi TypeScript, AWS Lambda, DynamoDB, CloudFront, and React (today)
- [dirien/kubecon-na-honeycomb-pulumi-aws-workshop](https://github.com/dirien/kubecon-na-honeycomb-pulumi-aws-workshop) -  (1 day ago)
- [dirien/cfgmgmtcamp-2026-agentic-ai-workshop](https://github.com/dirien/cfgmgmtcamp-2026-agentic-ai-workshop) - Building AI-Assisted Operations: Agentic AI Workshop - CfgMgmtCamp Ghent 2026 (2 days ago)
...
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.16.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.16.0), 5 days ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
...
- [dirien/minecraft-prometheus-exporter](https://github.com/dirien/minecraft-prometheus-exporter) ([0.15.0-helm](https://github.com/dirien/minecraft-prometheus-exporter/releases/tag/0.15.0-helm), 2 weeks ago) - Minecraft Prometheus exporter

#### ⭐ Latest repositories I starred

- [mcp-use/mcp-use](https://github.com/mcp-use/mcp-use) - mcp-use is the easiest way to interact with mcp servers with custom agents - 8901 stars
- [coleam00/habit-tracker](https://github.com/coleam00/habit-tracker) - Habit Tracker for the AI Coding Workshop - 296 stars
- [Free-TV/IPTV](https://github.com/Free-TV/IPTV) - M3U Playlist for free TV channels - 10584 stars
- [aws-samples/sample-strands-agents-agentskills](https://github.com/aws-samples/sample-strands-agents-agentskills) - Agent Skills implementation for Strands Agents SDK - 19 stars
- [exospherehost/exospherehost](https://github.com/exospherehost/exospherehost) - Runtime for building and managing AI agents and Workflows. Easy to learn, fast to build, High Performance, Reliable by design, Intuitive UI, Production Ready. - 177 stars
...
- [AdminTurnedDevOps/Agentic-AI-The-Hard-Way](https://github.com/AdminTurnedDevOps/Agentic-AI-The-Hard-Way) - This repository contains free labs for setting up three entire workflows for Agentic AI from a real-world perspective - 26 stars
- [jatinmehrotra/aws-reinvent-2025](https://github.com/jatinmehrotra/aws-reinvent-2025) - Showing use cases for different updates - 5 stars
- [ruvnet/claude-flow](https://github.com/ruvnet/claude-flow) - 🌊 The leading agent orchestration platform for Claude. Deploy intelligent multi-agent swarms, coordinate autonomous workflows, and build conversational AI systems. Features    enterprise-grade architecture, distributed swarm intelligence, RAG integration, and native Claude Code support via MCP protocol. Ranked #1 in agent-based frameworks. - 11906 stars
