...
- [dirien/lazy-pulumi](https://github.com/dirien/lazy-pulumi) ([v0.6.1](https://github.com/dirien/lazy-pulumi/releases/tag/v0.6.1), 2 days ago) - A terminal UI (TUI) application for Pulumi Cloud
- [kubernetes-sigs/kro](https://github.com/kubernetes-sigs/kro) ([v0.8.1](https://github.com/kubernetes-sigs/kro/releases/tag/v0.8.1), 2 days ago) - kro | Kube Resource Orchestrator
- [pulumi/pulumi-kubernetes-operator](https://github.com/pulumi/pulumi-kubernetes-operator) ([v2.4.0](https://github.com/pulumi/pulumi-kubernetes-operator/releases/tag/v2.4.0), 4 days ago) - A Kubernetes Operator that automates the deployment of Pulumi Stacks
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.19.2](https://github.com/port-labs/pulumi-port/releases/tag/v2.19.2), 4 days ago) - Pulumi Port provider
...
- [opsyhq/opsy](https://github.com/opsyhq/opsy) - AI DevOps Agent that won&#39;t take down your production - 18 stars
...
- [open-constructs/cdk-terrain](https://github.com/open-constructs/cdk-terrain) - Define infrastructure resources using programming constructs and provision them using OpenTofu/Terraform - 54 stars
- [0xSojalSec/airllm](https://github.com/0xSojalSec/airllm) - AirLLM 70B inference with single 4GB GPU - 2083 stars
- [batrachianai/toad](https://github.com/batrachianai/toad) - A unified interface for AI in your terminal. - 1970 stars
- [BloopAI/vibe-kanban](https://github.com/BloopAI/vibe-kanban) - Get 10X more out of Claude Code, Codex or any coding agent - 19701 stars
- [agentskills/agentskills](https://github.com/agentskills/agentskills) - Specification and documentation for Agent Skills - 7874 stars
- [michaelshimeles/ralphy](https://github.com/michaelshimeles/ralphy) - My Ralph Wiggum setup, an autonomous bash script that runs Claude Code, Codex, OpenCode, Cursor agent, Qwen &amp; Droid in a loop until your PRD is complete. - 2043 stars
- [antonbabenko/terraform-skill](https://github.com/antonbabenko/terraform-skill) - The Claude Agent Skill for Terraform and OpenTofu - testing, modules, CI/CD, and production patterns - 830 stars
