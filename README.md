...
- [dirien/pulumi-qovery](https://github.com/dirien/pulumi-qovery) ([v0.37.0](https://github.com/dirien/pulumi-qovery/releases/tag/v0.37.0), 2 days ago) - Pulumi provider for Qovery
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.20-alpha.0](https://github.com/loft-sh/devpod/releases/tag/v0.5.20-alpha.0), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.19](https://github.com/alexellis/arkade/releases/tag/0.11.19), 3 days ago) - Open Source Marketplace For Developer Tools
- [ovh/pulumi-ovh](https://github.com/ovh/pulumi-ovh) ([v0.48.0](https://github.com/ovh/pulumi-ovh/releases/tag/v0.48.0), 4 days ago) - Pulumi provider for OVHcloud
...
- [cryptocode/terminal-doom](https://github.com/cryptocode/terminal-doom) - Play DOOM in modern terminals - 71 stars
...
- [infiniflow/ragflow](https://github.com/infiniflow/ragflow) - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding. - 13868 stars
