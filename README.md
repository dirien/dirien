...
- [pulumi-labs/pulumi-exporter](https://github.com/pulumi-labs/pulumi-exporter) ([v0.1.1](https://github.com/pulumi-labs/pulumi-exporter/releases/tag/v0.1.1), 1 day ago) - OpenTelemetry Pulumi Cloud metrics exporter
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.21.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.21.0), 1 week ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
...
- [can1357/oh-my-pi](https://github.com/can1357/oh-my-pi) - ⌥  AI Coding agent for the terminal — hash-anchored edits, optimized tool harness, LSP, Python, browser, subagents, and more - 1842 stars
- [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) - omo; the best agent harness - previously oh-my-opencode - 38822 stars
- [github/gh-aw](https://github.com/github/gh-aw) - GitHub Agentic Workflows - 4018 stars
...
- [openclaw-rocks/k8s-operator](https://github.com/openclaw-rocks/k8s-operator) - Kubernetes operator for deploying and managing OpenClaw AI agent instances with production-grade security, observability, and lifecycle management. - 173 stars
- [bradygaster/squad](https://github.com/bradygaster/squad) - Squad: AI agent teams for any project - 745 stars
- [GoogleCloudPlatform/generative-ai](https://github.com/GoogleCloudPlatform/generative-ai) - Sample code and notebooks for Generative AI on Google Cloud, with Gemini on Vertex AI - 15723 stars
- [affaan-m/everything-claude-code](https://github.com/affaan-m/everything-claude-code) - The agent harness performance optimization system. Skills, instincts, memory, security, and research-first development for Claude Code, Codex, Opencode, Cursor and beyond. - 70554 stars
- [googleworkspace/cli](https://github.com/googleworkspace/cli) - Google Workspace CLI — one command-line tool for Drive, Gmail, Calendar, Sheets, Docs, Chat, Admin, and more. Dynamically built from Google Discovery Service. Includes AI agent skills. - 18175 stars
- [mvklingeren/sk8r](https://github.com/mvklingeren/sk8r) - A kubernetes-dashboard clone - 51 stars
