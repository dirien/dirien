...
- [dirien/devpod-provider-exoscale](https://github.com/dirien/devpod-provider-exoscale) - DevPod on Exoscale 🇨🇭 (4 days ago)

#### 🚀 Latest releases I contributed to

- [external-secrets/external-secrets](https://github.com/external-secrets/external-secrets) ([helm-chart-0.9.13](https://github.com/external-secrets/external-secrets/releases/tag/helm-chart-0.9.13), 1 day ago) - External Secrets Operator reads information from a third-party service like AWS Secrets Manager and automatically injects the values as Kubernetes Secrets.
...
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.29.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.29.0), 2 days ago) - Azure Native Provider
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v1.10.1](https://github.com/port-labs/pulumi-port/releases/tag/v1.10.1), 2 days ago)
- [dirien/devpod-provider-exoscale](https://github.com/dirien/devpod-provider-exoscale) ([v0.3.0](https://github.com/dirien/devpod-provider-exoscale/releases/tag/v0.3.0), 4 days ago) - DevPod on Exoscale 🇨🇭

#### ⭐ Latest repositories I starred

- [basemind-ai/gateway](https://github.com/basemind-ai/gateway) - The BaseMind.AI monorepo - 17 stars
- [facebook/dotslash](https://github.com/facebook/dotslash) - Simplified executable deployment - 382 stars
- [nuke-build/nuke](https://github.com/nuke-build/nuke) - 🏗 The AKEless Build System for C#/.NET - 2273 stars
- [gptscript-ai/gptscript](https://github.com/gptscript-ai/gptscript) - Natural Language Programming  - 462 stars
- [second-state/LlamaEdge](https://github.com/second-state/LlamaEdge) - The easiest &amp; fastest way to run customized and fine-tuned LLMs locally or on the edge - 345 stars
- [Azure/AI-in-a-Box](https://github.com/Azure/AI-in-a-Box) -  - 149 stars
...
- [langchain-ai/langserve](https://github.com/langchain-ai/langserve) - LangServe 🦜️🏓 - 1289 stars
