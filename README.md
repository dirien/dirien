...
- [Kubernetes GPU Sharing: NVIDIA MIG &#43; DRA on Amazon EKS](https://blog.ediri.io/kubernetes-gpu-sharing-nvidia-mig-dra-on-amazon-eks) (2 months ago)
...
- [pulumi-labs/pulumi-exporter](https://github.com/pulumi-labs/pulumi-exporter) - OpenTelemetry Pulumi Cloud metrics exporter (3 weeks ago)
- [dirien/devcontainer-coding-agents](https://github.com/dirien/devcontainer-coding-agents) - Devcontainer with four AI coding agents (Claude Code, Copilot, OpenCode, Codex) and yaah for unified config generation (3 weeks ago)

#### 🚀 Latest releases I contributed to

- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.50](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.50), 2 days ago) - MCP DigitalOcean Integration
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.27.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.27.0), 6 days ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.21.8](https://github.com/port-labs/pulumi-port/releases/tag/v2.21.8), 1 week ago) - Pulumi Port provider
...
- [pulumi/pulumi-kubernetes-operator](https://github.com/pulumi/pulumi-kubernetes-operator) ([v2.7.0](https://github.com/pulumi/pulumi-kubernetes-operator/releases/tag/v2.7.0), 3 weeks ago) - A Kubernetes Operator that automates the deployment of Pulumi Stacks

#### ⭐ Latest repositories I starred

- [microsoft/AIforITOps](https://github.com/microsoft/AIforITOps) - Workshop for IT/Ops teams to learn how to manage AI-enabled applications on Microsoft Azure. - 92 stars
- [DanWahlin/github-azure-agentic-journeys](https://github.com/DanWahlin/github-azure-agentic-journeys) - Idea → Prototype → Reality: Agentic journeys to help you build and deploy applications to Azure using agents and skills. - 23 stars
- [vercel-labs/portless](https://github.com/vercel-labs/portless) - Replace port numbers with stable, named local URLs. For humans and agents. - 8161 stars
- [microsoft/Hosted_Agents_Workshop_dotNET](https://github.com/microsoft/Hosted_Agents_Workshop_dotNET) - Build your first Microsoft Foundry hosted agent with this hands-on .NET 10 workshop, covering local development, Copilot-assisted coding, CI, secure deployment to Azure, and a working chat UI. - 12 stars
- [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) - ClawSweeper scans all issues and PRs and suggest what we can close, and why. It runs every PR / Issue once a week. - 1269 stars
- [Azure-Samples/foundry-hosted-agentframework-demos](https://github.com/Azure-Samples/foundry-hosted-agentframework-demos) - A demo project that deploys Agent Framework agent to Foundry Hosted Agents - 18 stars
- [microsoft/openclaw](https://github.com/microsoft/openclaw) - Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞  - 47 stars
- [crossplane-contrib/crossplane-diff](https://github.com/crossplane-contrib/crossplane-diff) - A command line diff tool for crossplane. - 37 stars
- [multica-ai/multica](https://github.com/multica-ai/multica) - The open-source managed agents platform. Turn coding agents into real teammates — assign tasks, track progress, compound skills. - 22453 stars
- [excalidraw/excalidraw-mcp](https://github.com/excalidraw/excalidraw-mcp) - Fast and streamable Excalidraw MCP App - 4217 stars

#### 👥 Latest follower

- [sergelogvinov](https://github.com/sergelogvinov) - Serge
- [Priyanshudev001](https://github.com/Priyanshudev001) - Priyanshu Dev
- [pawelkasperek](https://github.com/pawelkasperek) - Pawel Kasperek
- [arepodesir](https://github.com/arepodesir) - Arepo Desir
- [dioptx](https://github.com/dioptx) - Dennis P

#### 👨‍💻 Repositories I created recently

- [dirien/from-zero-to-ai-agent-building-with-azure-ai-agent-service](https://github.com/dirien/from-zero-to-ai-agent-building-with-azure-ai-agent-service) - From Prompt Agent to Production: AI Agents on Azure AI Foundry — three-stage demo (Foundry Local &#43; MAF → declarative prompt agents → MAF container with Memory, MCP, and AI Gateway governance). Pulumi IaC, companion to the Bedrock AgentCore talk.
