...
- [Building a RESTful API with Actix Web and Diesel for Persistent Data Storage](https://blog.ediri.io/building-a-restful-api-with-actix-web-and-diesel-for-persistent-data-storage) (2 days ago)
...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.9.5](https://github.com/alexellis/arkade/releases/tag/0.9.5), 1 day ago) - Open Source Marketplace For Kubernetes
...
- [dirien/pulumi-scaleway](https://github.com/dirien/pulumi-scaleway) ([v2.13.1](https://github.com/dirien/pulumi-scaleway/releases/tag/v2.13.1), 2 days ago) - Pulumi provider for Scaleway
- [dirien/pulumi-github](https://github.com/dirien/pulumi-github) ([v0.2.22](https://github.com/dirien/pulumi-github/releases/tag/v0.2.22), 2 days ago) - Pulumi program to manage my GitHub repositories
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([8.8.0](https://github.com/simple-icons/simple-icons/releases/tag/8.8.0), 2 days ago) - SVG icons for popular brands

#### ⭐ Latest repositories I starred

- [ContainerSSH/ContainerSSH](https://github.com/ContainerSSH/ContainerSSH) - ContainerSSH: Launch containers on demand - 2185 stars
...
- [orhun/halp](https://github.com/orhun/halp) - A CLI tool to get help with CLI tools 🐙 - 520 stars
- [project-zot/zot](https://github.com/project-zot/zot) - zot - A production-ready vendor-neutral OCI-native container image registry (purely based on OCI Distribution Specification) - 326 stars
...
- [bevyengine/bevy](https://github.com/bevyengine/bevy) - A refreshingly simple data-driven game engine built in Rust - 22723 stars
