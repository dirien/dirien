...
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.17.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.17.0), 1 day ago) - Azure Native Provider
- [ovh/pulumi-ovh](https://github.com/ovh/pulumi-ovh) ([v0.35.0](https://github.com/ovh/pulumi-ovh/releases/tag/v0.35.0), 1 day ago) - Pulumi provider for OVHcloud
- [SchwarzIT/node-red-chart](https://github.com/SchwarzIT/node-red-chart) ([node-red-0.28.0](https://github.com/SchwarzIT/node-red-chart/releases/tag/node-red-0.28.0), 2 days ago) - Node-red Helm Chart
- [pulumi/pulumi-kubernetes-operator](https://github.com/pulumi/pulumi-kubernetes-operator) ([pulumi-kubernetes-operator-0.4.0](https://github.com/pulumi/pulumi-kubernetes-operator/releases/tag/pulumi-kubernetes-operator-0.4.0), 2 days ago) - A Kubernetes Operator that automates the deployment of Pulumi Stacks
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([9.20.0](https://github.com/simple-icons/simple-icons/releases/tag/9.20.0), 2 days ago) - SVG icons for popular brands

#### ⭐ Latest repositories I starred

- [zakkg3/ClusterSecret](https://github.com/zakkg3/ClusterSecret) - Kubernetes ClusterSecret operator. - 312 stars
- [Melkeydev/go-blueprint](https://github.com/Melkeydev/go-blueprint) - Go-blueprint allows users to spin up a quick Go project using a popular framework - 630 stars
- [kubeflow/kubeflow](https://github.com/kubeflow/kubeflow) - Machine Learning Toolkit for Kubernetes - 13141 stars
...
- [numaproj/numaflow](https://github.com/numaproj/numaflow) - Kubernetes-native platform to run massively parallel data/streaming jobs - 817 stars
...
- [FlowiseAI/Flowise](https://github.com/FlowiseAI/Flowise) - Drag &amp; drop UI to build your customized LLM flow - 17676 stars
- [benwilcock/backstage-plugin-backchat](https://github.com/benwilcock/backstage-plugin-backchat) - A quick and dirty frontend plugin that integrates a GenAI feature into Backstage - 14 stars
