...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.16](https://github.com/alexellis/arkade/releases/tag/0.11.16), 2 days ago) - Open Source Marketplace For Developer Tools
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.3.2](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.3.2), 2 days ago)
- [dirien/pulumi-fly](https://github.com/dirien/pulumi-fly) ([v0.1.13](https://github.com/dirien/pulumi-fly/releases/tag/v0.1.13), 2 days ago) - Pulumi provider for Fly.io
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.15](https://github.com/loft-sh/devpod/releases/tag/v0.5.15), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
...
- [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly WebUI for LLMs (Formerly Ollama WebUI) - 27421 stars
...
- [robusta-dev/holmesgpt](https://github.com/robusta-dev/holmesgpt) - On-Call/DevOps Assistant - Get a head start on fixing alerts with AI investigation - 174 stars
- [explodinggradients/ragas](https://github.com/explodinggradients/ragas) - Evaluation framework for your Retrieval Augmented Generation (RAG) pipelines - 5377 stars
