...
- [langchain-ai/langserve](https://github.com/langchain-ai/langserve) ([v0.2.1](https://github.com/langchain-ai/langserve/releases/tag/v0.2.1), 2 days ago) - LangServe 🦜️🏓
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.9-alpha.1](https://github.com/loft-sh/devpod/releases/tag/v0.5.9-alpha.1), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
...
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.42.1](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.42.1), 4 days ago) - Azure Native Provider

#### ⭐ Latest repositories I starred

- [containers/bootc](https://github.com/containers/bootc) - Boot and upgrade via container images - 419 stars
...
- [octodns/octodns](https://github.com/octodns/octodns) - Tools for managing DNS across multiple providers - 2996 stars
- [sigoden/aichat](https://github.com/sigoden/aichat) - All-in-one AI-Powered CLI Chat &amp; Copilot that integrates 20&#43; AI platforms, including OpenAI, Azure-OpenAI, Gemini, Claude, Mistral, Cohere, VertexAI, Bedrock, Ollama, Ernie, Qianwen, Deepseek... - 3007 stars
- [jozu-ai/kitops](https://github.com/jozu-ai/kitops) - Tools for easing the handoff between AI/ML and App/SRE teams. - 196 stars
- [inkdrop-org/inkdrop-visualizer](https://github.com/inkdrop-org/inkdrop-visualizer) - Visualizes your Terraform - 409 stars
