...
- [dirien/pulumi-minecraft](https://github.com/dirien/pulumi-minecraft) - Pulumi component (Go): a Java Minecraft server on DigitalOcean (3 days ago)
- [pulumi/docs](https://github.com/pulumi/docs) - All things Pulumi docs! (4 days ago)
- [dirien/hermes-agent-pulumi](https://github.com/dirien/hermes-agent-pulumi) - Deploy a private Hermes agent as one Pulumi program across Render, Modal, and Tailscale. Companion to the Pulumi blog post. (5 days ago)
...
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.65](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.65), 4 days ago) - MCP DigitalOcean Integration
...
- [dirien/yet-another-agent-harness](https://github.com/dirien/yet-another-agent-harness) ([v0.5.0](https://github.com/dirien/yet-another-agent-harness/releases/tag/v0.5.0), 4 weeks ago) - A Go agent harness for Claude Code — runtime hooks, MCP server, session tracking, middleware chains, and full config generation in one binary
...
- [ferdinandobons/AWSBedrockAgentCoreSkill](https://github.com/ferdinandobons/AWSBedrockAgentCoreSkill) - Authoritative, source-cited Claude Code plugin/skill that lets a coding agent autonomously build production-grade AI agents on AWS (Strands Agents, Amazon Bedrock, Bedrock AgentCore) with official best practices. - 107 stars
- [cobusgreyling/loop-engineering](https://github.com/cobusgreyling/loop-engineering) - Practical patterns, starters &amp; CLI tools for loop engineering with AI coding agents. Design systems that prompt and orchestrate agents (inspired by Addy Osmani and Boris Cherny). Includes loop-audit, loop-init, loop-cost. - 3258 stars
- [weirdmachine64/SharkMCP](https://github.com/weirdmachine64/SharkMCP) - A swiss-knife MCP server for analysing PCAP files - 70 stars
- [tanrikuluozlem/burn](https://github.com/tanrikuluozlem/burn) - See what&#39;s burning your Kubernetes budget - 84 stars
- [visa/visa-vulnerability-agentic-harness](https://github.com/visa/visa-vulnerability-agentic-harness) - Visa Vulnerability Agentic Harness - 570 stars
- [ai-ecoverse/gh-reaper](https://github.com/ai-ecoverse/gh-reaper) - Harvest stale git worktrees: find them by age &amp; size across your machine and reap them. Read-only by default, macOS TCC-safe. (Don&#39;t Fear) The Reaper for forgotten worktrees. - 2 stars
- [CopilotKit/OpenTag](https://github.com/CopilotKit/OpenTag) - OpenTag - 205 stars
- [EpicGames/lore](https://github.com/EpicGames/lore) - Lore is a next-generation, open source version control system - 6898 stars
- [getsentry/dotagents](https://github.com/getsentry/dotagents) -  - 199 stars
- [ngrok/webernetes](https://github.com/ngrok/webernetes) - Kubernetes in the browser. - 646 stars
