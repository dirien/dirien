...
- [dirien/backrooms](https://github.com/dirien/backrooms) - A browser-based backrooms horror game built with Three.js (3 days ago)
...
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.23.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.23.0), 1 day ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
- [dirien/yet-another-agent-harness](https://github.com/dirien/yet-another-agent-harness) ([v0.1.6](https://github.com/dirien/yet-another-agent-harness/releases/tag/v0.1.6), 2 days ago) - A Go agent harness for Claude Code — runtime hooks, MCP server, session tracking, middleware chains, and full config generation in one binary
- [pulumi-labs/pulumi-exporter](https://github.com/pulumi-labs/pulumi-exporter) ([v0.1.1](https://github.com/pulumi-labs/pulumi-exporter/releases/tag/v0.1.1), 3 days ago) - OpenTelemetry Pulumi Cloud metrics exporter
...
- [HKUDS/CLI-Anything](https://github.com/HKUDS/CLI-Anything) - CLI-Anything: Making ALL Software Agent-Native - 8732 stars
- [tisu19021997/langclaw](https://github.com/tisu19021997/langclaw) - Langchain &#43; Openclaw = Langclaw - 28 stars
...
- [can1357/oh-my-pi](https://github.com/can1357/oh-my-pi) - ⌥  AI Coding agent for the terminal — hash-anchored edits, optimized tool harness, LSP, Python, browser, subagents, and more - 1909 stars
- [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) - omo; the best agent harness - previously oh-my-opencode - 39471 stars
- [github/gh-aw](https://github.com/github/gh-aw) - GitHub Agentic Workflows - 4073 stars
- [filipegalo/openclaw-with-brains-chart](https://github.com/filipegalo/openclaw-with-brains-chart) - 🦞 Helm chart for OpenClaw - with brains - 2 stars
- [openclaw-rocks/k8s-operator](https://github.com/openclaw-rocks/k8s-operator) - Kubernetes operator for deploying and managing OpenClaw AI agent instances with production-grade security, observability, and lifecycle management. - 190 stars
- [bradygaster/squad](https://github.com/bradygaster/squad) - Squad: AI agent teams for any project - 775 stars
- [GoogleCloudPlatform/generative-ai](https://github.com/GoogleCloudPlatform/generative-ai) - Sample code and notebooks for Generative AI on Google Cloud, with Gemini on Vertex AI - 16079 stars
