...
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.768.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.768.0), 1 day ago) - Fig adds autocomplete to your terminal.
- [sigstore/cosign-installer](https://github.com/sigstore/cosign-installer) ([v2.4.0](https://github.com/sigstore/cosign-installer/releases/tag/v2.4.0), 2 days ago) - Cosign Github Action
- [dexidp/dex](https://github.com/dexidp/dex) ([v2.32.0](https://github.com/dexidp/dex/releases/tag/v2.32.0), 3 days ago) - OpenID Connect (OIDC) identity and OAuth 2.0 provider with pluggable connectors
...
- [sigstore/cosign](https://github.com/sigstore/cosign) ([v1.9.0](https://github.com/sigstore/cosign/releases/tag/v1.9.0), 1 week ago) - Container Signing
...
- [chainguard-dev/ssc-reading-list](https://github.com/chainguard-dev/ssc-reading-list) - A reading list for software supply-chain security. - 202 stars
...
- [cosmtrek/air](https://github.com/cosmtrek/air) - ☁️ Live reload for Go apps - 7103 stars
