...
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.49](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.49), 2 days ago) - MCP DigitalOcean Integration
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.27.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.27.0), 3 days ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
...
- [Azure-Samples/foundry-hosted-agentframework-demos](https://github.com/Azure-Samples/foundry-hosted-agentframework-demos) - A demo project that deploys Agent Framework agent to Foundry Hosted Agents - 1 stars
- [microsoft/openclaw](https://github.com/microsoft/openclaw) - Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞  - 44 stars
...
- [multica-ai/multica](https://github.com/multica-ai/multica) - The open-source managed agents platform. Turn coding agents into real teammates — assign tasks, track progress, compound skills. - 21067 stars
- [excalidraw/excalidraw-mcp](https://github.com/excalidraw/excalidraw-mcp) - Fast and streamable Excalidraw MCP App - 4180 stars
- [TencentCloud/CubeSandbox](https://github.com/TencentCloud/CubeSandbox) - Instant, Concurrent, Secure &amp; Lightweight Sandbox for AI Agents. - 4077 stars
- [BlockRunAI/ClawRouter](https://github.com/BlockRunAI/ClawRouter) - The agent-native LLM router for OpenClaw. 41&#43; models, &lt;1ms routing, USDC payments on Base &amp; Solana via x402. - 6288 stars
- [obot-platform/discobot](https://github.com/obot-platform/discobot) - Coding Agent - 67 stars
- [vercel-labs/wterm](https://github.com/vercel-labs/wterm) - A terminal emulator for the web - 2419 stars
- [getagentseal/codeburn](https://github.com/getagentseal/codeburn) - See where your AI coding tokens go. Interactive TUI dashboard for Claude Code, Codex, and Cursor cost observability. - 3890 stars
