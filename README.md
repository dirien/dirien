...
- [Design Patterns in Rust 🦀: Upgrading the Builder Pattern using the Typestate Pattern](https://blog.ediri.io/design-patterns-in-rust-upgrading-the-builder-pattern-using-the-typestate-pattern) (2 days ago)
...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.9.0](https://github.com/alexellis/arkade/releases/tag/0.9.0), 3 days ago) - Open Source Marketplace For Kubernetes
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1129.1](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1129.1), 4 days ago) - IDE-style autocomplete for your existing terminal &amp; shell
- [dirien/pulumi-azapi](https://github.com/dirien/pulumi-azapi) ([v1.3.1](https://github.com/dirien/pulumi-azapi/releases/tag/v1.3.1), 5 days ago) - Pulumi provider for Azure API Management
- [lbrlabs/pulumi-scaleway](https://github.com/lbrlabs/pulumi-scaleway) ([v1.7.0](https://github.com/lbrlabs/pulumi-scaleway/releases/tag/v1.7.0), 5 days ago) - Pulumi provider for Scaleway, the European cloud provider
- [dirien/minectl](https://github.com/dirien/minectl) ([v0.29.0](https://github.com/dirien/minectl/releases/tag/v0.29.0), 5 days ago) - minectl 🗺  is a cli for creating Minecraft server on different cloud provider.
...
- [keephq/keep](https://github.com/keephq/keep) - Alerting. By developers, for developers. - 718 stars
...
- [coder/coder](https://github.com/coder/coder) - A tool that provisions remote development environments via Terraform - 3632 stars
