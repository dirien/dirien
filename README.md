...
- [dirien/pulumi-azure-flux-weave-ui](https://github.com/dirien/pulumi-azure-flux-weave-ui) - Playing around with the Weave GitOps UI (1 day ago)
...
- [jaxxstorm/pulumi-examples](https://github.com/jaxxstorm/pulumi-examples) -  (4 days ago)

#### 🚀 Latest releases I contributed to

- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.721.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.721.0), 1 day ago) - Fig adds autocomplete to your terminal.
- [argoproj-labs/argocd-autopilot](https://github.com/argoproj-labs/argocd-autopilot) ([v0.3.7](https://github.com/argoproj-labs/argocd-autopilot/releases/tag/v0.3.7), 1 day ago) - Argo-CD Autopilot
...
- [inlets/inlets-pro](https://github.com/inlets/inlets-pro) ([0.9.4-rc1](https://github.com/inlets/inlets-pro/releases/tag/0.9.4-rc1), 4 days ago) - Secure HTTP and TCP tunnels that just work

#### ⭐ Latest repositories I starred

- [weaveworks/weave-gitops](https://github.com/weaveworks/weave-gitops) - Weave GitOps core - 273 stars
...
- [kyverno/kyverno](https://github.com/kyverno/kyverno) - Kubernetes Native Policy Management - 2350 stars
...
- [kubernetes/git-sync](https://github.com/kubernetes/git-sync) - A sidecar app which clones a git repo and keeps it in sync with the upstream. - 1408 stars
...
- [guymenahem/the-kubernetes-journey](https://github.com/guymenahem/the-kubernetes-journey) - The community journey to master Kubernetes - 38 stars
