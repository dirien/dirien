...
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.49](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.49), 3 days ago) - MCP DigitalOcean Integration
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.27.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.27.0), 4 days ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
...
- [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) - ClawSweeper scans all issues and PRs and suggest what we can close, and why. It runs every PR / Issue once a week. - 989 stars
- [Azure-Samples/foundry-hosted-agentframework-demos](https://github.com/Azure-Samples/foundry-hosted-agentframework-demos) - A demo project that deploys Agent Framework agent to Foundry Hosted Agents - 2 stars
- [microsoft/openclaw](https://github.com/microsoft/openclaw) - Your own personal AI assistant. Any OS. Any Platform. The lobster way. 🦞  - 45 stars
...
- [multica-ai/multica](https://github.com/multica-ai/multica) - The open-source managed agents platform. Turn coding agents into real teammates — assign tasks, track progress, compound skills. - 21449 stars
- [excalidraw/excalidraw-mcp](https://github.com/excalidraw/excalidraw-mcp) - Fast and streamable Excalidraw MCP App - 4189 stars
- [TencentCloud/CubeSandbox](https://github.com/TencentCloud/CubeSandbox) - Instant, Concurrent, Secure &amp; Lightweight Sandbox for AI Agents. - 4213 stars
- [BlockRunAI/ClawRouter](https://github.com/BlockRunAI/ClawRouter) - The agent-native LLM router for OpenClaw. 41&#43; models, &lt;1ms routing, USDC payments on Base &amp; Solana via x402. - 6339 stars
