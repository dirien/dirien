...
- [Design Patterns in Rust 🦀: An Introduction to the Builder Pattern](https://blog.ediri.io/design-patterns-in-rust-an-introduction-to-the-builder-pattern) (3 days ago)
...
- [aquasecurity/helm-charts](https://github.com/aquasecurity/helm-charts) ([trivy-operator-0.11.0-rc](https://github.com/aquasecurity/helm-charts/releases/tag/trivy-operator-0.11.0-rc), 1 day ago) - Aqua Open Source Helm Chart Repository
- [aquasecurity/trivy-operator](https://github.com/aquasecurity/trivy-operator) ([v0.11.0-rc](https://github.com/aquasecurity/trivy-operator/releases/tag/v0.11.0-rc), 1 day ago) - Kubernetes-native security toolkit
...
- [pulumiverse/pulumi-aquasec](https://github.com/pulumiverse/pulumi-aquasec) ([v0.8.20](https://github.com/pulumiverse/pulumi-aquasec/releases/tag/v0.8.20), 1 day ago) - Pulumi provider for Aquasec
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([8.4.0](https://github.com/simple-icons/simple-icons/releases/tag/8.4.0), 1 day ago) - SVG icons for popular brands

#### ⭐ Latest repositories I starred

- [tinystacks/precloud](https://github.com/tinystacks/precloud) - An open source command line interface that runs checks on infrastructure as code to catch potential deployment issues before deploying. - 296 stars
...
- [aws-quickstart/cdk-eks-blueprints](https://github.com/aws-quickstart/cdk-eks-blueprints) - AWS Quick Start Team - 251 stars
...
- [ritz078/transform](https://github.com/ritz078/transform) - A polyglot web converter. - 4566 stars
