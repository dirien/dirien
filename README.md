...
- [Rust Development: Creating a REST API with Actix Web for Beginners](https://blog.ediri.io/rust-development-creating-a-rest-api-with-actix-web-for-beginners) (4 days ago)
...
- [dirien/parlez-vous-pulumi](https://github.com/dirien/parlez-vous-pulumi) - Creating an EKS cluster with Pulumi in different programming languages (1 day ago)
...
- [dirien/pulumi-github](https://github.com/dirien/pulumi-github) ([v0.2.21](https://github.com/dirien/pulumi-github/releases/tag/v0.2.21), 1 day ago) - Pulumi program to manage my GitHub repositories
- [aquasecurity/helm-charts](https://github.com/aquasecurity/helm-charts) ([trivy-operator-0.12.1](https://github.com/aquasecurity/helm-charts/releases/tag/trivy-operator-0.12.1), 2 days ago) - Aqua Open Source Helm Chart Repository
- [aquasecurity/trivy-operator](https://github.com/aquasecurity/trivy-operator) ([v0.12.1](https://github.com/aquasecurity/trivy-operator/releases/tag/v0.12.1), 2 days ago) - Kubernetes-native security toolkit
- [libdns/scaleway](https://github.com/libdns/scaleway) ([v0.1.6](https://github.com/libdns/scaleway/releases/tag/v0.1.6), 2 days ago) - Scaleway DNS implementation for libdns
- [pulumiverse/pulumi-purrl](https://github.com/pulumiverse/pulumi-purrl) ([v0.3.1](https://github.com/pulumiverse/pulumi-purrl/releases/tag/v0.3.1), 2 days ago) - A Pulumi native provider for making API calls

#### ⭐ Latest repositories I starred

- [bevyengine/bevy](https://github.com/bevyengine/bevy) - A refreshingly simple data-driven game engine built in Rust - 22620 stars
- [thinkinglabs/aws-iam-policy](https://github.com/thinkinglabs/aws-iam-policy) - A TypeScript Node.js module to manipulate AWS IAM Policy documents - 10 stars
- [andrewbaxter/terrars](https://github.com/andrewbaxter/terrars) - Terraform in Rust - 33 stars
...
- [tokio-rs/tracing](https://github.com/tokio-rs/tracing) - Application level tracing for Rust. - 3628 stars
- [one2nc/cloudlens](https://github.com/one2nc/cloudlens) - k9s like CLI for AWS - 209 stars
...
- [kluctl/kluctl](https://github.com/kluctl/kluctl) - The missing glue to put together large Kubernetes deployments, composed of multiple smaller parts (Helm/Kustomize/...)  in a manageable and unified way. - 229 stars
