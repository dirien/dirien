...
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.12](https://github.com/loft-sh/devpod/releases/tag/v0.5.12), 3 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
...
- [pulumi/actions](https://github.com/pulumi/actions) ([v5.2.4](https://github.com/pulumi/actions/releases/tag/v5.2.4), 3 days ago) - Deploy continuously to your cloud of choice, using your favorite language, Pulumi, and GitHub!
- [kubescape/kubescape](https://github.com/kubescape/kubescape) ([v3.0.11](https://github.com/kubescape/kubescape/releases/tag/v3.0.11), 4 days ago) - Kubescape is an open-source Kubernetes security platform for your IDE, CI/CD pipelines, and clusters. It includes risk analysis, security, compliance, and misconfiguration scanning, saving Kubernetes users and administrators precious time, effort, and resources.

#### ⭐ Latest repositories I starred

- [robusta-dev/holmesgpt](https://github.com/robusta-dev/holmesgpt) - The Open Source DevOps Assistant - solve problems twice as fast with an AI teammate - 41 stars
- [explodinggradients/ragas](https://github.com/explodinggradients/ragas) - Evaluation framework for your Retrieval Augmented Generation (RAG) pipelines - 5178 stars
- [containers/bootc](https://github.com/containers/bootc) - Boot and upgrade via container images - 425 stars
- [kubecolor/kubecolor](https://github.com/kubecolor/kubecolor) - Colorize your kubectl output - 423 stars
...
- [AxaFrance/SlimFaas](https://github.com/AxaFrance/SlimFaas) - SlimFaas : The slimest and simplest Function As A Service - 129 stars
- [clusterpedia-io/clusterpedia](https://github.com/clusterpedia-io/clusterpedia) - The Encyclopedia of Kubernetes clusters - 768 stars
- [octodns/octodns](https://github.com/octodns/octodns) - Tools for managing DNS across multiple providers - 3001 stars
- [sigoden/aichat](https://github.com/sigoden/aichat) - All-in-one AI-Powered CLI Chat &amp; Copilot that integrates 20&#43; AI platforms, including OpenAI, Azure-OpenAI, Gemini, Claude, Mistral, Cohere, VertexAI, Bedrock, Ollama, Ernie, Qianwen, Deepseek... - 3040 stars
