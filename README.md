...
- [Rust Development: Creating a REST API with Actix Web for Beginners](https://blog.ediri.io/rust-development-creating-a-rest-api-with-actix-web-for-beginners) (2 days ago)
- [Boost Your Rust 🦀 Development with Hot Reload using cargo-watch](https://blog.ediri.io/boost-your-rust-development-with-hot-reload-using-cargo-watch) (5 days ago)
- [Building the Port Pulumi Connector PoC: A Step-by-Step Guide](https://blog.ediri.io/building-the-port-pulumi-connector-poc-a-step-by-step-guide) (6 days ago)
...
- [dirien/pulumi-port-labs](https://github.com/dirien/pulumi-port-labs) - Pulumi provider for Port Labs (5 days ago)
...
- [dirien/pulumi-connector](https://github.com/dirien/pulumi-connector) - Pulumi connector for Port (6 days ago)
...
- [aquasecurity/helm-charts](https://github.com/aquasecurity/helm-charts) ([trivy-operator-0.12.1-rc](https://github.com/aquasecurity/helm-charts/releases/tag/trivy-operator-0.12.1-rc), 1 day ago) - Aqua Open Source Helm Chart Repository
- [aquasecurity/trivy-operator](https://github.com/aquasecurity/trivy-operator) ([v0.12.1-rc](https://github.com/aquasecurity/trivy-operator/releases/tag/v0.12.1-rc), 1 day ago) - Kubernetes-native security toolkit
...
- [pulumi/pulumi-kubernetes-operator](https://github.com/pulumi/pulumi-kubernetes-operator) ([v1.11.2](https://github.com/pulumi/pulumi-kubernetes-operator/releases/tag/v1.11.2), 3 days ago) - A Kubernetes Operator that automates the deployment of Pulumi Stacks
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1138.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1138.0), 4 days ago) - IDE-style autocomplete for your existing terminal &amp; shell
...
- [tokio-rs/tracing](https://github.com/tokio-rs/tracing) - Application level tracing for Rust. - 3618 stars
- [one2nc/cloudlens](https://github.com/one2nc/cloudlens) - k9s like CLI for AWS - 189 stars
- [helm/helm-mapkubeapis](https://github.com/helm/helm-mapkubeapis) - This is a Helm plugin which map deprecated or removed Kubernetes APIs in a release to supported APIs - 401 stars
...
- [GoogleCloudPlatform/microservices-demo](https://github.com/GoogleCloudPlatform/microservices-demo) - Sample cloud-first application with 10 microservices showcasing Kubernetes, Istio, and gRPC. - 13821 stars
- [mrsked/mrsk](https://github.com/mrsked/mrsk) - Deploy web apps anywhere. - 3459 stars
