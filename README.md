...
- [SchwarzIT/node-red-chart](https://github.com/SchwarzIT/node-red-chart) ([node-red-0.9.0](https://github.com/SchwarzIT/node-red-chart/releases/tag/node-red-0.9.0), 1 day ago) - Node-red Helm Chart
...
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([6.13.0](https://github.com/simple-icons/simple-icons/releases/tag/6.13.0), 2 days ago) - SVG icons for popular brands
...
- [fatih/semgroup](https://github.com/fatih/semgroup) - Like errgroup/waitgroup, but only runs a maximum of tasks at any time. - 161 stars
- [rust-lang/rustlings](https://github.com/rust-lang/rustlings) - :crab: Small exercises to get you used to reading and writing Rust code! - 22619 stars
- [kedacore/http-add-on](https://github.com/kedacore/http-add-on) - Add-on for KEDA to scale HTTP workloads - 95 stars
- [kyma-incubator/terraform-provider-kind](https://github.com/kyma-incubator/terraform-provider-kind) - Terraform Provider for kind (Kubernetes IN Docker) - 73 stars
- [firecracker-microvm/firecracker](https://github.com/firecracker-microvm/firecracker) - Secure and fast microVMs for serverless computing. - 17518 stars
- [prometheus-msteams/prometheus-msteams](https://github.com/prometheus-msteams/prometheus-msteams) - Forward Prometheus Alert Manager notifications to Microsoft Teams. - 381 stars
