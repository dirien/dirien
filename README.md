...
- [dirien/getting-started-with-devops-ai-skills](https://github.com/dirien/getting-started-with-devops-ai-skills) - Getting Started with DevOps AI Skills — a Pulumi workshop: build, share, and run Agent Skills with Microsoft APM. Slides, chapters, skills, LSP&#43;hooks, and a Claude/Codex/Pulumi devcontainer. (3 days ago)
- [dirien/fable-countdown](https://github.com/dirien/fable-countdown) - Split-flap departure board counting down the days until Fable 5 leaves Claude subscription plans (4 days ago)
- [dirien/fully-automated-ai-inference-pulumi](https://github.com/dirien/fully-automated-ai-inference-pulumi) - Zero-touch GPU inference server (Ollama) on AWS, Azure, and Google Cloud with Pulumi. Companion code for the Pulumi blog post. (5 days ago)
...
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.35.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.35.0), 4 days ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.22.0](https://github.com/port-labs/pulumi-port/releases/tag/v2.22.0), 5 days ago) - Pulumi Port provider
- [pulumi-labs/pulumi-exporter](https://github.com/pulumi-labs/pulumi-exporter) ([v0.1.3](https://github.com/pulumi-labs/pulumi-exporter/releases/tag/v0.1.3), 6 days ago) - OpenTelemetry Pulumi Cloud metrics exporter
...
- [Project-HAMi/HAMi](https://github.com/Project-HAMi/HAMi) - Heterogeneous GPU Sharing on Kubernetes - 3674 stars
- [Gitlawb/zero](https://github.com/Gitlawb/zero) - The coding agent that answers to you, your model, your machine, your rules. - 846 stars
- [better-auth/better-auth](https://github.com/better-auth/better-auth) - The most comprehensive authentication framework - 28945 stars
- [huggingface/tau](https://github.com/huggingface/tau) - a minimalist agent that teaches you to create coding agents - 526 stars
...
- [cobusgreyling/loop-engineering](https://github.com/cobusgreyling/loop-engineering) - Practical patterns, starters &amp; CLI tools for loop engineering with AI coding agents. Design systems that prompt and orchestrate agents (inspired by Addy Osmani and Boris Cherny). Includes loop-audit, loop-init, loop-cost. - 5659 stars
...
- [visa/visa-vulnerability-agentic-harness](https://github.com/visa/visa-vulnerability-agentic-harness) - Visa Vulnerability Agentic Harness - 636 stars
