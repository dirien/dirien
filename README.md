...
- [scraly/pulumi-ovh](https://github.com/scraly/pulumi-ovh) - Pulumi provider for OVHcloud (3 days ago)
...
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) -  (1 week ago)

#### 🚀 Latest releases I contributed to

- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.9.27](https://github.com/alexellis/arkade/releases/tag/0.9.27), 1 day ago) - Open Source Marketplace For Developer Tools
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-k8s-exporter-0.1.20](https://github.com/port-labs/helm-charts/releases/tag/port-k8s-exporter-0.1.20), 1 day ago)
...
- [kubewharf/kelemetry](https://github.com/kubewharf/kelemetry) - Global control plane tracing for Kubernetes - 182 stars
