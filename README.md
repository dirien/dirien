...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.3](https://github.com/alexellis/arkade/releases/tag/0.11.3), 1 day ago) - Open Source Marketplace For Developer Tools
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.30.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.30.0), 2 days ago) - Azure Native Provider
...
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-k8s-exporter-0.2.19](https://github.com/port-labs/helm-charts/releases/tag/port-k8s-exporter-0.2.19), 3 days ago)

#### ⭐ Latest repositories I starred

- [Mintplex-Labs/anything-llm](https://github.com/Mintplex-Labs/anything-llm) - A multi-user ChatGPT for any LLMs and vector database. Unlimited documents, messages, and storage in one privacy-focused app. Now available as a desktop application! - 8339 stars
- [QuivrHQ/quivr](https://github.com/QuivrHQ/quivr) - Your GenAI Second Brain 🧠  A personal productivity assistant (RAG) ⚡️🤖 Chat with your docs (PDF, CSV, ...)  &amp; apps using Langchain, GPT 3.5 / 4 turbo, Private, Anthropic, VertexAI, Ollama, LLMs, that you can share with users !  Local &amp; Private alternative to OpenAI GPTs &amp; ChatGPT powered by retrieval-augmented generation. - 28453 stars
- [dockur/windows](https://github.com/dockur/windows) - Windows in a Docker container. - 743 stars
...
- [vllm-project/vllm](https://github.com/vllm-project/vllm) - A high-throughput and memory-efficient inference and serving engine for LLMs - 15117 stars
- [basemind-ai/gateway](https://github.com/basemind-ai/gateway) - The BaseMind.AI monorepo - 18 stars
- [facebook/dotslash](https://github.com/facebook/dotslash) - Simplified executable deployment - 432 stars
- [nuke-build/nuke](https://github.com/nuke-build/nuke) - 🏗 The AKEless Build System for C#/.NET - 2296 stars
- [gptscript-ai/gptscript](https://github.com/gptscript-ai/gptscript) - Develop LLM Apps in Natural Language - 1267 stars
- [LlamaEdge/LlamaEdge](https://github.com/LlamaEdge/LlamaEdge) - The easiest &amp; fastest way to run customized and fine-tuned LLMs locally or on the edge - 375 stars
