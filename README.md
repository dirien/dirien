...
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.43.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.43.0), 1 day ago) - Azure Native Provider
...
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.12](https://github.com/loft-sh/devpod/releases/tag/v0.5.12), 4 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
- [pulumi/actions](https://github.com/pulumi/actions) ([v5.2.4](https://github.com/pulumi/actions/releases/tag/v5.2.4), 4 days ago) - Deploy continuously to your cloud of choice, using your favorite language, Pulumi, and GitHub!

#### ⭐ Latest repositories I starred

- [robusta-dev/holmesgpt](https://github.com/robusta-dev/holmesgpt) - The Open Source DevOps Assistant - solve problems twice as fast with an AI teammate - 88 stars
- [explodinggradients/ragas](https://github.com/explodinggradients/ragas) - Evaluation framework for your Retrieval Augmented Generation (RAG) pipelines - 5188 stars
- [containers/bootc](https://github.com/containers/bootc) - Boot and upgrade via container images - 430 stars
...
- [sigoden/aichat](https://github.com/sigoden/aichat) - All-in-one AI-Powered CLI Chat &amp; Copilot that integrates 20&#43; AI platforms, including OpenAI, Azure-OpenAI, Gemini, Claude, Mistral, Cohere, VertexAI, Bedrock, Ollama, Ernie, Qianwen, Deepseek... - 3045 stars
