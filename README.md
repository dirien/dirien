...
- [dirien/pulumi-minecraft](https://github.com/dirien/pulumi-minecraft) - Pulumi component (Go): a Java Minecraft server on DigitalOcean (5 days ago)
- [dirien/hermes-agent-pulumi](https://github.com/dirien/hermes-agent-pulumi) - Deploy a private Hermes agent as one Pulumi program across Render, Modal, and Tailscale. Companion to the Pulumi blog post. (1 week ago)
...
- [pulumi-labs/pulumi-exporter](https://github.com/pulumi-labs/pulumi-exporter) ([v0.1.3](https://github.com/pulumi-labs/pulumi-exporter/releases/tag/v0.1.3), 1 day ago) - OpenTelemetry Pulumi Cloud metrics exporter
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.65](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.65), 6 days ago) - MCP DigitalOcean Integration
...
- [visa/visa-vulnerability-agentic-harness](https://github.com/visa/visa-vulnerability-agentic-harness) - Visa Vulnerability Agentic Harness - 581 stars
...
- [CopilotKit/OpenTag](https://github.com/CopilotKit/OpenTag) - OpenTag - 402 stars
- [EpicGames/lore](https://github.com/EpicGames/lore) - Lore is a next-generation, open source version control system - 7327 stars
