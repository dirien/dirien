...
- [pulumiverse/pulumi-scaleway](https://github.com/pulumiverse/pulumi-scaleway) ([v1.19.0](https://github.com/pulumiverse/pulumi-scaleway/releases/tag/v1.19.0), 1 day ago) - Pulumi provider for Scaleway
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.15.0](https://github.com/simple-icons/simple-icons/releases/tag/13.15.0), 5 days ago) - SVG icons for popular brands
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.29](https://github.com/alexellis/arkade/releases/tag/0.11.29), 6 days ago) - Open Source Marketplace For Developer Tools
...
- [kolbytn/mindcraft](https://github.com/kolbytn/mindcraft) -  - 1722 stars
- [mc-bench/orchestrator](https://github.com/mc-bench/orchestrator) - Orchestrator to spin up MC server, run Mindcraft agent, save building and run eval - 128 stars
...
- [knadh/koanf](https://github.com/knadh/koanf) - Simple, extremely lightweight, extensible, configuration management library for Go. Support for JSON, TOML, YAML, env, command line, file, S3 etc. Alternative to viper. - 2768 stars
