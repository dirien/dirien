...
- [dirien/pulumi-civo-redis-flux](https://github.com/dirien/pulumi-civo-redis-flux) - Playing around with Pulumi, Civo and Redis with Flux (2 days ago)
- [helm/chartmuseum](https://github.com/helm/chartmuseum) - Host your own Helm Chart Repository (2 days ago)
...
- [SchwarzIT/node-red-chart](https://github.com/SchwarzIT/node-red-chart) ([node-red-0.11.0](https://github.com/SchwarzIT/node-red-chart/releases/tag/node-red-0.11.0), 1 day ago) - Node-red Helm Chart
...
- [argoproj-labs/argocd-autopilot](https://github.com/argoproj-labs/argocd-autopilot) ([v0.3.0](https://github.com/argoproj-labs/argocd-autopilot/releases/tag/v0.3.0), 3 days ago) - Argo-CD Autopilot
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([6.14.0](https://github.com/simple-icons/simple-icons/releases/tag/6.14.0), 4 days ago) - SVG icons for popular brands
...
- [estafette/estafette-vulnerability-scanner](https://github.com/estafette/estafette-vulnerability-scanner) - An application that regularly scans all containers in a Kubernetes cluster for vulnerabilities - 38 stars
- [comtrya/comtrya](https://github.com/comtrya/comtrya) - Configuration Management for Localhost / dotfiles - 152 stars
- [lightrun-platform/koolkits](https://github.com/lightrun-platform/koolkits) - 🧰 Opinionated, language-specific, batteries-included debug container images for Kubernetes. - 75 stars
- [gofish-bot/gofish-bot](https://github.com/gofish-bot/gofish-bot) -  - 7 stars
- [rancher/system-upgrade-controller](https://github.com/rancher/system-upgrade-controller) - In your Kubernetes, upgrading your nodes - 321 stars
- [cloud-native-skunkworks/ubuntu-operator](https://github.com/cloud-native-skunkworks/ubuntu-operator) - Control Ubuntu from Kubernetes. - 10 stars
