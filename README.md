...
- [pulumiverse/pulumi-scaleway](https://github.com/pulumiverse/pulumi-scaleway) ([v1.17.0](https://github.com/pulumiverse/pulumi-scaleway/releases/tag/v1.17.0), 1 day ago) - Pulumi provider for Scaleway
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.15.0](https://github.com/simple-icons/simple-icons/releases/tag/13.15.0), 3 days ago) - SVG icons for popular brands
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.29](https://github.com/alexellis/arkade/releases/tag/0.11.29), 4 days ago) - Open Source Marketplace For Developer Tools
...
- [kolbytn/mindcraft](https://github.com/kolbytn/mindcraft) -  - 1649 stars
- [mc-bench/orchestrator](https://github.com/mc-bench/orchestrator) - Orchestrator to spin up MC server, run Mindcraft agent, save building and run eval - 123 stars
- [AvitalTamir/cyphernetes](https://github.com/AvitalTamir/cyphernetes) - A Kubernetes Query Language - 494 stars
...
- [schednex-ai/schednex](https://github.com/schednex-ai/schednex) - Smart Kubernetes Scheduling - 61 stars
...
- [mbarinov/repogpt](https://github.com/mbarinov/repogpt) - RepoGPT: AI-powered GitHub assistant to chat, manage, and explore your repos effortlessly. - 44 stars
- [antfu-collective/taze](https://github.com/antfu-collective/taze) - 🥦 A modern cli tool that keeps your deps fresh - 2823 stars
- [kubewall/kubewall](https://github.com/kubewall/kubewall) - A single binary kubernetes dashboard to manage your multiple clusters. - 596 stars
- [knadh/koanf](https://github.com/knadh/koanf) - Simple, extremely lightweight, extensible, configuration management library for Go. Support for JSON, TOML, YAML, env, command line, file, S3 etc. Alternative to viper. - 2761 stars
