...
- [Rust Development with Testcontainers](https://blog.ediri.io/rust-development-with-testcontainers) (3 weeks ago)
...
- [Bulletproof Your Project: Automate NPM Package Security Fixes with Recurring CI Tasks!](https://blog.ediri.io/bulletproof-your-project-automate-npm-package-security-fixes-with-recurring-ci-tasks) (3 months ago)
- [Learn Rust with ChatGPT](https://blog.ediri.io/learn-rust-with-chatgpt) (3 months ago)

#### 👷 I'm currently working on

- [dirien/berlin-pug-26-07](https://github.com/dirien/berlin-pug-26-07) - Demo code for the Berlin PUG (1 day ago)
...
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.3.3](https://github.com/loft-sh/devpod/releases/tag/v0.3.3), 1 day ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
- [aquasecurity/trivy-operator](https://github.com/aquasecurity/trivy-operator) ([v0.15.1](https://github.com/aquasecurity/trivy-operator/releases/tag/v0.15.1), 1 day ago) - Kubernetes-native security toolkit
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1191.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1191.0), 2 days ago) - IDE-style autocomplete for your existing terminal &amp; shell
- [go-acme/lego](https://github.com/go-acme/lego) ([v4.13.3](https://github.com/go-acme/lego/releases/tag/v4.13.3), 2 days ago) - Let&#39;s Encrypt/ACME client and library written in Go
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.9.25](https://github.com/alexellis/arkade/releases/tag/0.9.25), 2 days ago) - Open Source Marketplace For Developer Tools
...
- [devstream-io/devstream](https://github.com/devstream-io/devstream) - DevStream: the open-source DevOps toolchain manager (DTM). - 798 stars
...
- [enix/kube-image-keeper](https://github.com/enix/kube-image-keeper) - kuik is a container image caching system for Kubernetes - 224 stars
- [zellij-org/zellij](https://github.com/zellij-org/zellij) - A terminal workspace with batteries included - 13068 stars
