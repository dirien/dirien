...
- [pulumi/pulumi-terraform-bridge](https://github.com/pulumi/pulumi-terraform-bridge) ([v3.119.0](https://github.com/pulumi/pulumi-terraform-bridge/releases/tag/v3.119.0), 3 days ago) - A library allowing Terraform providers to be bridged into Pulumi.
...
- [dirien/minectl-sdk](https://github.com/dirien/minectl-sdk) ([v0.20.0](https://github.com/dirien/minectl-sdk/releases/tag/v0.20.0), 1 week ago) - SDK for every minectl product
...
- [anthropics/claude-code](https://github.com/anthropics/claude-code) - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows - all through natural language commands. - 50327 stars
- [strands-agents/agent-sop](https://github.com/strands-agents/agent-sop) - Natural language workflows that enable AI agents to perform complex, multi-step tasks with consistency and reliability. - 595 stars
- [sinelaw/fresh](https://github.com/sinelaw/fresh) - Text editor for your terminal: easy, powerful and fast - 4515 stars
- [jesseduffield/lazygit](https://github.com/jesseduffield/lazygit) - simple terminal UI for git commands - 70014 stars
