...
- [argoproj/argo-helm](https://github.com/argoproj/argo-helm) ([argo-workflows-0.39.5](https://github.com/argoproj/argo-helm/releases/tag/argo-workflows-0.39.5), 1 day ago) - ArgoProj Helm Charts
- [pulumiverse/pulumi-exoscale](https://github.com/pulumiverse/pulumi-exoscale) ([v0.54.0](https://github.com/pulumiverse/pulumi-exoscale/releases/tag/v0.54.0), 1 day ago) - Pulumi provider for Exoscale
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.10.16](https://github.com/alexellis/arkade/releases/tag/0.10.16), 1 day ago) - Open Source Marketplace For Developer Tools
- [pulumi/pulumi-backstage-plugin](https://github.com/pulumi/pulumi-backstage-plugin) ([v0.3.0](https://github.com/pulumi/pulumi-backstage-plugin/releases/tag/v0.3.0), 2 days ago) - Pulumi plugin for Backstage
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-agent-0.6.2](https://github.com/port-labs/helm-charts/releases/tag/port-agent-0.6.2), 2 days ago)

#### ⭐ Latest repositories I starred

- [istio-ecosystem/admiral](https://github.com/istio-ecosystem/admiral) - Admiral provides automatic configuration generation, syncing and service discovery for multicluster Istio service mesh - 540 stars
...
- [kubeshop/tracetest](https://github.com/kubeshop/tracetest) - 🔭 Tracetest - Build integration and end-to-end tests in minutes, instead of days, using OpenTelemetry and trace-based testing. - 753 stars
- [charmbracelet/gum](https://github.com/charmbracelet/gum) - A tool for glamorous shell scripts 🎀 - 15303 stars
- [distribworks/dkron](https://github.com/distribworks/dkron) - Dkron - Distributed, fault tolerant job scheduling system https://dkron.io - 3948 stars
...
- [isotope-rs/isotope](https://github.com/isotope-rs/isotope) - AWS superpowers with the power of bedrock and speed of rust - 48 stars
- [zakkg3/ClusterSecret](https://github.com/zakkg3/ClusterSecret) - Kubernetes ClusterSecret operator. - 313 stars
- [Melkeydev/go-blueprint](https://github.com/Melkeydev/go-blueprint) - Go-blueprint allows users to spin up a quick Go project using a popular framework - 886 stars
- [kubeflow/kubeflow](https://github.com/kubeflow/kubeflow) - Machine Learning Toolkit for Kubernetes - 13180 stars
