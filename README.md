...
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.25.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.25.0), 3 days ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.43](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.43), 5 days ago) - MCP DigitalOcean Integration
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.21.7](https://github.com/port-labs/pulumi-port/releases/tag/v2.21.7), 5 days ago) - Pulumi Port provider
...
- [microsoft/apm](https://github.com/microsoft/apm) - Agent Package Manager - 1153 stars
- [griffinmartin/opencode-claude-auth](https://github.com/griffinmartin/opencode-claude-auth) - OpenCode plugin that uses your existing Claude Code credentials — no separate login needed.  - 799 stars
...
- [kagenti/kagenti](https://github.com/kagenti/kagenti) - Main Kagenti repo - installer, UI and docs - 179 stars
- [agentregistry-dev/agentregistry](https://github.com/agentregistry-dev/agentregistry) - Fast-track AI innovation with a centralized, trusted, curated registry - 257 stars
...
- [envoyproxy/ai-gateway](https://github.com/envoyproxy/ai-gateway) - Manages Unified Access to Generative AI Services built on Envoy Gateway - 1504 stars
- [ultraworkers/claw-code](https://github.com/ultraworkers/claw-code) - The repo is finally unlocked. enjoy the party! The fastest repo in history to surpass 100K stars ⭐. Join Discord: https://discord.gg/5TUQKqFWd Built in Rust using oh-my-codex. - 183406 stars
- [alibaba/OpenSandbox](https://github.com/alibaba/OpenSandbox) - Secure, Fast, and Extensible Sandbox runtime for AI agents. - 9971 stars
