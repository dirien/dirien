...
- [dexidp/dex](https://github.com/dexidp/dex) ([v2.32.0](https://github.com/dexidp/dex/releases/tag/v2.32.0), 1 day ago) - OpenID Connect (OIDC) identity and OAuth 2.0 provider with pluggable connectors
...
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.762.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.762.0), 2 days ago) - Fig adds autocomplete to your terminal.
- [sigstore/cosign](https://github.com/sigstore/cosign) ([v1.9.0](https://github.com/sigstore/cosign/releases/tag/v1.9.0), 5 days ago) - Container Signing
- [dirien/tfu](https://github.com/dirien/tfu) ([v0.4.2](https://github.com/dirien/tfu/releases/tag/v0.4.2), 6 days ago) - tfu is a terraform helper to update the providers.
...
- [chainguard-dev/ssc-reading-list](https://github.com/chainguard-dev/ssc-reading-list) - A reading list for software supply-chain security. - 194 stars
...
- [gimlet-io/gimlet](https://github.com/gimlet-io/gimlet) - Build and run a developer platform on Kubernetes - 54 stars
- [digitalocean/kubecon-2022-doks-workshop](https://github.com/digitalocean/kubecon-2022-doks-workshop) -  - 38 stars
- [cosmtrek/air](https://github.com/cosmtrek/air) - ☁️ Live reload for Go apps - 7080 stars
