...
- [kebap-stack/reference-implementation](https://github.com/kebap-stack/reference-implementation) -  (1 week ago)
...
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.5.2](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.5.2), 3 days ago)
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.18](https://github.com/alexellis/arkade/releases/tag/0.11.18), 3 days ago) - Open Source Marketplace For Developer Tools
...
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.18](https://github.com/loft-sh/devpod/releases/tag/v0.5.18), 5 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.0.12](https://github.com/port-labs/pulumi-port/releases/tag/v2.0.12), 5 days ago) - Pulumi Port provider

#### ⭐ Latest repositories I starred

- [kurtosis-tech/kardinal](https://github.com/kurtosis-tech/kardinal) - Kardinal is the lightest-weight way to spin up dev and test environments in Kubernetes. Deploy the absolute minimum resources necessary and implement dev, test, and QA all in one cluster. - 34 stars
- [mingrammer/diagrams](https://github.com/mingrammer/diagrams) - :art: Diagram as Code for prototyping cloud system architectures - 35709 stars
- [gofr-dev/gofr](https://github.com/gofr-dev/gofr) - An opinionated GoLang framework for accelerated microservice development. Built in support for databases and observability. - 1372 stars
...
- [vintagewang](https://github.com/vintagewang) - Xiaorui Wang
