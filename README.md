...
- [argoproj/argo-helm](https://github.com/argoproj/argo-helm) ([argo-workflows-0.39.8](https://github.com/argoproj/argo-helm/releases/tag/argo-workflows-0.39.8), 1 day ago) - ArgoProj Helm Charts
- [pulumi/pulumi](https://github.com/pulumi/pulumi) ([v3.96.2](https://github.com/pulumi/pulumi/releases/tag/v3.96.2), 1 day ago) - Pulumi - Infrastructure as Code in any programming language. Build infrastructure intuitively on any cloud using familiar languages 🚀
- [SchwarzIT/node-red-chart](https://github.com/SchwarzIT/node-red-chart) ([node-red-0.28.1](https://github.com/SchwarzIT/node-red-chart/releases/tag/node-red-0.28.1), 1 day ago) - Node-red Helm Chart
- [dirien/pulumi-scaleway](https://github.com/dirien/pulumi-scaleway) ([v2.34.0](https://github.com/dirien/pulumi-scaleway/releases/tag/v2.34.0), 1 day ago) - Pulumi provider for Scaleway
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.1.10](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.1.10), 2 days ago)

#### ⭐ Latest repositories I starred

- [fullstorydev/grpcui](https://github.com/fullstorydev/grpcui) - An interactive web UI for gRPC, along the lines of postman - 4604 stars
- [autometrics-dev/autometrics-rs](https://github.com/autometrics-dev/autometrics-rs) - Easily add metrics to your code that actually help you spot and debug issues in production. Built on Prometheus and OpenTelemetry. - 741 stars
...
- [avsthiago/kopylot](https://github.com/avsthiago/kopylot) - An AI-Powered assistant for Kubernetes developers - 88 stars
...
- [charmbracelet/gum](https://github.com/charmbracelet/gum) - A tool for glamorous shell scripts 🎀 - 15375 stars

#### 👥 Latest follower

- [OthmaneGhandi](https://github.com/OthmaneGhandi) - Othmane GHANDI
- [arferreira](https://github.com/arferreira) - Antonio Souza
