...
- [kubescape/kubescape](https://github.com/kubescape/kubescape) ([v3.0.12](https://github.com/kubescape/kubescape/releases/tag/v3.0.12), 1 day ago) - Kubescape is an open-source Kubernetes security platform for your IDE, CI/CD pipelines, and clusters. It includes risk analysis, security, compliance, and misconfiguration scanning, saving Kubernetes users and administrators precious time, effort, and resources.
...
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.0.0](https://github.com/simple-icons/simple-icons/releases/tag/13.0.0), 4 days ago) - SVG icons for popular brands
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.0.10](https://github.com/port-labs/pulumi-port/releases/tag/v2.0.10), 5 days ago) - Pulumi Port provider
...
- [nginxinc/nginx-gateway-fabric](https://github.com/nginxinc/nginx-gateway-fabric) - NGINX Gateway Fabric provides an implementation for the Gateway API using NGINX as the data plane. - 414 stars
