...
- [Rust Development: Creating a REST API with Actix Web for Beginners](https://blog.ediri.io/rust-development-creating-a-rest-api-with-actix-web-for-beginners) (5 days ago)
...
- [dirien/parlez-vous-pulumi](https://github.com/dirien/parlez-vous-pulumi) - Creating an EKS cluster with Pulumi in different programming languages (2 days ago)

#### 🚀 Latest releases I contributed to

- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([8.7.0](https://github.com/simple-icons/simple-icons/releases/tag/8.7.0), 1 day ago) - SVG icons for popular brands
- [dirien/pulumi-github](https://github.com/dirien/pulumi-github) ([v0.2.21](https://github.com/dirien/pulumi-github/releases/tag/v0.2.21), 2 days ago) - Pulumi program to manage my GitHub repositories
- [aquasecurity/helm-charts](https://github.com/aquasecurity/helm-charts) ([trivy-operator-0.12.1](https://github.com/aquasecurity/helm-charts/releases/tag/trivy-operator-0.12.1), 3 days ago) - Aqua Open Source Helm Chart Repository
- [aquasecurity/trivy-operator](https://github.com/aquasecurity/trivy-operator) ([v0.12.1](https://github.com/aquasecurity/trivy-operator/releases/tag/v0.12.1), 3 days ago) - Kubernetes-native security toolkit
- [libdns/scaleway](https://github.com/libdns/scaleway) ([v0.1.6](https://github.com/libdns/scaleway/releases/tag/v0.1.6), 3 days ago) - Scaleway DNS implementation for libdns

#### ⭐ Latest repositories I starred

- [bevyengine/bevy](https://github.com/bevyengine/bevy) - A refreshingly simple data-driven game engine built in Rust - 22631 stars
...
- [andrewbaxter/terrars](https://github.com/andrewbaxter/terrars) - Terraform in Rust - 37 stars
...
- [tokio-rs/tracing](https://github.com/tokio-rs/tracing) - Application level tracing for Rust. - 3630 stars
- [one2nc/cloudlens](https://github.com/one2nc/cloudlens) - k9s like CLI for AWS - 211 stars
...
- [kubefirst/kubefirst](https://github.com/kubefirst/kubefirst) - The Kubefirst Open Source Platform - 460 stars
