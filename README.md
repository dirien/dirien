...
- [langchain-ai/langserve](https://github.com/langchain-ai/langserve) ([v0.2.0rc1](https://github.com/langchain-ai/langserve/releases/tag/v0.2.0rc1), 1 day ago) - LangServe 🦜️🏓
- [ovh/pulumi-ovh](https://github.com/ovh/pulumi-ovh) ([v0.44.0](https://github.com/ovh/pulumi-ovh/releases/tag/v0.44.0), 1 day ago) - Pulumi provider for OVHcloud
...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.12](https://github.com/alexellis/arkade/releases/tag/0.11.12), 2 days ago) - Open Source Marketplace For Developer Tools
...
- [sigoden/aichat](https://github.com/sigoden/aichat) - All-in-one AI-Powered CLI Chat &amp; Copilot that integrates 20&#43; AI platforms, including OpenAI, Azure-OpenAI, Gemini, Claude, Mistral, Cohere, VertexAI, Bedrock, Ollama, Ernie, Qianwen, Deepseek... - 2932 stars
- [jozu-ai/kitops](https://github.com/jozu-ai/kitops) - Tools for easing the handoff between AI/ML and App/SRE teams. - 190 stars
- [inkdrop-org/inkdrop-visualizer](https://github.com/inkdrop-org/inkdrop-visualizer) - Visualizes your Terraform - 375 stars
- [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo) - Test your prompts, models, and RAGs. Catch regressions and improve prompt quality. LLM evals for OpenAI, Azure, Anthropic, Gemini, Mistral, Llama, Bedrock, Ollama, and other local &amp; private models with CI/CD integration. - 2919 stars
- [dicebear/dicebear](https://github.com/dicebear/dicebear) - DiceBear is an avatar library for designers and developers. 🌍 - 6517 stars
...
- [yuemingming](https://github.com/yuemingming) - sakura
