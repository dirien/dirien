...
- [dirien/pulumi-azure-flux-weave-ui](https://github.com/dirien/pulumi-azure-flux-weave-ui) - Playing around with the Weave GitOps UI (2 days ago)
...
- [jaxxstorm/pulumi-examples](https://github.com/jaxxstorm/pulumi-examples) -  (5 days ago)

#### 🚀 Latest releases I contributed to

- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.722.1](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.722.1), 1 day ago) - Fig adds autocomplete to your terminal.
- [norwoodj/helm-docs](https://github.com/norwoodj/helm-docs) ([v1.10.0](https://github.com/norwoodj/helm-docs/releases/tag/v1.10.0), 1 day ago) - A tool for automatically generating markdown documentation for helm charts
- [argoproj-labs/argocd-autopilot](https://github.com/argoproj-labs/argocd-autopilot) ([v0.3.7](https://github.com/argoproj-labs/argocd-autopilot/releases/tag/v0.3.7), 2 days ago) - Argo-CD Autopilot
...
- [kyverno/kyverno](https://github.com/kyverno/kyverno) - Kubernetes Native Policy Management - 2352 stars
...
- [kubernetes/git-sync](https://github.com/kubernetes/git-sync) - A sidecar app which clones a git repo and keeps it in sync with the upstream. - 1409 stars
