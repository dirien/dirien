...
- [dirien/lazy-pulumi](https://github.com/dirien/lazy-pulumi) - A terminal UI (TUI) application for Pulumi Cloud (1 week ago)
- [dirien/pulumi-events](https://github.com/dirien/pulumi-events) - MCP server for managing events on Meetup.com via AI assistants (1 week ago)
- [pulumi/workshops](https://github.com/pulumi/workshops) - A definitive place to store all the Pulumi workshops (1 week ago)

#### 🚀 Latest releases I contributed to

- [goreleaser/goreleaser-azure-devops-extension](https://github.com/goreleaser/goreleaser-azure-devops-extension) ([v0.1.50](https://github.com/goreleaser/goreleaser-azure-devops-extension/releases/tag/v0.1.50), 1 day ago) - Azure DevOps Extension for GoReleaser
- [dirien/yet-another-agent-harness](https://github.com/dirien/yet-another-agent-harness) ([v0.3.0](https://github.com/dirien/yet-another-agent-harness/releases/tag/v0.3.0), 1 day ago) - A Go agent harness for Claude Code — runtime hooks, MCP server, session tracking, middleware chains, and full config generation in one binary
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.40](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.40), 3 days ago) - MCP DigitalOcean Integration
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.20.2](https://github.com/port-labs/pulumi-port/releases/tag/v2.20.2), 4 days ago) - Pulumi Port provider
- [dirien/lazy-pulumi](https://github.com/dirien/lazy-pulumi) ([v0.9.0](https://github.com/dirien/lazy-pulumi/releases/tag/v0.9.0), 1 week ago) - A terminal UI (TUI) application for Pulumi Cloud

#### ⭐ Latest repositories I starred

- [skillmatic-ai/awesome-agent-skills](https://github.com/skillmatic-ai/awesome-agent-skills) - The definitive resource for Agent Skills - modular capabilities revolutionizing AI agent architecture - 474 stars
- [heilcheng/awesome-agent-skills](https://github.com/heilcheng/awesome-agent-skills) - A curated list of skills, tools, tutorials, and capabilities for AI coding agents (Claude, Codex, Antigravity, Copilot, VS Code) - 3485 stars
- [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) - A curated list of awesome Claude Skills, resources, and tools for customizing Claude AI workflows - 49137 stars
- [VoltAgent/awesome-agent-skills](https://github.com/VoltAgent/awesome-agent-skills) - Claude Code Skills and 1000&#43; agent skills from official dev teams and the community, compatible with Codex, Antigravity, Gemini CLI, Cursor and others. - 13307 stars
- [RoundTable02/tutor-skills](https://github.com/RoundTable02/tutor-skills) - A Claude Code skill that turns PDFs, docs, and codebases into Obsidian study vaults - 550 stars
- [fullstackcrew-alpha/skill-devops-agent](https://github.com/fullstackcrew-alpha/skill-devops-agent) - OpenClaw Skill: One-click DevOps assistant — deploy, monitor, backup, diagnose with safety-first design - 1 stars
- [sickn33/antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills) - Installable GitHub library of 1,326&#43; agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and more. Includes installer CLI, bundles, workflows, and official/community skill collections. - 28487 stars
- [coder/mux](https://github.com/coder/mux) - A desktop app for isolated, parallel agentic development - 1473 stars
- [NVIDIA/aicr](https://github.com/NVIDIA/aicr) - Tooling for optimized, validated, and reproducible GPU-accelerated AI runtime in Kubernetes - 224 stars
- [generalaction/emdash](https://github.com/generalaction/emdash) - Emdash is the Open-Source Agentic Development Environment (🧡 YC W26). Run multiple coding agents in parallel. Use any provider. - 3311 stars

#### 👥 Latest follower

- [KostasSliazas](https://github.com/KostasSliazas) - Kostas
- [abdxdev](https://github.com/abdxdev) - Abdul Rahman
- [FilipSolich](https://github.com/FilipSolich) - Filip Solich
- [danielgruber99](https://github.com/danielgruber99) - Daniel Gruber
- [ambushhere](https://github.com/ambushhere) - 
