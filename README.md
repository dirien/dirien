...
- [dirien/what-is-ai-platform-engineering-and-why-should-you-care](https://github.com/dirien/what-is-ai-platform-engineering-and-why-should-you-care) - Demo code for What is AI Platform Engineering and Why Should You Care (2 days ago)
...
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.21.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.21.0), 1 day ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
- [pulumi/pulumi-kubernetes-operator](https://github.com/pulumi/pulumi-kubernetes-operator) ([v2.5.1](https://github.com/pulumi/pulumi-kubernetes-operator/releases/tag/v2.5.1), 1 day ago) - A Kubernetes Operator that automates the deployment of Pulumi Stacks
...
- [mvklingeren/sk8r](https://github.com/mvklingeren/sk8r) - A kubernetes-dashboard clone - 44 stars
- [volcano-sh/kthena](https://github.com/volcano-sh/kthena) - Kubernetes-native AI serving platform for scalable model serving. - 242 stars
- [snarktank/ralph](https://github.com/snarktank/ralph) - Ralph is an autonomous AI agent loop that runs repeatedly until all PRD items are complete.  - 12008 stars
- [Pavelevich/llm-checker](https://github.com/Pavelevich/llm-checker) - Advanced CLI tool that scans your hardware and tells you exactly which LLM or sLLM models you can run locally, with full Ollama integration. - 1272 stars
- [aquasecurity/trivy](https://github.com/aquasecurity/trivy) - Find vulnerabilities, misconfigurations, secrets, SBOM in containers, Kubernetes, code repositories, clouds and more - 847 stars
- [mudler/LocalAGI](https://github.com/mudler/LocalAGI) - LocalAGI is a powerful, self-hostable AI Agent platform designed for maximum privacy and flexibility. A complete drop-in replacement for OpenAI&#39;s Responses APIs with advanced agentic capabilities. No clouds.  Local AI that works on consumer-grade hardware (CPU and GPU). - 1630 stars
- [hadolint/hadolint](https://github.com/hadolint/hadolint) - Dockerfile linter, validate inline bash, written in Haskell - 11979 stars
- [AlexsJones/sympozium](https://github.com/AlexsJones/sympozium) - Run a fleet of AI agents on Kubernetes. Administer your cluster agentically - 146 stars
- [Priivacy-ai/spec-kitty](https://github.com/Priivacy-ai/spec-kitty) - Spec-Driven Development for serious software developers. Spec Coding with with Claude, Cursor, Gemini, Codex. Kanban dashboard, git worktrees, auto-merge and more. - 848 stars
- [proliferate-ai/proliferate](https://github.com/proliferate-ai/proliferate) - The open source background agent - 185 stars
