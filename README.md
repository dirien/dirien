...
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.46](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.46), 2 days ago) - MCP DigitalOcean Integration
- [dirien/yet-another-agent-harness](https://github.com/dirien/yet-another-agent-harness) ([v0.4.1](https://github.com/dirien/yet-another-agent-harness/releases/tag/v0.4.1), 3 days ago) - A Go agent harness for Claude Code — runtime hooks, MCP server, session tracking, middleware chains, and full config generation in one binary
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.26.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.26.0), 3 days ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
...
- [getagentseal/codeburn](https://github.com/getagentseal/codeburn) - See where your AI coding tokens go. Interactive TUI dashboard for Claude Code, Codex, and Cursor cost observability. - 2710 stars
- [rtk-ai/rtk](https://github.com/rtk-ai/rtk) - CLI proxy that reduces LLM token consumption by 60-90% on common dev commands. Single Rust binary, zero dependencies - 29198 stars
- [thesysdev/openui](https://github.com/thesysdev/openui) - The Open Standard for Generative UI - 3519 stars
- [AlexsJones/llama-panel](https://github.com/AlexsJones/llama-panel) - A MacOS llama-server command centre - 18 stars
- [erikzaadi/dnd-fam-ftw](https://github.com/erikzaadi/dnd-fam-ftw) - An AI driven Family D&amp;D Game - 6 stars
- [microsoft/apm](https://github.com/microsoft/apm) - Agent Package Manager - 1863 stars
- [griffinmartin/opencode-claude-auth](https://github.com/griffinmartin/opencode-claude-auth) - OpenCode plugin that uses your existing Claude Code credentials — no separate login needed.  - 879 stars
...
- [agentregistry-dev/agentregistry](https://github.com/agentregistry-dev/agentregistry) - Fast-track AI innovation with a centralized, trusted, curated registry - 266 stars
