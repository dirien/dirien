...
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1197.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1197.0), today) - IDE-style autocomplete for your existing terminal &amp; shell
- [dirien/minectl](https://github.com/dirien/minectl) ([v0.40.0](https://github.com/dirien/minectl/releases/tag/v0.40.0), 1 day ago) - minectl 🗺  is a cli for creating Minecraft server on different cloud provider.
- [dirien/minectl-sdk](https://github.com/dirien/minectl-sdk) ([v0.14.1](https://github.com/dirien/minectl-sdk/releases/tag/v0.14.1), 1 day ago) - SDK for every minectl product
- [libdns/scaleway](https://github.com/libdns/scaleway) ([v0.1.9](https://github.com/libdns/scaleway/releases/tag/v0.1.9), 1 day ago) - Scaleway DNS implementation for libdns
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.3.4-alpha.0](https://github.com/loft-sh/devpod/releases/tag/v0.3.4-alpha.0), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.

#### ⭐ Latest repositories I starred

- [kubestellar/kubeflex](https://github.com/kubestellar/kubeflex) - A flexible and scalable platform for running Kubernetes control plane APIs. - 11 stars
...
- [devcontainers/features](https://github.com/devcontainers/features) - A collection of Dev Container Features managed by Dev Container spec maintainers. See https://github.com/devcontainers/feature-starter to publish your own - 504 stars
...
- [zellij-org/zellij](https://github.com/zellij-org/zellij) - A terminal workspace with batteries included - 13170 stars
