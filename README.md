...
- [Step-by-Step Guide: Setting Up WASI Node Pools for AKS and Running WASM Spin Applications all with Pulumi](https://blog.ediri.io/step-by-step-guide-setting-up-wasi-node-pools-for-aks-and-running-wasm-spin-applications-all-with-pulumi) (5 days ago)
...
- [port-labs/pulumi](https://github.com/port-labs/pulumi) ([v0.8.4](https://github.com/port-labs/pulumi/releases/tag/v0.8.4), 1 day ago) - Pulumi provider for Port Labs
- [civo/civogo](https://github.com/civo/civogo) ([v0.3.28](https://github.com/civo/civogo/releases/tag/v0.3.28), 3 days ago) - Golang client to interact with Civo&#39;s API
- [dirien/minectl-sdk](https://github.com/dirien/minectl-sdk) ([v0.10.0](https://github.com/dirien/minectl-sdk/releases/tag/v0.10.0), 3 days ago) - SDK for every minectl product
- [libdns/civo](https://github.com/libdns/civo) ([v0.1.9](https://github.com/libdns/civo/releases/tag/v0.1.9), 3 days ago) - Civo DNS implementation for libdns
- [libdns/scaleway](https://github.com/libdns/scaleway) ([v0.1.7](https://github.com/libdns/scaleway/releases/tag/v0.1.7), 4 days ago) - Scaleway DNS implementation for libdns

#### ⭐ Latest repositories I starred

- [livecycle/preevy](https://github.com/livecycle/preevy) - Quickly deploy preview environments to the cloud! - 36 stars
- [nobl9/ekg](https://github.com/nobl9/ekg) - Essential Kubernetes Gauges - 33 stars
- [k8sgpt-ai/k8sgpt](https://github.com/k8sgpt-ai/k8sgpt) - Giving Kubernetes SRE superpowers to everyone - 673 stars
...
- [sozercan/kubectl-ai](https://github.com/sozercan/kubectl-ai) - ✨ Kubectl plugin for OpenAI GPT - 481 stars
- [ContainerSSH/ContainerSSH](https://github.com/ContainerSSH/ContainerSSH) - ContainerSSH: Launch containers on demand - 2257 stars
...
- [orhun/halp](https://github.com/orhun/halp) - A CLI tool to get help with CLI tools 🐙 - 549 stars
