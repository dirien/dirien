...
- [How to build an SSH client using Rust 🦀](https://blog.ediri.io/how-to-build-an-ssh-client-using-rust) (3 days ago)
- [How To Upgrade Your AKS Cluster Using Only Pulumi](https://blog.ediri.io/how-to-upgrade-your-aks-cluster-using-only-pulumi) (5 days ago)
...
- [pulumiverse/infra](https://github.com/pulumiverse/infra) - IaC for all infrastructure required by Pulumiverse (4 days ago)
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) - SVG icons for popular brands (1 week ago)

#### 🚀 Latest releases I contributed to

- [go-acme/lego](https://github.com/go-acme/lego) ([v4.12.3](https://github.com/go-acme/lego/releases/tag/v4.12.3), 1 day ago) - Let&#39;s Encrypt/ACME client and library written in Go
- [lbrlabs/pulumi-scaleway](https://github.com/lbrlabs/pulumi-scaleway) ([v1.9.0](https://github.com/lbrlabs/pulumi-scaleway/releases/tag/v1.9.0), 1 day ago) - Pulumi provider for Scaleway, the European cloud provider
...
- [dirien/minectl](https://github.com/dirien/minectl) ([v0.31.0](https://github.com/dirien/minectl/releases/tag/v0.31.0), 4 days ago) - minectl 🗺  is a cli for creating Minecraft server on different cloud provider.
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1186.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1186.0), 5 days ago) - IDE-style autocomplete for your existing terminal &amp; shell
...
- [hashicorp/terraform-k8s](https://github.com/hashicorp/terraform-k8s) - Terraform Cloud Operator for Kubernetes - 409 stars
- [openchatai/OpenChat](https://github.com/openchatai/OpenChat) - LLMs custom-chatbots console ⚡ - 3237 stars
- [StyraInc/regal](https://github.com/StyraInc/regal) - Regal is a linter for Rego - 119 stars
