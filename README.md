...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.9.22](https://github.com/alexellis/arkade/releases/tag/0.9.22), 1 day ago) - Open Source Marketplace For Developer Tools
- [aquasecurity/trivy-action](https://github.com/aquasecurity/trivy-action) ([0.11.2](https://github.com/aquasecurity/trivy-action/releases/tag/0.11.2), 2 days ago) - Runs Trivy as GitHub action to scan your Docker container image for vulnerabilities
- [dirien/devpod-provider-hetzner](https://github.com/dirien/devpod-provider-hetzner) ([v0.3.0](https://github.com/dirien/devpod-provider-hetzner/releases/tag/v0.3.0), 2 days ago) - DevPod on Hetzner 🇩🇪 with Rust 🦀
- [aquasecurity/helm-charts](https://github.com/aquasecurity/helm-charts) ([trivy-operator-0.14.0](https://github.com/aquasecurity/helm-charts/releases/tag/trivy-operator-0.14.0), 4 days ago) - Aqua Open Source Helm Chart Repository
- [aquasecurity/trivy-operator](https://github.com/aquasecurity/trivy-operator) ([v0.14.0](https://github.com/aquasecurity/trivy-operator/releases/tag/v0.14.0), 4 days ago) - Kubernetes-native security toolkit

#### ⭐ Latest repositories I starred

- [openchatai/OpenChat](https://github.com/openchatai/OpenChat) - LLMs custom-chatbots console ⚡ - 2891 stars
- [StyraInc/regal](https://github.com/StyraInc/regal) - Regal is a linter for Rego - 62 stars
- [ruanbekker/grafana-observability-primer](https://github.com/ruanbekker/grafana-observability-primer) - Grafana Observability Primer - 33 stars
...
- [warp-tech/warpgate](https://github.com/warp-tech/warpgate) - Smart SSH, HTTPS and MySQL bastion that needs no client-side software - 2456 stars
- [tomnomnom/gron](https://github.com/tomnomnom/gron) - Make JSON greppable! - 12184 stars
