...
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.0.9](https://github.com/port-labs/pulumi-port/releases/tag/v2.0.9), 1 day ago) - Pulumi Port provider
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.47.0](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.47.0), 1 day ago) - Azure Native Provider
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-k8s-exporter-0.2.30](https://github.com/port-labs/helm-charts/releases/tag/port-k8s-exporter-0.2.30), 1 day ago)
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([12.4.0](https://github.com/simple-icons/simple-icons/releases/tag/12.4.0), 2 days ago) - SVG icons for popular brands
...
- [kserve/kserve](https://github.com/kserve/kserve) - Standardized Serverless ML Inference Platform on Kubernetes - 3238 stars
...
- [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly WebUI for LLMs (Formerly Ollama WebUI) - 28839 stars
- [volcano-sh/volcano](https://github.com/volcano-sh/volcano) - A Cloud Native Batch System (Project under CNCF) - 3879 stars
