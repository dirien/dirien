...
- [Building a RESTful API with Actix Web and Diesel for Persistent Data Storage](https://blog.ediri.io/building-a-restful-api-with-actix-web-and-diesel-for-persistent-data-storage) (1 day ago)
...
- [dirien/parlez-vous-pulumi](https://github.com/dirien/parlez-vous-pulumi) - Creating an EKS cluster with Pulumi in different programming languages (6 days ago)

#### 🚀 Latest releases I contributed to

- [dirien/pulumi-scaleway](https://github.com/dirien/pulumi-scaleway) ([v2.13.1](https://github.com/dirien/pulumi-scaleway/releases/tag/v2.13.1), 1 day ago) - Pulumi provider for Scaleway
- [dirien/pulumi-github](https://github.com/dirien/pulumi-github) ([v0.2.22](https://github.com/dirien/pulumi-github/releases/tag/v0.2.22), 1 day ago) - Pulumi program to manage my GitHub repositories
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([8.8.0](https://github.com/simple-icons/simple-icons/releases/tag/8.8.0), 1 day ago) - SVG icons for popular brands
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1138.1](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1138.1), 3 days ago) - IDE-style autocomplete for your existing terminal &amp; shell
- [aquasecurity/helm-charts](https://github.com/aquasecurity/helm-charts) ([trivy-operator-0.12.1](https://github.com/aquasecurity/helm-charts/releases/tag/trivy-operator-0.12.1), 1 week ago) - Aqua Open Source Helm Chart Repository

#### ⭐ Latest repositories I starred

- [orhun/halp](https://github.com/orhun/halp) - A CLI tool to get help with CLI tools 🐙 - 513 stars
- [project-zot/zot](https://github.com/project-zot/zot) - zot - A production-ready vendor-neutral OCI-native container image registry (purely based on OCI Distribution Specification) - 313 stars
...
- [bevyengine/bevy](https://github.com/bevyengine/bevy) - A refreshingly simple data-driven game engine built in Rust - 22701 stars
...
- [tokio-rs/tracing](https://github.com/tokio-rs/tracing) - Application level tracing for Rust. - 3639 stars
- [one2nc/cloudlens](https://github.com/one2nc/cloudlens) - k9s like CLI for AWS - 217 stars
