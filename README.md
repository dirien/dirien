...
- [libdns/civo](https://github.com/libdns/civo) ([v0.1.11](https://github.com/libdns/civo/releases/tag/v0.1.11), 1 day ago) - Civo DNS implementation for libdns
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1155.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1155.0), 1 day ago) - IDE-style autocomplete for your existing terminal &amp; shell
...
- [civo/civogo](https://github.com/civo/civogo) ([v0.3.32](https://github.com/civo/civogo/releases/tag/v0.3.32), 1 day ago) - Golang client to interact with Civo&#39;s API
- [dirien/pulumi-scaleway](https://github.com/dirien/pulumi-scaleway) ([v2.16.3](https://github.com/dirien/pulumi-scaleway/releases/tag/v2.16.3), 3 days ago) - Pulumi provider for Scaleway
...
- [Dentrax/falco-gpt](https://github.com/Dentrax/falco-gpt) - AI-generated remediations for Falco audit events - 27 stars
- [madhuakula/kubernetes-goat](https://github.com/madhuakula/kubernetes-goat) - Kubernetes Goat is a &#34;Vulnerable by Design&#34; cluster environment to learn and practice Kubernetes security using an interactive hands-on playground 🚀 - 3057 stars
...
- [wg/wrk](https://github.com/wg/wrk) - Modern HTTP benchmarking tool - 34215 stars
- [valyala/fasthttp](https://github.com/valyala/fasthttp) - Fast HTTP package for Go. Tuned for high performance. Zero memory allocations in hot paths. Up to 10x faster than net/http - 19389 stars
- [nickel-org/nickel.rs](https://github.com/nickel-org/nickel.rs) - An expressjs inspired web framework for Rust - 3000 stars
- [gofiber/fiber](https://github.com/gofiber/fiber) - ⚡️ Express inspired web framework written in Go - 25784 stars
