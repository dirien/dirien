...
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.1.7](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.1.7), 1 day ago)
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([10.1.0](https://github.com/simple-icons/simple-icons/releases/tag/10.1.0), 1 day ago) - SVG icons for popular brands
- [argoproj/argo-helm](https://github.com/argoproj/argo-helm) ([argo-cd-5.51.6](https://github.com/argoproj/argo-helm/releases/tag/argo-cd-5.51.6), 2 days ago) - ArgoProj Helm Charts
- [pulumi/pulumi](https://github.com/pulumi/pulumi) ([v3.95.0](https://github.com/pulumi/pulumi/releases/tag/v3.95.0), 3 days ago) - Pulumi - Infrastructure as Code in any programming language. Build infrastructure intuitively on any cloud using familiar languages 🚀
- [pulumi/pulumi-azure-native](https://github.com/pulumi/pulumi-azure-native) ([v2.20.1](https://github.com/pulumi/pulumi-azure-native/releases/tag/v2.20.1), 3 days ago) - Azure Native Provider

#### ⭐ Latest repositories I starred

- [awslabs/data-on-eks](https://github.com/awslabs/data-on-eks) - DoEKS is a tool to build, deploy and scale Data Platforms on Amazon EKS - 401 stars
- [kubewharf/kubeadmiral](https://github.com/kubewharf/kubeadmiral) - Multi-Cluster Kubernetes Orchestration - 286 stars
- [Boeing/config-file-validator](https://github.com/Boeing/config-file-validator) - Cross Platform tool to validate configuration files - 192 stars
...
- [charmbracelet/gum](https://github.com/charmbracelet/gum) - A tool for glamorous shell scripts 🎀 - 15342 stars
- [distribworks/dkron](https://github.com/distribworks/dkron) - Dkron - Distributed, fault tolerant job scheduling system https://dkron.io - 3959 stars
