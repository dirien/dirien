...
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.7](https://github.com/alexellis/arkade/releases/tag/0.11.7), 1 day ago) - Open Source Marketplace For Developer Tools
...
- [Azure/kaito](https://github.com/Azure/kaito) - Kubernetes AI Toolchain Operator - 194 stars
- [SchedMD/slurm](https://github.com/SchedMD/slurm) - Slurm: A Highly Scalable Workload Manager - 2270 stars
- [daytonaio/daytona](https://github.com/daytonaio/daytona) - The Open Source Dev Environment Manager. - 4614 stars
- [embedchain/embedchain](https://github.com/embedchain/embedchain) - Personalizing LLM Responses - 8287 stars
- [ariga/atlas-operator](https://github.com/ariga/atlas-operator) - Atlas Kubernetes Operator - 68 stars
...
- [cirruslabs/tart](https://github.com/cirruslabs/tart) - macOS and Linux VMs on Apple Silicon to use in CI and other automations - 3433 stars
- [predibase/lorax](https://github.com/predibase/lorax) - Multi-LoRA inference server that scales to 1000s of fine-tuned LLMs - 1287 stars
- [middyjs/middy](https://github.com/middyjs/middy) - 🛵 The stylish Node.js middleware engine for AWS Lambda 🛵 - 3607 stars
- [cake-build/cake](https://github.com/cake-build/cake) - :cake: Cake (C# Make) is a cross platform build automation system. - 3796 stars
