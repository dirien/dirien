...
- [dirien/devpod-provider-scaleway](https://github.com/dirien/devpod-provider-scaleway) ([v0.1.0](https://github.com/dirien/devpod-provider-scaleway/releases/tag/v0.1.0), 1 day ago) - DevPod on Scaleway 🇫🇷
- [dirien/pulumi-github](https://github.com/dirien/pulumi-github) ([v0.2.25](https://github.com/dirien/pulumi-github/releases/tag/v0.2.25), 1 day ago) - Pulumi program to manage my GitHub repositories
- [SchwarzIT/node-red-chart](https://github.com/SchwarzIT/node-red-chart) ([node-red-0.23.2](https://github.com/SchwarzIT/node-red-chart/releases/tag/node-red-0.23.2), 1 day ago) - Node-red Helm Chart
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([8.15.0](https://github.com/simple-icons/simple-icons/releases/tag/8.15.0), 1 day ago) - SVG icons for popular brands
- [dirien/pulumi-scaleway](https://github.com/dirien/pulumi-scaleway) ([v2.19.0](https://github.com/dirien/pulumi-scaleway/releases/tag/v2.19.0), 2 days ago) - Pulumi provider for Scaleway

#### ⭐ Latest repositories I starred

- [sustainable-computing-io/kepler](https://github.com/sustainable-computing-io/kepler) - Kepler (Kubernetes-based Efficient Power Level Exporter) uses eBPF to probe energy related system stats and exports as Prometheus metrics - 470 stars
...
- [robusta-dev/krr](https://github.com/robusta-dev/krr) - Prometheus-based Kubernetes Resource Recommendations - 599 stars
- [oslabs-beta/kaptn](https://github.com/oslabs-beta/kaptn) - A powerful K8s development tool - 61 stars
- [umputun/spot](https://github.com/umputun/spot) - A user-friendly and efficient tool for the effortless deployment and configuration of resources on remote machines. - 189 stars
- [hardbyte/netchecks](https://github.com/hardbyte/netchecks) - Tool to validate assumptions about the network - 50 stars
- [defenseunicorns/pepr](https://github.com/defenseunicorns/pepr) - Typescript &#43; plain language api &#43; K8s = 🎸 - 67 stars
