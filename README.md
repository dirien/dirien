...
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.49](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.49), 1 day ago) - MCP DigitalOcean Integration
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.27.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.27.0), 2 days ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.21.8](https://github.com/port-labs/pulumi-port/releases/tag/v2.21.8), 6 days ago) - Pulumi Port provider
...
- [multica-ai/multica](https://github.com/multica-ai/multica) - The open-source managed agents platform. Turn coding agents into real teammates — assign tasks, track progress, compound skills. - 20671 stars
- [excalidraw/excalidraw-mcp](https://github.com/excalidraw/excalidraw-mcp) - Fast and streamable Excalidraw MCP App - 4167 stars
- [TencentCloud/CubeSandbox](https://github.com/TencentCloud/CubeSandbox) - Instant, Concurrent, Secure &amp; Lightweight Sandbox for AI Agents. - 3919 stars
- [BlockRunAI/ClawRouter](https://github.com/BlockRunAI/ClawRouter) - The agent-native LLM router for OpenClaw. 41&#43; models, &lt;1ms routing, USDC payments on Base &amp; Solana via x402. - 6281 stars
- [obot-platform/discobot](https://github.com/obot-platform/discobot) - Coding Agent - 67 stars
- [vercel-labs/wterm](https://github.com/vercel-labs/wterm) - A terminal emulator for the web - 2377 stars
- [getagentseal/codeburn](https://github.com/getagentseal/codeburn) - See where your AI coding tokens go. Interactive TUI dashboard for Claude Code, Codex, and Cursor cost observability. - 3595 stars
- [rtk-ai/rtk](https://github.com/rtk-ai/rtk) - CLI proxy that reduces LLM token consumption by 60-90% on common dev commands. Single Rust binary, zero dependencies - 34619 stars
- [thesysdev/openui](https://github.com/thesysdev/openui) - The Open Standard for Generative UI - 3695 stars
