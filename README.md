...
- [pinecone-io/pulumi-pinecone](https://github.com/pinecone-io/pulumi-pinecone) ([v0.4.1](https://github.com/pinecone-io/pulumi-pinecone/releases/tag/v0.4.1), 1 day ago) - Pinecone Pulumi Provider
...
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v1.10.5](https://github.com/port-labs/pulumi-port/releases/tag/v1.10.5), 2 days ago)
...
- [microsoft/retina](https://github.com/microsoft/retina) - eBPF distributed networking observability tool for Kubernetes - 1951 stars
- [spinkube/spin-operator](https://github.com/spinkube/spin-operator) - Spin Operator is a Kubernetes operator that empowers platform engineers to deploy Spin applications as custom resources to their Kubernetes clusters - 67 stars
- [llmnetes/llmnetes](https://github.com/llmnetes/llmnetes) -  - 28 stars
- [Azure/kaito](https://github.com/Azure/kaito) - Kubernetes AI Toolchain Operator - 226 stars
- [SchedMD/slurm](https://github.com/SchedMD/slurm) - Slurm: A Highly Scalable Workload Manager - 2285 stars
- [daytonaio/daytona](https://github.com/daytonaio/daytona) - The Open Source Dev Environment Manager. - 4833 stars
- [embedchain/embedchain](https://github.com/embedchain/embedchain) - Personalizing LLM Responses - 8318 stars
...
- [cirruslabs/tart](https://github.com/cirruslabs/tart) - macOS and Linux VMs on Apple Silicon to use in CI and other automations - 3440 stars
