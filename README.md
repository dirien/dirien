...
- [dirien/getting-started-with-devops-ai-skills](https://github.com/dirien/getting-started-with-devops-ai-skills) - Getting Started with DevOps AI Skills — a Pulumi workshop: build, share, and run Agent Skills with Microsoft APM. Slides, chapters, skills, LSP&#43;hooks, and a Claude/Codex/Pulumi devcontainer. (5 days ago)
...
- [dirien/fully-automated-ai-inference-pulumi](https://github.com/dirien/fully-automated-ai-inference-pulumi) - Zero-touch GPU inference server (Ollama) on AWS, Azure, and Google Cloud with Pulumi. Companion code for the Pulumi blog post. (1 week ago)
...
- [digitalocean-labs/mcp-digitalocean](https://github.com/digitalocean-labs/mcp-digitalocean) ([v1.0.66](https://github.com/digitalocean-labs/mcp-digitalocean/releases/tag/v1.0.66), 1 day ago) - MCP DigitalOcean Integration
- [pulumi/pulumi-aws](https://github.com/pulumi/pulumi-aws) ([v7.35.0](https://github.com/pulumi/pulumi-aws/releases/tag/v7.35.0), 6 days ago) - An Amazon Web Services (AWS) Pulumi resource package, providing multi-language access to AWS
...
- [ogulcancelik/herdr](https://github.com/ogulcancelik/herdr) - agent multiplexer that lives in your terminal. - 12910 stars
...
- [Project-HAMi/HAMi](https://github.com/Project-HAMi/HAMi) - Heterogeneous GPU Sharing on Kubernetes - 3689 stars
- [Gitlawb/zero](https://github.com/Gitlawb/zero) - The coding agent that answers to you, your model, your machine, your rules. - 951 stars
- [better-auth/better-auth](https://github.com/better-auth/better-auth) - The most comprehensive authentication framework - 28967 stars
- [huggingface/tau](https://github.com/huggingface/tau) - a minimalist agent that teaches you to create coding agents - 646 stars
- [ferdinandobons/AWSBedrockAgentCoreSkill](https://github.com/ferdinandobons/AWSBedrockAgentCoreSkill) - Authoritative, source-cited Claude Code plugin/skill that lets a coding agent autonomously build production-grade AI agents on AWS (Strands Agents, Amazon Bedrock, Bedrock AgentCore) with official best practices. - 198 stars
- [cobusgreyling/loop-engineering](https://github.com/cobusgreyling/loop-engineering) - Practical patterns, starters &amp; CLI tools for loop engineering with AI coding agents. Design systems that prompt and orchestrate agents (inspired by Addy Osmani and Boris Cherny). Includes loop-audit, loop-init, loop-cost. - 6209 stars
...
- [tanrikuluozlem/burn](https://github.com/tanrikuluozlem/burn) - See what&#39;s burning your Kubernetes budget - 83 stars
