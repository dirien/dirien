...
- [pulumi/actions](https://github.com/pulumi/actions) ([v4.5.1](https://github.com/pulumi/actions/releases/tag/v4.5.1), 2 days ago) - Deploy continuously to your cloud of choice, using your favorite language, Pulumi, and GitHub!
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.16-alpha.1](https://github.com/loft-sh/devpod/releases/tag/v0.5.16-alpha.1), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
- [port-labs/pulumi-port](https://github.com/port-labs/pulumi-port) ([v2.0.9](https://github.com/port-labs/pulumi-port/releases/tag/v2.0.9), 3 days ago) - Pulumi Port provider
...
- [flox/flox](https://github.com/flox/flox) - Developer environments you can take with you - 2189 stars
...
- [kserve/kserve](https://github.com/kserve/kserve) - Standardized Serverless ML Inference Platform on Kubernetes - 3249 stars
...
- [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly WebUI for LLMs (Formerly Ollama WebUI) - 29101 stars
- [volcano-sh/volcano](https://github.com/volcano-sh/volcano) - A Cloud Native Batch System (Project under CNCF) - 3885 stars
