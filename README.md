...
- [chronosphereio/pulumi-chronosphere](https://github.com/chronosphereio/pulumi-chronosphere) - Chronosphere Pulumi Provider (1 week ago)

#### 🚀 Latest releases I contributed to

- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([13.5.0](https://github.com/simple-icons/simple-icons/releases/tag/13.5.0), 1 day ago) - SVG icons for popular brands
- [dirien/pulumi-qovery](https://github.com/dirien/pulumi-qovery) ([v0.37.0](https://github.com/dirien/pulumi-qovery/releases/tag/v0.37.0), 3 days ago) - Pulumi provider for Qovery
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.20-alpha.0](https://github.com/loft-sh/devpod/releases/tag/v0.5.20-alpha.0), 3 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.11.19](https://github.com/alexellis/arkade/releases/tag/0.11.19), 4 days ago) - Open Source Marketplace For Developer Tools
- [ovh/pulumi-ovh](https://github.com/ovh/pulumi-ovh) ([v0.48.0](https://github.com/ovh/pulumi-ovh/releases/tag/v0.48.0), 5 days ago) - Pulumi provider for OVHcloud

#### ⭐ Latest repositories I starred

- [cryptocode/terminal-doom](https://github.com/cryptocode/terminal-doom) - Play DOOM in modern terminals - 75 stars
- [sighupio/permission-manager](https://github.com/sighupio/permission-manager) - Permission Manager is a project that brings sanity to Kubernetes RBAC and Users management, Web UI FTW - 1277 stars
- [dastergon/postmortem-templates](https://github.com/dastergon/postmortem-templates) - A collection of postmortem templates - 1288 stars
- [kubernetes-sigs/cluster-api-operator](https://github.com/kubernetes-sigs/cluster-api-operator) - Home for Cluster API Operator, a subproject of sig-cluster-lifecycle - 153 stars
...
- [buildsafedev/bsf](https://github.com/buildsafedev/bsf) - Developer-centric tool to secure your software supply chain. - 48 stars
- [infiniflow/ragflow](https://github.com/infiniflow/ragflow) - RAGFlow is an open-source RAG (Retrieval-Augmented Generation) engine based on deep document understanding. - 13910 stars

#### 👥 Latest follower

- [ministerko](https://github.com/ministerko) - kelvin mwaijega
- [viralkachhadiya](https://github.com/viralkachhadiya) - Viral Kachhadiya
- [kingcoder0601](https://github.com/kingcoder0601) - Andrii Taran
