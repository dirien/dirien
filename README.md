...
- [ossf/scorecard-webapp](https://github.com/ossf/scorecard-webapp) ([v1.0.6](https://github.com/ossf/scorecard-webapp/releases/tag/v1.0.6), 1 day ago) - Website and API for OpenSSF Scorecard
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.10.0](https://github.com/alexellis/arkade/releases/tag/0.10.0), 1 day ago) - Open Source Marketplace For Developer Tools
- [scraly/pulumi-ovh](https://github.com/scraly/pulumi-ovh) ([v0.33.0](https://github.com/scraly/pulumi-ovh/releases/tag/v0.33.0), 1 day ago) - Pulumi provider for OVHcloud
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.3.6](https://github.com/loft-sh/devpod/releases/tag/v0.3.6), 2 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
...
- [kdash-rs/kdash](https://github.com/kdash-rs/kdash) - A simple and fast dashboard for Kubernetes - 1373 stars
- [mochi-mqtt/server](https://github.com/mochi-mqtt/server) - The fully compliant, embeddable high-performance Go MQTT v5 server for IoT, smarthome, and pubsub - 695 stars
- [eigr/spawn](https://github.com/eigr/spawn) - Spawn - Actor Mesh - 131 stars
- [kcl-lang/kcl](https://github.com/kcl-lang/kcl) - A constraint-based record &amp; functional language mainly used in configuration and policy scenarios. https://kcl-lang.io - 731 stars
- [IBM/fp-go](https://github.com/IBM/fp-go) - functional programming library for golang - 1023 stars
...
- [org-formation/org-formation-cli](https://github.com/org-formation/org-formation-cli) - Better than landingzones! - 1228 stars
...
- [yonahd/kor](https://github.com/yonahd/kor) - A Golang Tool to discover unused Kubernetes Resources  - 120 stars
- [kubernetes-up-and-running/kuard](https://github.com/kubernetes-up-and-running/kuard) - Demo app for Kubernetes Up and Running book - 1430 stars
