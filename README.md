...
- [Boost Your Rust 🦀 Development with Hot Reload using cargo-watch](https://blog.ediri.io/boost-your-rust-development-with-hot-reload-using-cargo-watch) (3 days ago)
- [Building the Port Pulumi Connector PoC: A Step-by-Step Guide](https://blog.ediri.io/building-the-port-pulumi-connector-poc-a-step-by-step-guide) (4 days ago)
...
- [dirien/pulumi-port-labs](https://github.com/dirien/pulumi-port-labs) - Pulumi provider for Port Labs (3 days ago)
- [dirien/pulumi-connector](https://github.com/dirien/pulumi-connector) - Pulumi connector for Port (4 days ago)
...
- [pulumi/pulumi-kubernetes-operator](https://github.com/pulumi/pulumi-kubernetes-operator) ([v1.11.2](https://github.com/pulumi/pulumi-kubernetes-operator/releases/tag/v1.11.2), 1 day ago) - A Kubernetes Operator that automates the deployment of Pulumi Stacks
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1138.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1138.0), 2 days ago) - IDE-style autocomplete for your existing terminal &amp; shell
- [dergeberl/multitool-container](https://github.com/dergeberl/multitool-container) ([v0.5.10](https://github.com/dergeberl/multitool-container/releases/tag/v0.5.10), 2 days ago) - Three containers with useful tools for troubleshooting
- [antfu/case-police](https://github.com/antfu/case-police) ([v0.5.14](https://github.com/antfu/case-police/releases/tag/v0.5.14), 2 days ago) - 🚨 Make the case correct, PLEASE!

#### ⭐ Latest repositories I starred

- [tokio-rs/tracing](https://github.com/tokio-rs/tracing) - Application level tracing for Rust. - 3609 stars
- [one2nc/cloudlens](https://github.com/one2nc/cloudlens) - k9s like CLI for AWS - 172 stars
...
- [kluctl/kluctl](https://github.com/kluctl/kluctl) - The missing glue to put together large Kubernetes deployments, composed of multiple smaller parts (Helm/Kustomize/...)  in a manageable and unified way. - 224 stars
...
- [GoogleCloudPlatform/microservices-demo](https://github.com/GoogleCloudPlatform/microservices-demo) - Sample cloud-first application with 10 microservices showcasing Kubernetes, Istio, and gRPC. - 13808 stars
- [mrsked/mrsk](https://github.com/mrsked/mrsk) - Deploy web apps anywhere. - 3418 stars
...
- [swaggo/echo-swagger](https://github.com/swaggo/echo-swagger) - echo middleware to automatically generate RESTful API documentation with Swagger 2.0. - 568 stars
