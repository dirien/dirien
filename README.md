...
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.1.23](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.1.23), 1 day ago)
...
- [langchain-ai/langserve](https://github.com/langchain-ai/langserve) ([v0.2.1](https://github.com/langchain-ai/langserve/releases/tag/v0.2.1), 3 days ago) - LangServe 🦜️🏓
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.5.9-alpha.1](https://github.com/loft-sh/devpod/releases/tag/v0.5.9-alpha.1), 3 days ago) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just localhost docker.
...
- [kubecolor/kubecolor](https://github.com/kubecolor/kubecolor) - Colorize your kubectl output - 421 stars
...
- [sigoden/aichat](https://github.com/sigoden/aichat) - All-in-one AI-Powered CLI Chat &amp; Copilot that integrates 20&#43; AI platforms, including OpenAI, Azure-OpenAI, Gemini, Claude, Mistral, Cohere, VertexAI, Bedrock, Ollama, Ernie, Qianwen, Deepseek... - 3013 stars
- [jozu-ai/kitops](https://github.com/jozu-ai/kitops) - Tools for easing the handoff between AI/ML and App/SRE teams. - 198 stars
- [inkdrop-org/inkdrop-visualizer](https://github.com/inkdrop-org/inkdrop-visualizer) - Visualizes your Terraform - 410 stars
