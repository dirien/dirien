...
- [KCD Israel Unplugged: My Thrilling Cloud Native Adventure in Tel Aviv!](https://blog.ediri.io/kcd-israel-unplugged-my-thrilling-cloud-native-adventure-in-tel-aviv) (6 days ago)
...
- [bots-garden/capsule](https://github.com/bots-garden/capsule) ([v0.3.3](https://github.com/bots-garden/capsule/releases/tag/v0.3.3), 2 days ago) - Capsule is a runner (or launcher) of wasm functions. Capsule can serve the functions through HTTP, NATS and MQTT (it’s possible to use Capsule as a simple CLI).
- [aquasecurity/helm-charts](https://github.com/aquasecurity/helm-charts) ([postee-v2.10.2](https://github.com/aquasecurity/helm-charts/releases/tag/postee-v2.10.2), 2 days ago) - Aqua Open Source Helm Chart Repository
- [pulumi/pulumi-kubernetes-operator](https://github.com/pulumi/pulumi-kubernetes-operator) ([v1.11.3](https://github.com/pulumi/pulumi-kubernetes-operator/releases/tag/v1.11.3), 3 days ago) - A Kubernetes Operator that automates the deployment of Pulumi Stacks
- [aquasecurity/trivy-operator](https://github.com/aquasecurity/trivy-operator) ([v0.13.1-rc](https://github.com/aquasecurity/trivy-operator/releases/tag/v0.13.1-rc), 3 days ago) - Kubernetes-native security toolkit
- [aquasecurity/trivy-action](https://github.com/aquasecurity/trivy-action) ([0.10.0](https://github.com/aquasecurity/trivy-action/releases/tag/0.10.0), 3 days ago) - Runs Trivy as GitHub action to scan your Docker container image for vulnerabilities
...
- [sagiegurari/cargo-make](https://github.com/sagiegurari/cargo-make) - Rust task runner and build tool. - 1953 stars
...
- [vitobotta/hetzner-k3s](https://github.com/vitobotta/hetzner-k3s) - A CLI tool to install and manage Kubernetes clusters in Hetzner Cloud using the lightweight distribution k3s by Rancher. - 804 stars
