...
- [kebap-stack/reference-implementation](https://github.com/kebap-stack/reference-implementation) -  (2 days ago)
...
- [kebap-stack/.github](https://github.com/kebap-stack/.github) -  (3 days ago)
...
- [port-labs/helm-charts](https://github.com/port-labs/helm-charts) ([port-ocean-0.1.20](https://github.com/port-labs/helm-charts/releases/tag/port-ocean-0.1.20), 1 day ago)
- [backstage/backstage](https://github.com/backstage/backstage) ([v1.26.0](https://github.com/backstage/backstage/releases/tag/v1.26.0), 1 day ago) - Backstage is an open platform for building developer portals
- [langchain-ai/langserve](https://github.com/langchain-ai/langserve) ([v0.1.0](https://github.com/langchain-ai/langserve/releases/tag/v0.1.0), 2 days ago) - LangServe 🦜️🏓
...
- [pulumiverse/pulumi-scaleway](https://github.com/pulumiverse/pulumi-scaleway) ([v1.12.1](https://github.com/pulumiverse/pulumi-scaleway/releases/tag/v1.12.1), 2 days ago) - Pulumi provider for Scaleway
...
- [mziyabo/argocd-trivy-extension](https://github.com/mziyabo/argocd-trivy-extension) - An Argo CD extension to enable visualization of Trivy generated vulnerability reports in Argo CD UI.  - 40 stars
...
- [hcavarsan/kftray](https://github.com/hcavarsan/kftray) - 🦀⚡  kubectl port-forward on steroids  - manage and share multiple k8s port forwards from the menu bar - 400 stars
- [aws-samples/aws-serverless-ai-stories](https://github.com/aws-samples/aws-serverless-ai-stories) - Example open source event-driven application that generates a new bed time story for your children every night using Lambda, EventBridge, DynamoDB, App Runner, ChatGPT and DALL-E. - 147 stars
