...
- [Advanced Secrets Management on Kubernetes with Pulumi: Doppler Secrets Operator](https://blog.ediri.io/advanced-secrets-management-on-kubernetes-with-pulumi-doppler-secrets-operator) (3 weeks ago)
...
- [dirien/devpod-provider-hetzner](https://github.com/dirien/devpod-provider-hetzner) - DevPod on Hetzner 🇩🇪 with Rust 🦀 (2 days ago)
...
- [aquasecurity/trivy-action](https://github.com/aquasecurity/trivy-action) ([0.11.0](https://github.com/aquasecurity/trivy-action/releases/tag/0.11.0), 1 day ago) - Runs Trivy as GitHub action to scan your Docker container image for vulnerabilities
- [alexellis/arkade](https://github.com/alexellis/arkade) ([0.9.19](https://github.com/alexellis/arkade/releases/tag/0.9.19), 1 day ago) - Open Source Marketplace For Developer Tools
- [bots-garden/capsule](https://github.com/bots-garden/capsule) ([v0.3.9](https://github.com/bots-garden/capsule/releases/tag/v0.3.9), 2 days ago) - A Capsule application is a runner (or launcher) of wasm functions. Capsule HTTP can serve the functions through HTTP (it’s possible to use Capsule as a simple CLI with Capsule CLI). And soon: NATS and MQTT
- [dirien/devpod-provider-hetzner](https://github.com/dirien/devpod-provider-hetzner) ([v0.1.0](https://github.com/dirien/devpod-provider-hetzner/releases/tag/v0.1.0), 2 days ago) - DevPod on Hetzner 🇩🇪 with Rust 🦀
- [withfig/autocomplete](https://github.com/withfig/autocomplete) ([spec-build-number-0.1184.0](https://github.com/withfig/autocomplete/releases/tag/spec-build-number-0.1184.0), 3 days ago) - IDE-style autocomplete for your existing terminal &amp; shell

#### ⭐ Latest repositories I starred

- [lewish/asciiflow](https://github.com/lewish/asciiflow) - ASCIIFlow - 3770 stars
- [doitintl/kube-no-trouble](https://github.com/doitintl/kube-no-trouble) - Easily check your clusters for use of deprecated APIs - 1891 stars
- [wez/wezterm](https://github.com/wez/wezterm) - A GPU-accelerated cross-platform terminal emulator and multiplexer written by @wez and implemented in Rust - 8960 stars
- [dev-wasm/dev-wasm-go](https://github.com/dev-wasm/dev-wasm-go) - Simple devcontainer for Golang &#43; WASM development - 14 stars
- [k0sproject/k0smotron](https://github.com/k0sproject/k0smotron) - k0smotron - 49 stars
- [ellie/atuin](https://github.com/ellie/atuin) - 🐢 Magical shell history - 9984 stars
- [houseabsolute/precious](https://github.com/houseabsolute/precious) - One code quality tool to rule them all - 44 stars
- [stefanprodan/timoni](https://github.com/stefanprodan/timoni) - Timoni is a package manager for Kubernetes, powered by CUE and inspired by Helm. - 440 stars
- [awslabs/specctl](https://github.com/awslabs/specctl) - CLI to convert Kubernetes specifications to ECS Fargate and vice-versa - 159 stars
- [crablang/crab](https://github.com/crablang/crab) - A community fork of a language named after a plant fungus. All of the memory-safe features you love, now with 100% less bureaucracy!  - 4225 stars
